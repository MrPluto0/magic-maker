...
var i = {
		...
		lineEditor: { edit: "Linie bearbeiten", exit: "Linieneditor verlassen" },
		elementLock: {
			lock: "Sperren",
			unlock: "Entsperren",
	...
	t = {
		...
		hint_emptyLibrary:
			"W\xE4hle ein Element auf der Zeichenfl\xE4che, um es hier hinzuzuf\xFCgen. Oder installiere eine Bibliothek aus dem \xF6ffentlichen Verzeichnis.",
		hint_emptyPrivateLibrary:
			"W\xE4hle ein Element von der Zeichenfl\xE4che, um es hier hinzuzuf\xFCgen.",
	},
	r = {
		clearReset:
			"Zeichenfl\xE4che l\xF6schen & Hintergrundfarbe zur\xFCcksetzen",
	...
	a = {
		clearReset:
			"Dies wird die ganze Zeichenfl\xE4che l\xF6schen. Bist du dir sicher?",
		couldNotCreateShareableLink: "Konnte keinen teilbaren Link erstellen.",
		couldNotCreateShareableLinkTooBig:
			"Konnte keinen teilbaren Link erstellen: Die Zeichnung ist zu gro\xDF",
		...
		cannotExportEmptyCanvas:
			"Leere Zeichenfl\xE4che kann nicht exportiert werden.",
		...
		uploadedSecurly:
			"Der Upload wurde mit Ende-zu-Ende-Verschl\xFCsselung gespeichert. Weder Excalidraw noch Dritte k\xF6nnen den Inhalt einsehen.",
		loadSceneOverridePrompt:
			"Das Laden einer externen Zeichnung ersetzt den vorhandenen Inhalt. M\xF6chtest du fortfahren?",
...
(Wenn du deine lokale Zeichnung behalten m\xF6chtest, schlie\xDFe stattdessen den Browser-Tab.)`,
		errorAddingToLibrary:
			"Das Element konnte nicht zur Bibliothek hinzugef\xFCgt werden",
		errorRemovingFromLibrary:
			"Das Element konnte nicht aus der Bibliothek entfernt werden",
		confirmAddLibrary:
			"Dies f\xFCgt {{numShapes}} Form(en) zu deiner Bibliothek hinzu. Bist du dir sicher?",
		imageDoesNotContainScene:
			"Dieses Bild scheint keine Szenendaten zu enthalten. Hast Du das Einbetten der Szene w\xE4hrend des Exports aktiviert?",
		cannotRestoreFromImage:
			"Die Zeichnung konnte aus dieser Bilddatei nicht wiederhergestellt werden",
		invalidSceneUrl:
			"Die Szene konnte nicht von der angegebenen URL importiert werden. Sie ist entweder fehlerhaft oder enth\xE4lt keine g\xFCltigen Excalidraw JSON-Daten.",
		resetLibrary: "Dieses l\xF6scht deine Bibliothek. Bist du sicher?",
		removeItemsFromsLibrary:
			"{{count}} Element(e) aus der Bibliothek l\xF6schen?",
		invalidEncryptionKey:
			"Verschl\xFCsselungsschl\xFCssel muss 22 Zeichen lang sein. Die Live-Zusammenarbeit ist deaktiviert.",
...
Deine \xC4nderungen werden nicht gespeichert!`,
	...
	l = {
		...
		imageInsertError:
			"Das Bild konnte nicht eingef\xFCgt werden. Versuche es sp\xE4ter erneut...",
		fileTooBig:
			"Die Datei ist zu gro\xDF. Die maximal zul\xE4ssige Gr\xF6\xDFe ist {{maxSize}}.",
		svgImageInsertError:
			"SVG-Bild konnte nicht eingef\xFCgt werden. Das SVG-Markup sieht ung\xFCltig aus.",
		failedToFetchImage: "Bild konnte nicht abgerufen werden.",
		invalidSVGString: "Ung\xFCltige SVG.",
		cannotResolveCollabServer:
			"Konnte keine Verbindung zum Collab-Server herstellen. Bitte lade die Seite neu und versuche es erneut.",
		importLibraryError: "Bibliothek konnte nicht geladen werden",
		collabSaveFailed:
			"Keine Speicherung in der Backend-Datenbank m\xF6glich. Wenn die Probleme weiterhin bestehen, solltest Du Deine Datei lokal speichern, um sicherzustellen, dass Du Deine Arbeit nicht verlierst.",
		collabSaveFailed_sizeExceeded:
			"Keine Speicherung in der Backend-Datenbank m\xF6glich, die Zeichenfl\xE4che scheint zu gro\xDF zu sein. Du solltest Deine Datei lokal speichern, um sicherzustellen, dass Du Deine Arbeit nicht verlierst.",
		imageToolNotSupported: "Bilder sind deaktiviert.",
		brave_measure_text_error: {
			line1:
				"Sieht so aus, als ob Du den Brave-Browser verwendest und die <bold>aggressive Blockierung von Fingerabdr\xFCcken</bold> aktiviert hast.",
			line2:
				"Dies k\xF6nnte dazu f\xFChren, dass die <bold>Textelemente</bold> in Ihren Zeichnungen zerst\xF6rt werden.",
			line3:
				"Wir empfehlen dringend, diese Einstellung zu deaktivieren. Dazu kannst Du <link>diesen Schritten</link> folgen.",
			line4:
				"Wenn die Deaktivierung dieser Einstellung die fehlerhafte Anzeige von Textelementen nicht behebt, \xF6ffne bitte ein <issueLink>Ticket</issueLink> auf unserem GitHub oder schreibe uns auf <discordLink>Discord</discordLink>",
		},
		libraryElementTypeError: {
			embeddable:
				"Einbettbare Elemente k\xF6nnen der Bibliothek nicht hinzugef\xFCgt werden.",
			iframe:
				"IFrame-Elemente k\xF6nnen nicht zur Bibliothek hinzugef\xFCgt werden.",
			image:
				"Unterst\xFCtzung f\xFCr das Hinzuf\xFCgen von Bildern in die Bibliothek kommt bald!",
		},
		asyncPasteFailedOnRead:
			"Einf\xFCgen fehlgeschlagen (konnte aus der Zwischenablage des Systems nicht gelesen werden).",
	...
	d = {
		canvasPanning:
			"Um die Zeichenfl\xE4che zu verschieben, halte das Mausrad oder die Leertaste w\xE4hrend des Ziehens, oder verwende das Hand-Werkzeug",
		linearElement:
			"Klicken f\xFCr Linie mit mehreren Punkten, Ziehen f\xFCr einzelne Linie",
		...
		text_selected:
			"Doppelklicken oder Eingabetaste dr\xFCcken, um Text zu bearbeiten",
		text_editing:
			"Dr\xFCcke Escape oder CtrlOrCmd+Eingabetaste, um die Bearbeitung abzuschlie\xDFen",
		linearElementMulti:
			"Zum Beenden auf den letzten Punkt klicken oder Escape oder Eingabe dr\xFCcken",
		lockAngle:
			"Du kannst Winkel einschr\xE4nken, indem du SHIFT gedr\xFCckt h\xE4ltst",
		resize:
			"Du kannst die Proportionen einschr\xE4nken, indem du SHIFT w\xE4hrend der Gr\xF6\xDFen\xE4nderung gedr\xFCckt h\xE4ltst. Halte ALT gedr\xFCckt, um die Gr\xF6\xDFe vom Zentrum aus zu \xE4ndern",
		resizeImage:
			"Du kannst die Gr\xF6\xDFe frei \xE4ndern, indem du SHIFT gedr\xFCckt h\xE4ltst; halte ALT, um die Gr\xF6\xDFe vom Zentrum aus zu \xE4ndern",
		rotate:
			"Du kannst Winkel einschr\xE4nken, indem du SHIFT w\xE4hrend der Drehung gedr\xFCckt h\xE4ltst",
		lineEditor_info:
			"CtrlOrCmd halten und Doppelklick oder CtrlOrCmd + Eingabe dr\xFCcken, um Punkte zu bearbeiten",
		lineEditor_pointSelected:
			"Dr\xFCcke L\xF6schen, um Punkt(e) zu entfernen, CtrlOrCmd+D zum Duplizieren oder ziehe zum Verschieben",
...
oder halte Alt gedr\xFCckt und klicke um neue Punkte hinzuzuf\xFCgen`,
		placeImage:
			"Klicken, um das Bild zu platzieren oder klicken und ziehen um seine Gr\xF6\xDFe manuell zu setzen",
		publishLibrary: "Ver\xF6ffentliche deine eigene Bibliothek",
		bindTextToElement: "Zum Hinzuf\xFCgen Eingabetaste dr\xFCcken",
		deepBoxSelect:
			"Halte CtrlOrCmd gedr\xFCckt, um innerhalb der Gruppe auszuw\xE4hlen, und um Ziehen zu vermeiden",
		eraserRevert:
			"Halte Alt gedr\xFCckt, um die zum L\xF6schen markierten Elemente zur\xFCckzusetzen",
		firefox_clipboard_write:
			'Diese Funktion kann wahrscheinlich aktiviert werden, indem die Einstellung "dom.events.asyncClipboard.clipboardItem" auf "true" gesetzt wird. Um die Browsereinstellungen in Firefox zu \xE4ndern, besuche die Seite "about:config".',
		disableSnapping:
			"Halte CtrlOrCmd gedr\xFCckt, um das Einrasten zu deaktivieren",
	},
	u = {
		cannotShowPreview: "Vorschau kann nicht angezeigt werden",
		canvasTooBig: "Die Leinwand ist m\xF6glicherweise zu gro\xDF.",
		canvasTooBigTip:
			"Tipp: Schiebe die am weitesten entfernten Elemente ein wenig n\xE4her zusammen.",
	},
	h = {
		headingMain:
			"Es ist ein Fehler aufgetreten. Versuche <button>die Seite neu zu laden.</button>",
		clearCanvasMessage:
			"Wenn das Neuladen nicht funktioniert, versuche <button>die Zeichenfl\xE4che zu l\xF6schen.</button>",
		clearCanvasCaveat: " Dies wird zum Verlust von Daten f\xFChren ",
		trackedToSentry:
			"Der Fehler mit der Kennung {{eventId}} wurde in unserem System registriert.",
		openIssueMessage:
	...
	c = {
		...
		desc_privacy:
			"Keine Sorge, die Sitzung nutzt eine Ende-zu-Ende-Verschl\xFCsselung. Alles was du zeichnest, bleibt privat. Auch unser Server sieht nicht, was du dir einfallen l\xE4sst.",
		...
		desc_shareLink:
			"Teile diesen Link mit allen, mit denen du zusammenarbeiten m\xF6chtest:",
		desc_exitSession:
			"Wenn du die Sitzung beendest, wird deine Verbindung zum Raum getrennt. Du kannst jedoch lokal weiter an der Zeichnung arbeiten. Beachte, dass dies keine Auswirkungen auf andere hat und diese weiterhin gemeinsam an ihrer Version arbeiten k\xF6nnen.",
	...
	m = {
		...
		disk_details:
			"Exportiere die Zeichnungsdaten in eine Datei, die Du sp\xE4ter importieren kannst.",
		...
		excalidrawplus_description:
			"Speichere die Szene in deinem Excalidraw+ Arbeitsbereich.",
	...
	k = { title: "Zeichenfl\xE4che l\xF6schen" },
	p = {
		...
		placeholder: {
			...
			libraryDesc:
				"Beschreibung deiner Bibliothek, um anderen Nutzern bei der Verwendung zu helfen",
			githubHandle:
				"GitHub-Handle (optional), damit du die Bibliothek bearbeiten kannst, wenn sie zur \xDCberpr\xFCfung eingereicht wurde",
			twitterHandle:
				"Twitter-Benutzername (optional), damit wir wissen, wen wir bei Werbung \xFCber Twitter nennen k\xF6nnen",
			website:
				"Link zu deiner pers\xF6nlichen Webseite oder zu anderer Seite (optional)",
		},
		errors: { required: "Erforderlich", website: "G\xFCltige URL eingeben" },
		noteDescription:
			"Sende deine Bibliothek ein, um in die <link>\xF6ffentliche Bibliotheks-Repository aufgenommen zu werden</link>damit andere Nutzer sie in ihren Zeichnungen verwenden k\xF6nnen.",
		noteGuidelines:
			"Die Bibliothek muss zuerst manuell freigegeben werden. Bitte lies die <link>Richtlinien</link> vor dem Absenden. Du ben\xF6tigst ein GitHub-Konto, um zu kommunizieren und \xC4nderungen vorzunehmen, falls erforderlich, aber es ist nicht unbedingt erforderlich.",
		noteLicense:
			"Mit dem Absenden stimmst du zu, dass die Bibliothek unter der <link>MIT-Lizenz, </link>die zusammengefasst beinhaltet, dass jeder sie ohne Einschr\xE4nkungen nutzen kann.",
		noteItems:
			"Jedes Bibliothekselement muss einen eigenen Namen haben, damit es gefiltert werden kann. Die folgenden Bibliothekselemente werden hinzugef\xFCgt:",
		atleastOneLibItem:
			"Bitte w\xE4hle mindestens ein Bibliothekselement aus, um zu beginnen",
		republishWarning:
			"Hinweis: Einige der ausgew\xE4hlten Elemente sind bereits als ver\xF6ffentlicht/eingereicht markiert. Du solltest Elemente nur erneut einreichen, wenn Du eine existierende Bibliothek oder Einreichung aktualisierst.",
	},
	z = {
		title: "Bibliothek \xFCbermittelt",
		content:
			"Vielen Dank {{authorName}}. Deine Bibliothek wurde zur \xDCberpr\xFCfung eingereicht. Du kannst den Status verfolgen<link>hier</link>",
	},
	f = {
		resetLibrary: "Bibliothek zur\xFCcksetzen",
...
Dieses wird die exportierte Datei vergr\xF6\xDFern.`,
	...
	S = {
		tooltip:
			"Da deine Zeichnungen Ende-zu-Ende verschl\xFCsselt werden, sehen auch unsere Excalidraw-Server sie niemals.",
...
einzuf\xFCgen oder in einen existierenden Texteditor einzuf\xFCgen`,
		unableToEmbed:
			"Einbetten dieser URL ist derzeit nicht zul\xE4ssig. Erstelle einen Issue auf GitHub, um die URL freigeben zu lassen",
		unrecognizedLinkFormat:
			"Der Link, den Du eingebettet hast, stimmt nicht mit dem erwarteten Format \xFCberein. Bitte versuche den 'embed' String einzuf\xFCgen, der von der Quellseite zur Verf\xFCgung gestellt wird",
	},
	E = {
	...
	L = {
		action: {
			exportToImage: {
				...
				description:
					"Exportiere die Zeichnungsdaten als ein Bild, von dem Du sp\xE4ter importieren kannst.",
			},
			saveToDisk: {
				title: "Auf Festplatte speichern",
				button: "Auf Festplatte speichern",
				description:
					"Exportiere die Zeichnungsdaten in eine Datei, von der Du sp\xE4ter importieren kannst.",
			},
			excalidrawPlus: {
				title: "Excalidraw+",
		...
		modal: {
			loadFromFile: {
				...
				description:
					"Das Laden aus einer Datei wird <bold>Deinen vorhandenen Inhalt ersetzen</bold>.<br></br>Du kannst Deine Zeichnung zuerst mit einer der folgenden Optionen sichern.",
			},
			shareableLink: {
				title: "Aus Link laden",
				button: "Meinen Inhalt ersetzen",
				description:
					"Das Laden einer externen Zeichnung wird <bold>Deinen vorhandenen Inhalt ersetzen</bold>.<br></br>Du kannst Deine Zeichnung zuerst mit einer der folgenden Optionen sichern.",
			},
		},
	},
	T = {
		...
		button: "Einf\xFCgen",
		description:
			"Derzeit werden nur <flowchartLink>Flussdiagramme</flowchartLink>, <sequenceLink>Sequenzdiagramme</sequenceLink> und <classLink>Klassendiagramme</classLink> unterst\xFCtzt. Die anderen Typen werden als Bild in Excalidraw dargestellt.",
