...
var a = {
		...
		lineEditor: { edit: "Muokkaa rivi\xE4", exit: "Poistu rivieditorista" },
		elementLock: {
			lock: "Lukitse",
	...
	t = {
		...
		hint_emptyLibrary:
			"Valitse lis\xE4tt\xE4v\xE4 kohde piirtoalueelta, tai asenna alta julkinen kirjasto.",
		hint_emptyPrivateLibrary:
			"Valitse lis\xE4tt\xE4v\xE4 kohde piirtoalueelta.",
	},
	n = {
	...
	o = {
		...
		couldNotCreateShareableLinkTooBig:
			"Jaettavaa linkki\xE4 ei voitu luoda: teos on liian suuri",
		...
		uploadedSecurly:
			"L\xE4hetys on turvattu p\xE4\xE4st\xE4-p\xE4\xE4h\xE4n-salauksella. Excalidrawin palvelin ja kolmannet osapuolet eiv\xE4t voi lukea sis\xE4lt\xF6\xE4.",
		loadSceneOverridePrompt:
			"Ulkopuolisen piirroksen lataaminen korvaa nykyisen sis\xE4lt\xF6si. Jatketaanko?",
...
(Jos haluat s\xE4ilytt\xE4\xE4 paikallisesti tallennetun piirustuksen, sulje selaimen v\xE4lilehti lopettamisen sijaan.)`,
		...
		confirmAddLibrary:
			"T\xE4m\xE4 lis\xE4\xE4 {{numShapes}} muotoa kirjastoosi. Jatketaanko?",
		imageDoesNotContainScene:
			"T\xE4m\xE4 kuva ei n\xE4yt\xE4 sis\xE4lt\xE4v\xE4n piirrostietoja. Oletko ottanut k\xE4ytt\xF6\xF6n piirroksen tallennuksen viennin aikana?",
		cannotRestoreFromImage:
			"Teosta ei voitu palauttaa t\xE4st\xE4 kuvatiedostosta",
		invalidSceneUrl:
			"Teosta ei voitu tuoda annetusta URL-osoitteesta. Tallenne on vioittunut, tai osoitteessa ei ole Excalidraw JSON-dataa.",
		...
		invalidEncryptionKey:
			"Salausavaimen on oltava 22 merkki\xE4 pitk\xE4. Live-yhteisty\xF6 ei ole k\xE4yt\xF6ss\xE4.",
...
Muutoksiasi ei tallenneta!`,
	...
	s = {
		...
		imageInsertError:
			"Kuvan lis\xE4\xE4minen ep\xE4onnistui. Yrit\xE4 my\xF6hemmin uudelleen...",
		fileTooBig: "Tiedosto on liian suuri. Suurin sallittu koko on {{maxSize}}.",
		svgImageInsertError:
			"SVG- kuvaa ei voitu lis\xE4t\xE4. Tiedoston SVG-sis\xE4lt\xF6 n\xE4ytt\xE4\xE4 virheelliselt\xE4.",
		failedToFetchImage: "",
		invalidSVGString: "Virheellinen SVG.",
		cannotResolveCollabServer:
			"Yhteyden muodostaminen collab-palvelimeen ep\xE4onnistui. Virkist\xE4 sivu ja yrit\xE4 uudelleen.",
		importLibraryError: "Kokoelman lataaminen ep\xE4onnistui",
		collabSaveFailed:
			"Ei voitu tallentaan palvelimen tietokantaan. Jos ongelmia esiintyy, sinun kannatta tallentaa tallentaa tiedosto paikallisesti varmistaaksesi, ett\xE4 et menet\xE4 ty\xF6t\xE4si.",
	...
	k = {
		canvasPanning:
			"Piirtoalueen liikuttamiseksi pid\xE4 hiiren py\xF6r\xE4\xE4 tai v\xE4lily\xF6nti\xE4 pohjassa tai k\xE4yt\xE4 k\xE4sity\xF6kalua",
		linearElement:
			"Klikkaa piirt\xE4\xE4ksesi useampi piste, raahaa piirt\xE4\xE4ksesi yksitt\xE4inen viiva",
		...
		linearElementMulti:
			"Lopeta klikkaamalla viimeist\xE4 pistett\xE4, painamalla Escape- tai Enter-n\xE4pp\xE4int\xE4",
		lockAngle:
			"Voit rajoittaa kulmaa pit\xE4m\xE4ll\xE4 SHIFT-n\xE4pp\xE4int\xE4 alaspainettuna",
		resize:
			"Voit rajoittaa mittasuhteet pit\xE4m\xE4ll\xE4 SHIFT-n\xE4pp\xE4int\xE4 alaspainettuna kun muutat kokoa, pid\xE4 ALT-n\xE4pp\xE4int\xE4 alaspainettuna muuttaaksesi kokoa keskipisteen suhteen",
		resizeImage:
			"Voit muuttaa kokoa vapaasti pit\xE4m\xE4ll\xE4 SHIFTi\xE4 pohjassa, pid\xE4 ALT pohjassa muuttaaksesi kokoa keskipisteen ymp\xE4ri",
		rotate:
			"Voit rajoittaa kulman pit\xE4m\xE4ll\xE4 SHIFT pohjassa py\xF6ritt\xE4ess\xE4si",
		lineEditor_info:
			"Pid\xE4 CtrlOrCmd pohjassa ja kaksoisnapsauta tai paina CtrlOrCmd + Enter muokataksesi pisteit\xE4",
		lineEditor_pointSelected:
			"Poista piste(et) painamalla delete, monista painamalla CtrlOrCmd+D, tai liikuta raahaamalla",
		lineEditor_nothingSelected:
			"Valitse muokattava piste (monivalinta pit\xE4m\xE4ll\xE4 SHIFT pohjassa), tai paina Alt ja klikkaa lis\xE4t\xE4ksesi uusia pisteit\xE4",
		placeImage:
			"Klikkaa asettaaksesi kuvan, tai klikkaa ja raahaa asettaaksesi sen koon manuaalisesti",
		publishLibrary: "Julkaise oma kirjasto",
		bindTextToElement: "Lis\xE4\xE4 teksti\xE4 painamalla enter",
		deepBoxSelect:
			"K\xE4yt\xE4 syv\xE4valintaa ja est\xE4 raahaus painamalla CtrlOrCmd",
		eraserRevert:
			"Pid\xE4 Alt alaspainettuna, kumotaksesi merkittyjen elementtien poistamisen",
		firefox_clipboard_write:
			'T\xE4m\xE4 ominaisuus voidaan todenn\xE4k\xF6isesti ottaa k\xE4ytt\xF6\xF6n asettamalla "dom.events.asyncClipboard.clipboardItem" kohta "true":ksi. Vaihtaaksesi selaimen kohdan Firefoxissa, k\xE4y "about:config" sivulla.',
		disableSnapping: "",
	},
	u = {
		...
		canvasTooBigTip:
			"Vinkki: yrit\xE4 siirt\xE4\xE4 kaukaisimpia elementtej\xE4 hieman l\xE4hemm\xE4s toisiaan.",
	},
	m = {
		headingMain:
			"Tapahtui virhe. Yrit\xE4 <button>sivun lataamista uudelleen.</button>",
		clearCanvasMessage:
			"Mik\xE4li sivun lataaminen uudelleen ei auta, yrit\xE4 <button>tyhjent\xE4\xE4 piirtoalue.</button>",
		clearCanvasCaveat: " T\xE4m\xE4 johtaa ty\xF6n menetykseen ",
		trackedToSentry:
			"Virhe tunnisteella {{eventId}} tallennettiin j\xE4rjestelm\xE4\xE4mme.",
		openIssueMessage:
			"Olimme varovaisia emmek\xE4 sis\xE4llytt\xE4neet tietoa piirroksestasi virheeseen. Mik\xE4li piirroksesi ei ole yksityinen, harkitsethan kertovasi meille <button>virheenseurantaj\xE4rjestelm\xE4ss\xE4mme.</button> Sis\xE4llyt\xE4 alla olevat tiedot kopioimalla ne GitHub-ongelmaan.",
		sceneContent: "Piirroksen tiedot:",
	},
	d = {
		desc_intro:
			"Voit kutsua ihmisi\xE4 piirrokseesi tekem\xE4\xE4n yhteisty\xF6t\xE4 kanssasi.",
		desc_privacy:
			"\xC4l\xE4 huoli, istunto k\xE4ytt\xE4\xE4 p\xE4\xE4st\xE4-p\xE4\xE4h\xE4n-salausta, joten mit\xE4 tahansa piirr\xE4tkin, se pysyy salassa. Edes palvelimemme eiv\xE4t n\xE4e mit\xE4 keksit.",
		...
		desc_shareLink:
			"Jaa t\xE4m\xE4 linkki kenelle tahansa, jonka kanssa haluat tehd\xE4 yhteisty\xF6t\xE4:",
		desc_exitSession:
			"Istunnon pys\xE4ytt\xE4minen katkaisee yhteyden huoneeseen, mutta voit viel\xE4 jatkaa ty\xF6skentely\xE4 paikallisesti. Huomaa, ett\xE4 t\xE4m\xE4 ei vaikuta muihin k\xE4ytt\xE4jiin ja he voivat jatkaa oman versionsa parissa ty\xF6skentely\xE4.",
	...
	v = {
		...
		disk_details:
			"Vie ty\xF6n tiedot tiedostoon, josta sen voi tuoda my\xF6hemmin.",
		...
		excalidrawplus_exportError:
			"Ei voitu vied\xE4 Excalidraw+-palveluun t\xE4ll\xE4 hetkell\xE4...",
	},
	y = {
		blog: "Lue blogiamme",
		click: "klikkaa",
	...
	c = {
		...
		placeholder: {
			...
			libraryDesc:
				"Kirjaston kuvaus, joka auttaa ihmisi\xE4 ymm\xE4rt\xE4m\xE4\xE4n sen k\xE4ytt\xF6tarkoitukset",
			githubHandle:
				"GitHub-tunnuksesi (valinnainen), jotta voit muokata kirjastoa sen j\xE4lkeen kun se on l\xE4hetetty tarkastettavaksi",
			twitterHandle:
				"Twitter-tunnus (valinnainen), jotta tied\xE4mme ket\xE4 kiitt\xE4\xE4 kun viestimme Twitteriss\xE4",
			website:
				"Linkki henkil\xF6kohtaiselle verkkosivustollesi tai muualle (valinnainen)",
		},
		errors: {
			required: "Pakollinen",
		...
		noteDescription:
			"L\xE4het\xE4 kirjastosi, jotta se voidaan sis\xE4llytt\xE4\xE4 <link>julkisessa kirjastolistauksessa</link>muiden k\xE4ytt\xF6\xF6n omissa piirrustuksissaan.",
		noteGuidelines:
			"Kirjasto on ensin hyv\xE4ksytt\xE4v\xE4 manuaalisesti. Ole hyv\xE4 ja lue <link>ohjeet</link> ennen l\xE4hett\xE4mist\xE4. Tarvitset GitHub-tilin, jotta voit viesti\xE4 ja tehd\xE4 muutoksia pyydett\xE4ess\xE4, mutta se ei ole ehdottoman v\xE4ltt\xE4m\xE4t\xF6nt\xE4.",
		noteLicense:
			"L\xE4hett\xE4m\xE4ll\xE4 hyv\xE4ksyt ett\xE4 kirjasto julkaistaan <link>MIT-lisenssin </link>alla, mik\xE4 lyhyesti antaa muiden k\xE4ytt\xE4\xE4 sit\xE4 ilman rajoituksia.",
		noteItems:
			"Jokaisella kirjaston kohteella on oltava oma nimens\xE4 suodatusta varten. Seuraavat kirjaston kohteet sis\xE4ltyv\xE4t:",
		atleastOneLibItem:
			"Valitse v\xE4hint\xE4\xE4n yksi kirjaston kohde aloittaaksesi",
		republishWarning:
			"Huom! Osa valituista kohteista on merkitty jo julkaistu/l\xE4hetetyiksi. L\xE4het\xE4 kohteita uudelleen vain p\xE4ivitett\xE4ess\xE4 olemassa olevaa kirjastoa tai ehdotusta.",
	},
	b = {
		title: "Kirjasto l\xE4hetetty",
		content:
			"Kiitos {{authorName}}. Kirjastosi on l\xE4hetetty tarkistettavaksi. Voit seurata sen tilaa<link>t\xE4\xE4ll\xE4</link>",
	},
	g = {
		resetLibrary: "Tyhjenn\xE4 kirjasto",
	...
	T = {
		tooltip:
			"Piirroksesi ovat p\xE4\xE4st\xE4-p\xE4\xE4h\xE4n-salattuja, joten Excalidrawin palvelimet eiv\xE4t koskaan n\xE4e niit\xE4.",
...
tai liitt\xE4\xE4ksesi olemassa olevaan tekstieditoriin`,
	...
	P = {
		app: {
			center_heading:
				"Kaikki tietosi on tallennettu paikallisesti selaimellesi.",
	...
	E = { title: "", button: "", description: "", syntax: "", preview: "" },
	V = {
		labels: a,
		library: t,
		buttons: n,
