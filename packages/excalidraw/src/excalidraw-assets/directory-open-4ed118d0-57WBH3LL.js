import { a as p } from "./chunk-M2JW2GFW.js";
...
var w = async (e, i, r = e.name, n) => {
			...
			for (
				var h,
					y = (function (t) {
						...
						for (
							typeof Symbol < "u" &&
							((a = Symbol.asyncIterator), (u = Symbol.iterator));
							m--;
						) {
							if (a && (o = t[a]) != null) return o.call(t);
							if (u && (o = t[u]) != null) return new l(o.call(t));
							(a = "@@asyncIterator"), (u = "@@iterator");
						}
						throw new TypeError("Object is not async iterable");
					})(e.values());
				(c = !(h = await y.next()).done);
				c = !1
			) {
				let t = h.value,
					o = `${r}/${t.name}`;
	...
	P = async (e = {}) => {
		...
		let i = await window.showDirectoryPicker({ id: e.id, startIn: e.startIn });
		return w(i, e.recursive, void 0, e.skipDirectory);
	};
export { P as default };
