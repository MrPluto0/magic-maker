...
import { f as K } from "./chunk-SXMPUQ6M.js";
et();
var Dt = K(St(), 1),
	te = K(Et(), 1),
	ee = K(Tt(), 1);
			...
			performAction: function (i, r, c, d, u, l, $) {
				...
				switch (u) {
					...
					case 7:
						...
						break;
					case 8:
						d.getCommonDb().setDiagramTitle(l[x].substr(6)),
							(this.$ = l[x].substr(6));
						break;
					case 9:
			...
			parse: function (i) {
				...
				function z() {
					...
					return (
						(L = d.pop() || k.lex() || A),
						typeof L != "number" &&
							(L instanceof Array && ((d = L), (L = d.pop())),
							(L = r.symbols_[L] || L)),
						L
					);
				}
				for (var b, M, E, Z, R = {}, j, N, tt, G; ; ) {
					if (
						((M = c[c.length - 1]),
						this.defaultActions[M]
							? (E = this.defaultActions[M])
							: ((b === null || typeof b > "u") && (b = z()),
								(E = $[M] && $[M][b])),
						typeof E > "u" || !E.length || !E[0])
					) {
						var J = "";
						G = [];
						for (j in $[M])
					...
					switch (E[0]) {
						...
						case 2:
							...
							N &&
								...
								(u = u.slice(0, -1 * N)),
								(l = l.slice(0, -1 * N))),
								c.push(this.productions_[E[1]][0]),
								u.push(R.$),
								l.push(R._$),
								(tt = $[c[c.length - 2]][c[c.length - 1]]),
								c.push(tt);
							break;
						case 3:
							return !0;
			...
			var g = {
				...
				unput: function (i) {
					...
					return (
						...
						this.options.ranges &&
							(this.yylloc.range = [u[0], u[0] + this.yyleng - r]),
...
` +
				...
				next: function () {
					...
					for (var u = this._currentRules(), l = 0; l < u.length; l++)
						if (
							((c = this._input.match(this.rules[u[l]])),
							c && (!r || c[0].length > r[0].length))
						) {
							if (((r = c), (d = l), this.options.backtrack_lexer)) {
								if (((i = this.test_match(c, u[l])), i !== !1)) return i;
								if (this._backtrack) {
									r = !1;
									continue;
								} else return !1;
					...
					return r
						? ((i = this.test_match(r, u[d])), i !== !1 ? i : !1)
						: this._input === ""
							? this.EOF
							: this.parseError(
									"Lexical error on line " +
...
var It = X,
	...
	pt = () => ot,
	yt = function () {
		(Y.length = 0), (q.length = 0), (F = ""), (V.length = 0), at();
	},
	ft = function (n) {
		(F = n), Y.push(n);
	},
	...
	_t = function (n) {
		V.find((e) => e.id === ut - 1).events.push(n);
	},
	bt = function (n) {
		let t = { section: F, type: F, description: n, task: n, classes: [] };
		q.push(t);
	},
	ct = function () {
		let n = function (e) {
			...
			t = !0;
		for (let [e, a] of V.entries()) n(e), (t = t && a.processed);
		return t;
	},
	$t = {
		clear: yt,
	...
	Pt = function (n, t) {
		...
		let a = n.append("polygon");
		a.attr("points", e(t.x, t.y, 50, 20, 7)),
	...
	Ht = function (n, t, e) {
		...
		(s.x = t.x),
			...
			(s.width = e.width),
			(s.height = e.height),
			(s.class = "journey-section section-type-" + t.num),
			(s.rx = 3),
			(s.ry = 3),
			U(a, s),
			vt(e)(
	...
	Ct = function (n, t, e) {
		...
		s
			...
			.attr("stroke", "#666"),
			Mt(s, { cx: a, cy: 300 + (5 - t.score) * 30, score: t.score });
		let o = D();
		(o.x = t.x),
			(o.y = t.y),
			(o.fill = t.fill),
	...
	vt = (function () {
		...
		function t(s, h, o, p, y, f, _, m, g) {
			let { taskFontSize: i, taskFontFamily: r } = m,
				c = s.split(/<br\s*\/?>/gi);
			for (let d = 0; d < c.length; d++) {
				let u = d * i - (i * (c.length - 1)) / 2,
					l = h
						.append("text")
						.attr("x", o + y / 2)
						.attr("y", p)
		...
		function a(s, h) {
			for (let o in h) o in h && s.attr(o, h[o]);
		}
		return function (s) {
	...
	n.each(function () {
		...
		for (let _ = 0; _ < a.length; _++)
			(s = a[a.length - 1 - _]),
				h.push(s),
				f.text(h.join(" ").trim()),
				(f.node().getComputedTextLength() > t || s === "<br>") &&
					(h.pop(),
					f.text(h.join(" ").trim()),
					s === "<br>" ? (h = [""]) : (h = [s]),
					(f = e
...
var Vt = function (n, t, e, a) {
		...
		let o = h.append("g"),
			...
			f = p
				...
				.getBBox(),
			_ =
				a.fontSize && a.fontSize.replace
					? a.fontSize.replace("px", "")
					: a.fontSize;
		return (
			(t.height = f.height + _ * 1.1 * 0.5 + t.padding),
	...
	Ot = function (n, t, e, a) {
		...
		let o = lt(),
			p = o.leftMargin ?? 50;
		w.debug("timeline", a.db);
		let y = o.securityLevel,
			f;
		y === "sandbox" && (f = O("#i" + t));
		let m = (
			y === "sandbox" ? O(f.nodes()[0].contentDocument.body) : O("body")
		).select("#" + t);
		m.append("g");
		let g = a.db.getTasks(),
			i = a.db.getCommonDb().getDiagramTitle();
		w.debug("task", g), H.initGraphics(m);
		let r = a.db.getSections();
		w.debug("sections", r);
		let c = 0,
			d = 0,
			u = 0,
		...
		r.forEach(function (S) {
			...
			w.debug("sectionHeight before draw", I), (c = Math.max(c, I + 20));
		});
		let C = 0,
			A = 0;
		w.debug("tasks.length", g.length);
		for (let [S, v] of g.entries()) {
			let I = {
					number: S,
					descr: v,
					section: v.section,
			...
			w.debug("taskHeight before draw", P),
				(d = Math.max(d, P + 20)),
				(C = Math.max(C, v.events.length));
			let z = 0;
			for (let b = 0; b < v.events.length; b++) {
				...
				z += H.getVirtualNodeHeight(m, E, o);
			}
			A = Math.max(A, z);
		}
		w.debug("maxSectionHeight before draw", c),
			w.debug("maxTaskHeight before draw", d),
			r && r.length > 0
				? r.forEach((S) => {
						let v = g.filter((b) => b.section === S),
							I = {
								number: T,
								descr: S,
								section: T,
						...
						w.debug("sectionNode", I);
						let P = m.append("g"),
							z = H.drawNode(P, I, T, o);
						w.debug("sectionNode output", z),
							P.attr("transform", `translate(${$}, ${l})`),
							(x += c + 50),
							v.length > 0 && dt(m, v, T, $, x, d, o, C, A, c, !1),
							($ += 200 * Math.max(v.length, 1)),
							(x = l),
							T++;
					})
				: ((W = !1), dt(m, g, T, $, x, d, o, C, A, c, !0));
		let B = m.node().getBBox();
		w.debug("bounds", B),
			i &&
				m
					.append("text")
	...
	dt = function (n, t, e, a, s, h, o, p, y, f, _) {
		var m;
		for (let g of t) {
			let i = {
				descr: g.task,
			...
			w.debug("taskNode", i);
			let r = n.append("g").attr("class", "taskWrapper"),
				d = H.drawNode(r, i, e, o).height;
			if (
				(w.debug("taskHeight after draw", d),
				r.attr("transform", `translate(${a}, ${s})`),
				(h = Math.max(h, d)),
				g.events)
			) {
				let u = n.append("g").attr("class", "lineWrapper"),
					l = h;
				(s += 100),
					(l = l + jt(n, g.events, e, a, s, o)),
					(s -= 100),
					u
						.append("line")
						.attr("x1", a + 190 / 2)
			...
			(a = a + 200),
				_ && !((m = o.timeline) != null && m.disableMulticolor) && e++;
		}
		s = s - 10;
	},
	jt = function (n, t, e, a, s, h) {
		let o = 0,
			p = s;
		s = s + 100;
		for (let y of t) {
			...
			w.debug("eventNode", f);
			let _ = n.append("g").attr("class", "eventWrapper"),
				g = H.drawNode(_, f, e, h).height;
			(o = o + g),
				_.attr("transform", `translate(${a}, ${s})`),
				(s = s + 10 + g);
		}
		return (s = p), o;
	},
	...
	qt = (n) => {
		...
		for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
			(n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e]),
				nt(n["lineColor" + e])
					? (n["lineColor" + e] = st(n["lineColor" + e], 20))
					: (n["lineColor" + e] = it(n["lineColor" + e], 20));
		for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
			let a = "" + (17 - 3 * e);
			t += `
...
`,
	Zt = Ut,
	ne = { db: Nt, renderer: Gt, parser: It, styles: Zt };
