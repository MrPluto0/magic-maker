...
var r = {
		...
		elementLock: { lock: "", unlock: "", lockAll: "", unlockAll: "" },
		statusPublished: "",
		sidebarLock: "",
	...
	i = { noItems: "", hint_emptyLibrary: "", hint_emptyPrivateLibrary: "" },
	n = {
	...
	l = {
		...
		couldNotCreateShareableLinkTooBig:
			"Kunne ikkje opprette deleleg lenke: scena er for stor",
		...
		uploadedSecurly:
			"Opplastinga er kryptert og er ikkje mogleg \xE5 lese av Excalidraw-serveren eller tredjepartar.",
		loadSceneOverridePrompt:
			"Innlasting av ekstern teikning erstattar ditt eksisterande innhald. Ynskjer du \xE5 fortsette?",
...
(\xD8nsker du \xE5 halde fram med denne? D\xE5 er det berre \xE5 lukke denne fana.)`,
		...
		confirmAddLibrary:
			"Dette vil legge til {{numShapes}} form(er) i biblioteket ditt. Er du sikker?",
		imageDoesNotContainScene:
			"Dette biletet ser ikkje ut til \xE5 ha noko scenedata. Har du skrutt p\xE5 innbygging av scene medan eksporteringa heldt p\xE5?",
		cannotRestoreFromImage:
			"Scena kunne ikkje gjenopprettast fr\xE5 denne biletfila",
		invalidSceneUrl:
			"Kunne ikkje hente noko scene fr\xE5 den URL-en. Ho er anten \xF8ydelagd eller inneheld ikkje gyldig Excalidraw JSON-data.",
		resetLibrary:
			"Dette vil fjerne alt innhald fr\xE5 biblioteket. Er du sikker?",
		removeItemsFromsLibrary: "Slette {{count}}\xA0element fr\xE5 biblioteket?",
		invalidEncryptionKey:
			"Krypteringsn\xF8kkelen m\xE5 ha 22 teikn. Sanntidssamarbeid er deaktivert.",
	...
	a = {
		...
		svgImageInsertError:
			"Kunne ikkje sette inn SVG-biletet. SVG-koden ser ugyldig ut.",
		failedToFetchImage: "",
		invalidSVGString: "Ugyldig SVG.",
		cannotResolveCollabServer:
			"Kunne ikkje kople til samarbeidsserveren. Ver vennleg \xE5 oppdatere inn sida og pr\xF8v p\xE5 nytt.",
		importLibraryError: "",
		collabSaveFailed: "",
	...
	s = {
		canvasPanning: "",
		linearElement:
			"Klikk for \xE5 starte linje med fleire punkt, eller drag for ei enkel linje",
		...
		text_editing:
			"Trykk Escape eller CtrlOrCmd+ENTER for \xE5 fullf\xF8re redigeringa",
		linearElementMulti:
...
eller hald inne Alt og klikk for \xE5 legge til nye punkt`,
		placeImage:
			"Klikk for \xE5 plassere biletet, eller klikk og drag for \xE5 velje storleik manuelt",
		publishLibrary: "Publiser ditt eige bibliotek",
		bindTextToElement: "Trykk p\xE5 enter for \xE5 legge til tekst",
		deepBoxSelect:
			"Hald inne Ctrl / Cmd for \xE5 velje djupt, og forhindre flytting",
		eraserRevert:
			"Hald inne Alt for \xE5 reversere markering av element for sletting",
	...
	k = {
		...
		canvasTooBigTip:
			"Tips: pr\xF8v \xE5 flytte elementa som er lengst fr\xE5 kvarandre, litt n\xE6rare kvarandre.",
	},
	g = {
		headingMain:
			"Ein feil oppstod. Pr\xF8v <button>\xE5 laste sida p\xE5 nytt.</button>",
		clearCanvasMessage:
			"Om ny sidelasting ikkje fungerer, pr\xF8v <button>\xE5 t\xF8mme lerretet.</button>",
		clearCanvasCaveat: " Dette vil f\xF8re til tap av arbeid ",
		trackedToSentry:
			"Feilen med identifikator {{eventId}} vart logga i systemet v\xE5rt.",
		openIssueMessage:
			"Vi er veldig n\xF8ye med \xE5 ikkje inkludere scene-opplysingane dine i feilmeldinga. Viss scena di ikkje er privat kan du vurdere \xE5 f\xF8lge opp i <button>feilrapporteringssystemet v\xE5rt.</button> Ta med opplysingane nedanfor ved \xE5 kopiere og lime inn i GitHub-saka.",
		sceneContent: "Scene-innhald:",
	},
	m = {
		desc_intro:
			"Du kan invitere personar til scena di for \xE5 samarbeide med deg.",
		desc_privacy:
			"Ta det med ro; \xF8kta brukar ende-til-ende-kryptering, s\xE5 alt du teiknar held fram med \xE5 vere privat. Ikkje ein gong serveren v\xE5r kan sj\xE5 kva du lagar.",
		...
		desc_exitSession:
			"Dersom du avsluttar \xF8kta blir du kopla fr\xE5 rommet, men du kan halde fram med \xE5 arbeide med scena lokalt. Ver merksam p\xE5 at dette ikkje vil p\xE5verke andre personar, og desse vil framleis ha moglegheit til \xE5 samarbeide p\xE5 deira eigen versjon.",
	...
	b = {
		...
		excalidrawplus_description:
			"Lagre scena til Excalidraw+-arbeidsomr\xE5det ditt.",
		excalidrawplus_button: "Eksporter",
		excalidrawplus_exportError:
			"Kunne ikkje eksportere til Excalidraw+ akkurat no...",
	},
	u = {
	...
	v = {
		...
		placeholder: {
			...
			libraryDesc:
				"Skildring av biblioteket ditt s\xE5nn at andre forst\xE5r bruken av det",
			githubHandle:
				"GitHub-brukarnamn (valfritt), slik at du kan redigere bibiloteket n\xE5r det er sendt inn til vurdering",
			twitterHandle:
				"Twitter-brukarnamn (valfritt), s\xE5 vi veit kven vi skal kreditere p\xE5 Twitter",
			website:
				"Lenke til den personlege nettstaden din eller ein anna stad (valfritt)",
		},
		errors: { required: "Kravt", website: "Fyll inn ein gyldig URL" },
		noteDescription:
			"Send inn biblioteket ditt til inkludering i <link>den offentlege bibliotek-kjeldekoda</link>slik at andre kan bruke det i teikningane deira.",
		noteGuidelines:
			"Biblioteket m\xE5 godkjennast manuelt fyrst. Ver vennleg \xE5 lese <link>retningslinjene</link> f\xF8r du sender inn. Du kjem til \xE5 trenge ein GitHub-konto for \xE5 kommunisere og gjere endringar dersom kravt, men det er ikkje strengt naudsynt.",
		noteLicense:
			"Ved \xE5 sende inn godkjenner du at biblioteket vert publisert under <link>MIT-lisensen, </link>som kort sagt betyr at kven som helst kan bruke det utan avgrensingar.",
		noteItems:
			"Kvart bibliotekselement m\xE5 ha eit eige namn, slik at det er mogleg \xE5 filtrere. Dei f\xF8lgande bibliotekselementa blir inkludert:",
		atleastOneLibItem:
			"Ver vennleg \xE5 markere minst eitt bibliotekselement for \xE5 starte",
		republishWarning: "",
	},
	f = {
		title: "Bibliotek innsendt",
		content:
			"Tusen takk {{authorName}}! Biblioteket ditt har blitt sendt inn til gjennomgang. Du kan halde styr p\xE5 status<link>her</link>",
	},
	y = {
	...
	S = {
		tooltip:
			"Teikningane dine er ende-til-ende-krypterte slik at Excalidraw sine serverar aldri f\xE5r sj\xE5 dei.",
