...
var o = {
	...
	r = {
		...
		hint_emptyLibrary:
			"Seleccione um item na tela para adicion\xE1-lo aqui, ou ent\xE3o instale uma biblioteca do reposit\xF3rio p\xFAblico abaixo.",
		hint_emptyPrivateLibrary:
			"Seleccione um item na tela para adicion\xE1-lo aqui.",
	},
	i = {
	...
	t = {
		...
		couldNotCreateShareableLink:
			"N\xE3o foi poss\xEDvel criar um link partilh\xE1vel.",
		couldNotCreateShareableLinkTooBig:
			"N\xE3o foi poss\xEDvel criar um link partilh\xE1vel: a cena \xE9 muito grande",
		couldNotLoadInvalidFile:
			"N\xE3o foi poss\xEDvel carregar o ficheiro inv\xE1lido",
		importBackendFailed: "A importa\xE7\xE3o do servidor falhou.",
		cannotExportEmptyCanvas:
			"N\xE3o \xE9 poss\xEDvel exportar uma \xE1rea de desenho vazia.",
		...
		loadSceneOverridePrompt:
			"Se carregar um desenho externo substituir\xE1 o conte\xFAdo existente. Quer continuar?",
...
(Caso queira manter o \xFAltimo desenho, simplesmente feche a janela do navegador.)`,
		...
		confirmAddLibrary:
			"Isso adicionar\xE1 {{numShapes}} forma(s) \xE0 sua biblioteca. Tem a certeza?",
		imageDoesNotContainScene:
			"Esta imagem parece n\xE3o conter dados de cenas. Ativou a incorpora\xE7\xE3o da cena durante a exporta\xE7\xE3o?",
		cannotRestoreFromImage:
			"N\xE3o foi poss\xEDvel restaurar a cena deste ficheiro de imagem",
		invalidSceneUrl:
			"N\xE3o foi poss\xEDvel importar a cena a partir do URL fornecido. Ou est\xE1 mal formado ou n\xE3o cont\xE9m dados JSON do Excalidraw v\xE1lidos.",
		...
		invalidEncryptionKey:
			"Chave de encripta\xE7\xE3o deve ter 22 caracteres. A colabora\xE7\xE3o ao vivo est\xE1 desativada.",
...
As suas altera\xE7\xF5es n\xE3o ser\xE3o salvas!`,
	...
	n = {
		...
		imageInsertError:
			"N\xE3o foi poss\xEDvel inserir a imagem, tente novamente mais tarde...",
		fileTooBig:
			"O ficheiro \xE9 muito grande. O tamanho m\xE1ximo permitido \xE9 {{maxSize}}.",
		svgImageInsertError:
			"N\xE3o foi poss\xEDvel inserir a imagem SVG. A marca\xE7\xE3o SVG parece inv\xE1lida.",
		failedToFetchImage: "",
		invalidSVGString: "SVG inv\xE1lido.",
		cannotResolveCollabServer:
			"N\xE3o foi poss\xEDvel fazer a liga\xE7\xE3o ao servidor colaborativo. Por favor, volte a carregar a p\xE1gina e tente novamente.",
		importLibraryError: "N\xE3o foi poss\xEDvel carregar a biblioteca",
		collabSaveFailed:
			"N\xE3o foi poss\xEDvel guardar na base de dados de backend. Se os problemas persistirem, guarde o ficheiro localmente para garantir que n\xE3o perde o seu trabalho.",
		collabSaveFailed_sizeExceeded:
			"N\xE3o foi poss\xEDvel guardar na base de dados de backend, o ecr\xE3 parece estar muito grande. Deve guardar o ficheiro localmente para garantir que n\xE3o perde o seu trabalho.",
	...
	d = {
		canvasPanning:
			"Para mover a tela, carregue na roda do rato ou na barra de espa\xE7o enquanto arrasta, ou use a ferramenta da m\xE3o",
		linearElement:
		...
		embeddable: "",
		text_selected:
			"Clique duas vezes ou pressione a tecla Enter para editar o texto",
		text_editing:
			"Pressione a tecla Escape ou CtrlOrCmd+ENTER para terminar a edi\xE7\xE3o",
		linearElementMulti:
...
mantenha pressionada a tecla ALT para redimensionar do centro`,
		rotate:
			"Pode restringir os \xE2ngulos mantendo a tecla SHIFT premida enquanto roda",
		lineEditor_info:
			"Pressione CtrlOrCmd e fa\xE7a um duplo-clique ou pressione CtrlOrCmd + Enter para editar pontos",
		lineEditor_pointSelected:
			"Carregue na tecla Delete para remover o(s) ponto(s), CtrlOuCmd+D para duplicar, ou arraste para mover",
...
ou carregue em Alt e clique para acrescentar novos pontos`,
		placeImage:
			"Clique para colocar a imagem ou clique e arraste para definir o seu tamanho manualmente",
		publishLibrary: "Publique a sua pr\xF3pria biblioteca",
		bindTextToElement: "Carregue Enter para acrescentar texto",
		deepBoxSelect:
			"Mantenha a tecla CtrlOrCmd carregada para selec\xE7\xE3o profunda, impedindo o arrastamento",
		eraserRevert:
			"Carregue tamb\xE9m em Alt para reverter os elementos marcados para serem apagados",
		firefox_clipboard_write:
			'Esta fun\xE7\xE3o pode provavelmente ser ativada definindo a op\xE7\xE3o "dom.events.asyncClipboard.clipboardItem" como "true". Para alterar os sinalizadores do navegador no Firefox, visite a p\xE1gina "about:config".',
		disableSnapping: "",
	},
	c = {
		cannotShowPreview:
			"N\xE3o \xE9 poss\xEDvel mostrar uma pr\xE9-visualiza\xE7\xE3o",
	...
	m = {
		...
		clearCanvasMessage:
			"Se a recarga n\xE3o funcionar, tente <button>a limpar a \xE1rea de desenho.</button>",
		...
		openIssueMessage:
			"Fomos muito cautelosos para n\xE3o incluir suas informa\xE7\xF5es de cena no erro. Se sua cena n\xE3o for privada, por favor, considere seguir nosso <button>rastreador de bugs.</button> Por favor, inclua informa\xE7\xF5es abaixo, copiando e colando no relat\xF3rio de erros no GitHub.",
		sceneContent: "Conte\xFAdo da cena:",
	},
	p = {
		desc_intro: "Pode convidar pessoas para colaborarem na sua cena atual.",
		desc_privacy:
			"N\xE3o se preocupe, a sess\xE3o usa criptografia de ponta-a-ponta, por isso o que desenhar permanecer\xE1 privado. Nem mesmo o nosso servidor poder\xE1 ver o que cria.",
		...
		desc_shareLink:
			"Partilhe este link com qualquer pessoa com quem queira colaborar:",
		desc_exitSession:
			"Interrompendo a sess\xE3o ir\xE1 desconectar-se da sala, mas poder\xE1 continuar a trabalhar com a cena localmente. Note que isso n\xE3o afetar\xE1 outras pessoas e elas ainda poder\xE3o colaborar nas vers\xF5es deles.",
		shareTitle:
			"Participe numa sess\xE3o de colabora\xE7\xE3o ao vivo no Excalidraw",
	},
	u = { title: "Erro" },
	b = {
		disk_title: "Guardar no disco",
		disk_details:
			"Exportar os dados da cena para um ficheiro do qual poder\xE1 importar mais tarde.",
		...
		excalidrawplus_description:
			"Guardar a cena no seu espa\xE7o de trabalho Excalidraw+",
		excalidrawplus_button: "Exportar",
		excalidrawplus_exportError:
			"N\xE3o foi poss\xEDvel exportar para o Excalidraw+ neste momento...",
	},
	g = {
		...
		deepBoxSelect:
			"Selec\xE7\xE3o profunda dentro da caixa, impedindo que seja arrastada",
	...
	h = {
		...
		placeholder: {
			...
			libraryDesc:
				"Descri\xE7\xE3o da sua biblioteca para ajudar as pessoas a entender a utiliza\xE7\xE3o dela",
			githubHandle:
				"Identificador do GitHub (opcional), para que possa editar a biblioteca depois desta ser enviada para revis\xE3o",
			twitterHandle:
				"Nome do Twitter (opcional), para que saibamos quem merece os cr\xE9ditos na promo\xE7\xE3o via Twitter",
			website:
		...
		noteDescription:
			"Envie a sua biblioteca para ser inclu\xEDda no <link>reposit\xF3rio de bibliotecas p\xFAblicas</link>para outras pessoas a poderem usar nos seus pr\xF3prios desenhos.",
		noteGuidelines:
			"A biblioteca precisa ser aprovada manualmente primeiro. Por favor, leia <link>orienta\xE7\xF5es</link> antes de enviar. Vai precisar de uma conta no GitHub para comunicar e fazer altera\xE7\xF5es se solicitado, mas n\xE3o \xE9 estritamente necess\xE1ria.",
		noteLicense:
			"Ao enviar, concorda que a biblioteca ser\xE1 publicada sob a <link>Licen\xE7a MIT, </link>o que significa, de forma resumida, que qualquer pessoa pode utiliz\xE1-la sem restri\xE7\xF5es.",
		noteItems:
			"Cada item da biblioteca deve ter o seu pr\xF3prio nome para que este seja pesquis\xE1vel com filtros. Os seguintes itens da biblioteca ser\xE3o inclu\xEDdos:",
		atleastOneLibItem:
			"Por favor, seleccione pelo menos um item da biblioteca para come\xE7ar",
		republishWarning:
			"Nota: alguns dos itens seleccionados est\xE3o marcados como j\xE1 publicados/enviados. S\xF3 deve reenviar itens ao actualizar uma biblioteca existente ou submiss\xE3o.",
	},
	f = {
		title: "Biblioteca enviada",
		content:
			"Obrigado {{authorName}}. A sua biblioteca foi enviada para an\xE1lise. Pode acompanhar o status<link>aqui</link>",
	},
	S = {
		resetLibrary: "Repor a biblioteca",
	...
	C = {
		tooltip:
			"Os seus desenhos s\xE3o encriptados de ponta-a-ponta, por isso os servidores do Excalidraw nunca os ver\xE3o.",
...
ou colar num editor de texto existente`,
	...
	z = { title: "", button: "", description: "", syntax: "", preview: "" },
	q = {
		labels: o,
		library: r,
		buttons: i,
