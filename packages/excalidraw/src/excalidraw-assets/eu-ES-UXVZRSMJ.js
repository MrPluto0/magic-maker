...
var t = {
		...
		lineEditor: { edit: "Editatu lerroa", exit: "Irten lerro-editoretik" },
		elementLock: {
			lock: "Blokeatu",
			unlock: "Desblokeatu",
	...
	i = {
		...
		hint_emptyLibrary:
			"Hautatu oihaleko elementu bat hemen gehitzeko, edo instalatu liburutegi bat beheko biltegi publikotik.",
	...
	o = {
		...
		uploadedSecurly:
			"Kargatzea muturretik muturrerako zifratze bidez ziurtatu da, hau da, Excalidraw zerbitzariak eta hirugarrenek ezin dutela edukia irakurri.",
		loadSceneOverridePrompt:
			"Kanpoko marrazkia kargatzeak lehendik duzun edukia ordezkatuko du. Jarraitu nahi duzu?",
...
(Zure marrazki lokala mantendu nahi baduzu, itxi arakatzailearen fitxa.)`,
		...
		confirmAddLibrary:
			"Honek {{numShapes}} forma gehituko ditu zure liburutegian. Ziur zaude?",
		imageDoesNotContainScene:
			"Irudi honek ez dirudi eszena daturik duenik. Eszena kapsulatzea gaitu al duzu esportazioan?",
		cannotRestoreFromImage:
			"Ezin izan da eszena leheneratu irudi fitxategi honetatik",
		invalidSceneUrl:
			"Ezin izan da eszena inportatu emandako URLtik. Gaizki eratuta dago edo ez du baliozko Excalidraw JSON daturik.",
		...
		invalidEncryptionKey:
			"Enkriptazio-gakoak 22 karaktere izan behar ditu. Zuzeneko lankidetza desgaituta dago.",
...
Zure aldaketak ez dira gordeko!`,
	...
	n = {
		...
		fileTooBig:
			"Fitxategia handiegia da. Onartutako gehienezko tamaina {{maxSize}} da.",
		svgImageInsertError:
			"Ezin izan da SVG irudia txertatu. SVG markak baliogabea dirudi.",
		failedToFetchImage: "Ezin izan da irudia eskuratu.",
		invalidSVGString: "SVG baliogabea.",
		cannotResolveCollabServer:
			"Ezin izan da elkarlaneko zerbitzarira konektatu. Mesedez, berriro kargatu orria eta saiatu berriro.",
		importLibraryError: "Ezin izan da liburutegia kargatu",
		collabSaveFailed:
			"Ezin izan da backend datu-basean gorde. Arazoak jarraitzen badu, zure fitxategia lokalean gorde beharko zenuke zure lana ez duzula galtzen ziurtatzeko.",
		...
		brave_measure_text_error: {
			line1:
				"Brave arakatzailea erabiltzen ari zarela dirudi <bold>Blokeatu hatz-markak erasokorki</bold> ezarpena gaituta.",
			line2:
				"Honek zure marrazkietako <bold>Testu-elementuak</bold> hautsi ditzake.",
			line3:
				"Ezarpen hau desgaitzea gomendatzen dugu. <link>urrats hauek</link> jarrai ditzakezu hori nola egin jakiteko.",
			line4:
				"Ezarpen hau desgaituz gero, testu-elementuen bistaratzea konpontzen ez bada, ireki <issueLink>arazo</issueLink> gure GitHub-en edo idatzi iezaguzu <discordLink>Discord</discordLink> helbidera",
		},
		...
		asyncPasteFailedOnRead:
			"Ezin izan da itsatsi (ezin izan da sistemaren arbeletik irakurri).",
	...
	l = {
		canvasPanning:
			"Oihala mugitzeko, eutsi saguaren gurpila edo zuriune-barra arrastatzean, edo erabili esku tresna",
		linearElement:
			"Egin klik hainbat puntu hasteko, arrastatu lerro bakarrerako",
		...
		linearElementMulti:
			"Egin klik azken puntuan edo sakatu Esc edo Sartu amaitzeko",
...
sakatu ALT erditik tamaina aldatzeko`,
		rotate:
			"Angeluak mantendu ditzakezu SHIFT sakatuta biratzen duzun bitartean",
		lineEditor_info:
			"Eutsi sakatuta Ctrl edo Cmd eta egin klik bikoitza edo sakatu Ctrl edo Cmd + Sartu puntuak editatzeko",
...
edo eduki Alt sakatuta eta egin klik puntu berriak gehitzeko`,
		placeImage:
			"Egin klik irudia kokatzeko, edo egin klik eta arrastatu bere tamaina eskuz ezartzeko",
		publishLibrary: "Argitaratu zure liburutegia",
		bindTextToElement: "Sakatu Sartu testua gehitzeko",
		deepBoxSelect:
			"Eutsi Ctrl edo Cmd sakatuta aukeraketa sakona egiteko eta arrastatzea saihesteko",
		eraserRevert:
			"Eduki Alt sakatuta ezabatzeko markatutako elementuak leheneratzeko",
		firefox_clipboard_write:
			'Ezaugarri hau "dom.events.asyncClipboard.clipboardItem" marka "true" gisa ezarrita gaitu daiteke. Firefox-en arakatzailearen banderak aldatzeko, bisitatu "about:config" orrialdera.',
	...
	d = {
		...
		canvasTooBigTip:
			"Aholkua: saiatu urrunen dauden elementuak pixka bat hurbiltzen.",
	},
	s = {
		headingMain:
			"Errore bat aurkitu da. Saiatu <button>orria birkargatzen.</button>",
		clearCanvasMessage:
			"Birkargatzea ez bada burutzen, saiatu <button>oihala garbitzen.</button>",
		clearCanvasCaveat: " Honen ondorioz lana galduko da ",
		trackedToSentry:
			"Identifikatzailearen errorea {{eventId}} gure sistemak behatu du.",
		openIssueMessage:
			"Oso kontuz ibili gara zure eszenaren informazioa errorean ez sartzeko. Zure eszena pribatua ez bada, kontuan hartu gure <button>erroreen jarraipena egitea.</button> Sartu beheko informazioa kopiatu eta itsatsi bidez GitHub issue-n.",
		sceneContent: "Eszenaren edukia:",
	},
	z = {
		desc_intro:
			"Jendea zure uneko eszenara gonbida dezakezu zurekin elkarlanean aritzeko.",
		desc_privacy:
			"Ez kezkatu, saioak muturretik muturrerako enkriptatzea erabiltzen du, beraz, marrazten duzuna pribatua izango da. Gure zerbitzariak ere ezingo du ikusi zer egiten duzun.",
		button_startSession: "Hasi saioa",
		button_stopSession: "Itxi saioa",
		desc_inProgressIntro: "Zuzeneko lankidetza saioa abian da.",
		desc_shareLink:
			"Partekatu esteka hau elkarlanean aritu nahi duzun edonorekin:",
		desc_exitSession:
			"Saioa ixteak aretotik deskonektatuko zaitu, baina eszenarekin lanean jarraitu ahal izango duzu lokalean. Kontuan izan honek ez diela beste pertsonei eragingo, eta euren bertsioan elkarlanean aritu ahal izango dira.",
	...
	b = {
		...
		excalidrawplus_exportError:
			"Une honetan ezin izan da esportatu Excalidraw+era...",
	},
	m = {
		...
		deepBoxSelect:
			"Hautapen sakona egin laukizuzen bidez, eta saihestu arrastatzea",
	...
	h = {
		...
		placeholder: {
			...
			libraryDesc:
				"Zure liburutegiaren deskripzioa laguntzeko jendeari ulertzen haren erabilpena",
			githubHandle:
				"GitHub heldulekua (aukerakoa), liburutegia editatu ahal izateko berrikustera bidalitakoan",
			twitterHandle:
				"Twitter-eko erabiltzaile-izena (aukerakoa), badakigu nori kreditatu behar dugun Twitter bidez sustatzeko",
			website: "Estekatu zure webgunera edo nahi duzun tokira (aukerakoa)",
		},
		errors: { required: "Beharrezkoa", website: "Sartu baliozko URL bat" },
		noteDescription:
			"Bidali zure liburutegira sartu ahal izateko <link>zure liburutegiko biltegian</link>beste jendeak bere marrazkietan erabili ahal izateko.",
		noteGuidelines:
			"Liburutegia eskuz onartu behar da. Irakurri <link>gidalerroak</link> bidali aurretik. GitHub kontu bat edukitzea komeni da komunikatzeko eta aldaketak egin ahal izateko, baina ez da guztiz beharrezkoa.",
		noteLicense:
			"Bidaltzen baduzu, onartzen duzu liburutegia <link>MIT lizentziarekin argitaratuko dela, </link>zeinak, laburbilduz, esan nahi du edozeinek erabiltzen ahal duela murrizketarik gabe.",
		noteItems:
			"Liburutegiko elementu bakoitzak bere izena eduki behar du iragazi ahal izateko. Liburutegiko hurrengo elementuak barne daude:",
		atleastOneLibItem:
			"Hautatu gutxienez liburutegiko elementu bat gutxienez hasi ahal izateko",
		republishWarning:
			"Oharra: hautatutako elementu batzuk dagoeneko argitaratuta/bidalita bezala markatuta daude. Elementuak berriro bidali behar dituzu lehendik dagoen liburutegi edo bidalketa eguneratzen duzunean.",
	},
	c = {
		title: "Liburutegia bidali da",
		content:
			"Eskerrik asko {{authorName}}. Zure liburutegia bidali da berrikustera. Jarraitu dezakezu haren egoera<link>hemen</link>",
	},
	E = {
		resetLibrary: "Leheneratu liburutegia",
...
Esportatutako fitxategien tamaina handituko da.`,
	...
	S = {
		tooltip:
			"Zure marrazkiak muturretik muturrera enkriptatu dira, beraz Excalidraw-ren zerbitzariek ezingo dituzte ikusi.",
...
edo itsatsi lehendik dagoen testu-editore batean`,
		unableToEmbed:
			"Url hau txertatzea ez da une honetan onartzen. Sortu issue bat GitHub-en Urla zerrenda zurian sartzea eskatzeko",
		unrecognizedLinkFormat:
			"Kapsulatu duzun esteka ez dator bat espero den formatuarekin. Mesedez, saiatu iturburu-guneak emandako 'kapsulatu' katea itsasten",
	},
	T = {
		transparent: "Gardena",
		black: "Beltza",
	...
	w = {
		app: {
			center_heading:
				"Zure datu guztiak lokalean gordetzen dira zure nabigatzailean.",
	...
	f = {
		action: {
			exportToImage: {
				...
				description:
					"Esportatu eszenaren datuak geroago inportatu ahal izango duzun irudi gisa.",
			},
			saveToDisk: {
				title: "Gorde diskoan",
		...
		modal: {
			loadFromFile: {
				...
				description:
					"Fitxategi batetik kargatzeak <bold>lehendik duzun edukia ordezkatuko du</bold>.<br></br>Lehenengo marrazkiaren babeskopia egin dezakezu beheko aukeretako bat erabiliz.",
			},
			shareableLink: {
				title: "Estekatik kargatu",
				button: "Ordeztu nire edukia",
				description:
					"Kanpoko irudi bat kargatzeak <bold>lehendik duzun edukia ordezkatuko du</bold>.<br></br>. Zure marrazkiaren babeskopia egin dezakezu lehenik beheko aukeretako bat erabiliz.",
			},
		},
	},
	A = {
