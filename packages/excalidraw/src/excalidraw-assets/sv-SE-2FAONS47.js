...
var a = {
		...
		lineEditor: { edit: "Redigera linje", exit: "Avsluta linjeredigerare" },
		elementLock: {
			lock: "L\xE5s",
			unlock: "L\xE5s upp",
			lockAll: "L\xE5s alla",
	...
	r = {
		...
		hint_emptyLibrary:
			"V\xE4lj ett objekt p\xE5 canvasen f\xF6r att l\xE4gga till det h\xE4r, eller installera ett bibliotek fr\xE5n det publika arkivet, nedan.",
		hint_emptyPrivateLibrary:
			"V\xE4lj ett objekt p\xE5 canvasen f\xF6r att l\xE4gga till det h\xE4r.",
	},
	i = {
	...
	n = {
		...
		couldNotCreateShareableLinkTooBig:
			"Kunde inte skapa delbar l\xE4nk: skissen \xE4r f\xF6r stor",
		...
		uploadedSecurly:
			"Uppladdning har s\xE4krats med kryptering fr\xE5n \xE4nde till \xE4nde. vilket inneb\xE4r att Excalidraw server och tredje part inte kan l\xE4sa inneh\xE5llet.",
		loadSceneOverridePrompt:
			"Laddning av extern skiss kommer att ers\xE4tta ditt befintliga inneh\xE5ll. Vill du forts\xE4tta?",
...
(Om du vill beh\xE5lla din lokala skiss, st\xE4ng bara webbl\xE4sarfliken ist\xE4llet.)`,
		...
		confirmAddLibrary:
			"Detta kommer att l\xE4gga till {{numShapes}} form(er) till ditt bibliotek. \xC4r du s\xE4ker?",
		imageDoesNotContainScene:
			"Den h\xE4r bilden verkar inte inneh\xE5lla n\xE5gon skissdata. Har du aktiverat inb\xE4ddning av skiss under export?",
		cannotRestoreFromImage:
			"Skiss kunde inte \xE5terst\xE4llas fr\xE5n denna bildfil",
		invalidSceneUrl:
			"Det gick inte att importera skiss fr\xE5n den angivna webbadressen. Antingen har den fel format, eller s\xE5 inneh\xE5ller den ingen giltig Excalidraw JSON data.",
		...
		invalidEncryptionKey:
			"Krypteringsnyckeln m\xE5ste vara 22 tecken. Livesamarbetet \xE4r inaktiverat.",
...
Dina \xE4ndringar kommer inte att sparas!`,
	...
	l = {
		...
		fileTooBig:
			"Filen \xE4r f\xF6r stor. Maximal till\xE5ten storlek \xE4r {{maxSize}}.",
		svgImageInsertError:
			"Kunde inte infoga SVG-bild. SVG-koden ser ogiltig ut.",
		failedToFetchImage: "Kunde inte h\xE4mta bilden.",
		invalidSVGString: "Ogiltig SVG.",
		cannotResolveCollabServer:
			"Det gick inte att ansluta till samarbets-servern. Ladda om sidan och f\xF6rs\xF6k igen.",
		importLibraryError: "Kunde inte ladda bibliotek",
		collabSaveFailed:
			"Det gick inte att spara i backend-databasen. Om problemen kvarst\xE5r b\xF6r du spara filen lokalt f\xF6r att se till att du inte f\xF6rlorar ditt arbete.",
		collabSaveFailed_sizeExceeded:
			"Det gick inte att spara till backend-databasen, whiteboarden verkar vara f\xF6r stor. Du b\xF6r spara filen lokalt f\xF6r att du inte ska f\xF6rlora ditt arbete.",
		imageToolNotSupported: "Bilder \xE4r inaktiverade.",
		brave_measure_text_error: {
			line1:
				"Det ser ut som om du anv\xE4nder Brave-webbl\xE4saren med <bold>Aggressivt Blockera fingeravtryck</bold> inst\xE4llningen aktiverad.",
			line2:
				"Detta kan resultera i trasiga <bold>Textelement</bold> i dina ritningar.",
			line3:
				"Vi rekommenderar starkt att du inaktiverar den h\xE4r inst\xE4llningen. Du kan f\xF6lja <link>dessa steg</link> f\xF6r att inaktivera den.",
			line4:
				"Om inaktivering av denna inst\xE4llning inte \xE5tg\xE4rdar visningen av textelement, \xF6ppna ett <issueLink>\xE4rende</issueLink> p\xE5 v\xE5r GitHub, eller skriv till oss p\xE5 <discordLink>Discord</discordLink>",
		},
		libraryElementTypeError: {
			embeddable:
				"Inb\xE4ddbara element kan inte l\xE4ggas till i biblioteket.",
			iframe: "IFrame-element kan inte l\xE4ggas till i biblioteket.",
			image:
				"St\xF6d f\xF6r att l\xE4gga till bilder till biblioteket kommer snart!",
		},
		asyncPasteFailedOnRead:
			"Kunde inte klistra in (kunde inte l\xE4sa fr\xE5n urklipp).",
	...
	d = {
		canvasPanning:
			"F\xF6r att flytta whiteboarden, h\xE5ll mushjulet eller mellanslagstangenten medan du drar eller anv\xE4nd handverktyget",
		linearElement:
			"Klicka f\xF6r att starta flera punkter, dra f\xF6r en linje",
		...
		text_editing:
			"Tryck Escape eller CtrlOrCmd + ENTER f\xF6r att slutf\xF6ra redigeringen",
		linearElementMulti:
			"Klicka p\xE5 sista punkten eller tryck Escape eller Enter f\xF6r att avsluta",
...
h\xE5ll ALT f\xF6r att \xE4ndra storlek fr\xE5n mitten`,
		rotate:
			"Du kan begr\xE4nsa vinklar genom att h\xE5lla SHIFT medan du roterar",
		lineEditor_info:
			"H\xE5ll Ctrl/Cmd och dubbelklicka eller tryck p\xE5 Ctrl/Cmd + Enter f\xF6r att redigera punkter",
		lineEditor_pointSelected:
			"Tryck p\xE5 Ta bort f\xF6r att ta bort punkt(er), Ctrl + D eller Cmd + D f\xF6r att duplicera, eller dra f\xF6r att flytta",
...
eller h\xE5ll ned Alt och klicka f\xF6r att l\xE4gga till nya punkter`,
		placeImage:
			"Klicka f\xF6r att placera bilden, eller klicka och dra f\xF6r att st\xE4lla in dess storlek manuellt",
		publishLibrary: "Publicera ditt eget bibliotek",
		bindTextToElement: "Tryck p\xE5 Enter f\xF6r att l\xE4gga till text",
		deepBoxSelect:
			"H\xE5ll Ctrl eller Cmd f\xF6r att djupv\xE4lja, och f\xF6r att f\xF6rhindra att dra",
		eraserRevert:
			"H\xE5ll Alt f\xF6r att \xE5terst\xE4lla de element som \xE4r markerade f\xF6r borttagning",
		firefox_clipboard_write:
			'Denna funktion kan sannolikt aktiveras genom att st\xE4lla in "dom.events.asyncClipboard.clipboardItem" flaggan till "true". F\xF6r att \xE4ndra webbl\xE4sarens flaggor i Firefox, bes\xF6k "about:config" sidan.',
	...
	k = {
		...
		canvasTooBigTip:
			"Tips: prova att flytta de mest avl\xE4gsna elementen lite n\xE4rmare varandra.",
	},
	g = {
		headingMain:
			"Ett fel uppstod. F\xF6rs\xF6k <button>med att l\xE4sa in sidan p\xE5 nytt.</button>",
		clearCanvasMessage:
			"Om omladdning inte fungerar, f\xF6rs\xF6k <button>rensa canvasen.</button>",
		clearCanvasCaveat: " Detta kommer att leda till f\xF6rlust av arbete ",
		trackedToSentry:
			"Felet med identifieraren {{eventId}} sp\xE5rades p\xE5 v\xE5rt system.",
		openIssueMessage:
			"Vi var mycket f\xF6rsiktiga med att inte inkludera din skissinformation om felet. Om din skiss inte \xE4r privat, v\xE4nligen \xF6verv\xE4ga att f\xF6lja upp p\xE5 v\xE5r <button>buggsp\xE5rare.</button> V\xE4nligen inkludera information nedan genom att kopiera och klistra in i GitHub-problemet.",
		sceneContent: "Skissinneh\xE5ll:",
	},
	m = {
		desc_intro:
			"Du kan bjuda in personer till din nuvarande skiss f\xF6r att samarbeta med dig.",
		desc_privacy:
			"Oroa dig inte, sessionen anv\xE4nder kryptering fr\xE5n \xE4nde till \xE4nde, s\xE5 vad du \xE4n ritar kommer att f\xF6rbli privat. Inte ens v\xE5r server kommer att kunna se vad du skissar.",
		...
		desc_exitSession:
			"Att avbryta sessionen kommer att koppla bort dig fr\xE5n rummet, men du kommer att kunna forts\xE4tta arbeta med skissen, lokalt. Observera att detta inte p\xE5verkar andra m\xE4nniskor, och de kommer fortfarande att kunna samarbeta p\xE5 deras version.",
	...
	p = {
		...
		disk_details:
			"Exportera skissdata till en fil som du kan importera fr\xE5n senare.",
		...
		excalidrawplus_exportError:
			"Det gick inte att exportera till Excalidraw+ just nu...",
	},
	c = {
	...
	v = {
		...
		placeholder: {
			...
			libraryDesc:
				"Beskrivning av ditt bibliotek f\xF6r att hj\xE4lpa m\xE4nniskor att f\xF6rst\xE5 dess anv\xE4ndning",
			githubHandle:
				"Github-anv\xE4ndarnamn (valfritt), s\xE5 att du kan redigera biblioteket n\xE4r du har skickat in det f\xF6r granskning",
			twitterHandle:
				"Twitter-anv\xE4ndarnamn (valfritt), s\xE5 vi vet vem att kreditera n\xE4r du marknadsf\xF6r p\xE5 Twitter",
			website:
				"L\xE4nk till din personliga webbplats eller n\xE5gon annan (valfritt)",
		},
		errors: { required: "Obligatoriskt", website: "Ange en giltig URL" },
		noteDescription:
			"Skicka ditt bibliotek f\xF6r att inkluderas i <link>det offentliga bibliotekets arkiv</link>f\xF6r andra m\xE4nniskor att anv\xE4nda i sina skisser.",
		noteGuidelines:
			"Biblioteket m\xE5ste godk\xE4nnas manuellt f\xF6rst. V\xE4nligen l\xE4s <link>riktlinjerna</link> innan du skickar in. Du beh\xF6ver ett GitHub-konto f\xF6r att kommunicera och g\xF6ra \xE4ndringar om s\xE5 \xF6nskas, men det kr\xE4vs inte.",
		noteLicense:
			"Genom att skicka in godk\xE4nner du att biblioteket kommer att publiceras under <link>MIT-licens, </link>vilket kort sagt betyder att vem som helst kan anv\xE4nda det utan restriktioner.",
		noteItems:
			"Varje objekt m\xE5ste ha sitt eget namn s\xE5 att det \xE4r filtrerbart. F\xF6ljande objekt kommer att inkluderas:",
		atleastOneLibItem:
			"V\xE4lj minst ett biblioteksobjekt f\xF6r att komma ig\xE5ng",
		republishWarning:
			"Obs: n\xE5gra av de markerade objekten \xE4r redan markerade som publicerade/skickade. Du b\xF6r endast skicka objekt igen n\xE4r du uppdaterar ett befintligt bibliotek eller inl\xE4mning.",
	},
	f = {
		title: "Bibliotek inskickat",
		content:
			"Tack {{authorName}}. Ditt bibliotek har skickats f\xF6r granskning. Du kan f\xF6lja status<link>h\xE4r</link>",
	},
	h = {
		resetLibrary: "\xC5terst\xE4ll bibliotek",
...
Kommer att \xF6ka exporterad filstorlek.`,
	...
	S = {
		tooltip:
			"Dina skisser \xE4r krypterade fr\xE5n \xE4nde till \xE4nde s\xE5 Excalidraws servrar kommer aldrig att se dem.",
...
eller klistra in i en befintlig textredigerare`,
		unableToEmbed:
			"Att b\xE4dda in denna webbadress \xE4r f\xF6r n\xE4rvarande inte till\xE5tet. Skapa en problemrapport p\xE5 GitHub f\xF6r att beg\xE4ra att webbadressen vitlistas.",
		unrecognizedLinkFormat:
			"L\xE4nken du b\xE4ddade in matchar inte det f\xF6rv\xE4ntade formatet. F\xF6rs\xF6k klistra in 'embed'-str\xE4ngen som tillhandah\xE5lls av k\xE4llwebbplatsen",
	},
	w = {
	...
	F = {
		action: {
			exportToImage: {
				...
				description:
					"Exportera scendata som en bild fr\xE5n vilken du kan importera senare.",
			},
			saveToDisk: {
				title: "Spara till disk",
				button: "Spara till disk",
				description:
					"Exportera scendata till en fil fr\xE5n vilken du kan importera senare.",
			},
			excalidrawPlus: {
				title: "Excalidraw+",
		...
		modal: {
			loadFromFile: {
				...
				description:
					"Laddar fr\xE5n en fil kommer <bold>ers\xE4tta ditt befintliga inneh\xE5ll</bold>.<br></br>Du kan s\xE4kerhetskopiera din ritning f\xF6rst med hj\xE4lp av ett av alternativen nedan.",
			},
			shareableLink: {
				title: "L\xE4s in fr\xE5n l\xE4nk",
				button: "Ers\xE4tt mitt inneh\xE5ll",
				description:
					"Inl\xE4sning av en extern ritning kommer <bold>ers\xE4tta ditt befintliga inneh\xE5ll</bold>.<br></br>Du kan s\xE4kerhetskopiera din ritning f\xF6rst genom att anv\xE4nda ett av alternativen nedan.",
			},
		},
	},
	D = {
		...
		button: "Infoga",
		description:
			"F\xF6r n\xE4rvarande st\xF6ds endast <flowchartLink>Fl\xF6desdiagram</flowchartLink>,<sequenceLink> Sekvensdiagram </sequenceLink> och <classLink>Klassdiagram</classLink>. De andra typerna kommer att \xE5terges som bild i Excalidraw.",
