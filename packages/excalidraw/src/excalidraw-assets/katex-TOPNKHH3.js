...
var he = class {
		constructor(e) {
			...
			for (var t in qe)
				if (qe.hasOwnProperty(t)) {
					var a = qe[t];
					this[t] =
						e[t] !== void 0 ? (a.processor ? a.processor(e[t]) : e[t]) : Ba(a);
				}
		}
		reportNonstrict(e, t, a) {
			var n = this.strict;
			if (
				(typeof n == "function" && (n = n(e, t, a)), !(!n || n === "ignore"))
			) {
				if (n === !0 || n === "error")
					throw new M(
	...
	x0 = class {
		...
		sup() {
			return w0[Da[this.id]];
		}
		sub() {
			return w0[Ca[this.id]];
		}
		fracNum() {
			return w0[qa[this.id]];
		}
		fracDen() {
	...
	Da = [me, f0, me, f0, re, n0, re, n0],
	Ca = [f0, f0, f0, f0, n0, n0, n0, n0],
	qa = [te, C0, me, f0, re, n0, re, n0],
	Na = [C0, C0, f0, f0, n0, n0, n0, n0],
	Ra = [Re, Re, C0, C0, f0, f0, n0, n0],
	Ea = [wt, Re, te, C0, te, C0, te, C0],
	E = { DISPLAY: w0[wt], TEXT: w0[te], SCRIPT: w0[me], SCRIPTSCRIPT: w0[re] },
	ut = [
		{
			name: "latin",
			blocks: [
...
function Ia(r) {
	for (var e = 0; e < ut.length; e++)
		for (var t = ut[e], a = 0; a < t.blocks.length; a++) {
			var n = t.blocks[a];
...
var Ne = [];
ut.forEach((r) => r.blocks.forEach((e) => Ne.push(...e)));
function wr(r) {
	for (var e = 0; e < Ne.length; e += 2)
		if (r >= Ne[e] && r <= Ne[e + 1]) return !0;
	return !1;
}
var ee = 80,
	Oa = function (e, t) {
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`
	...
	$0 = class {
		...
		hasClass(e) {
			return N.contains(this.classes, e);
		}
		toNode() {
			for (
...
function kt(r, e, t) {
	...
	var a = r.charCodeAt(0),
		n = k0[e][a];
	if (
		(!n && r[0] in Yt && ((a = Yt[r[0]].charCodeAt(0)), (n = k0[e][a])),
		!n && t === "text" && wr(a) && (n = k0[e][77]),
		n)
	)
...
var ja = [
	...
	Ee = class r {
		...
		havingStyle(e) {
			return this.style === e
				? this
				: this.extend({ style: e, size: $t(this.textSize, e) });
		}
		havingCrampedStyle() {
		...
		havingBaseStyle(e) {
			...
			return this.size === t && this.textSize === r.BASESIZE && this.style === e
				? this
		...
		baseSizingClasses() {
			return this.size !== r.BASESIZE
				? ["sizing", "reset-size" + this.size, "size" + r.BASESIZE]
				: [];
		}
		fontMetrics() {
			return (
				this._fontMetrics || (this._fontMetrics = Wa(this.size)),
				this._fontMetrics
			);
		}
		getColor() {
...
var ht = {
	...
	kr = function (e) {
		return (
			typeof e != "string" && (e = e.unit), e in ht || e in Za || e === "ex"
		);
	},
	J = function (e, t) {
		var a;
	...
	zr = function (e) {
		var t = "<" + e;
		this.classes.length && (t += ' class="' + N.escape(P0(this.classes)) + '"');
		var a = "";
		for (var n in this.style)
			this.style.hasOwnProperty(n) &&
				(a += N.hyphenate(n) + ":" + this.style[n] + ";");
		a && (t += ' style="' + N.escape(a) + '"');
		for (var s in this.attributes)
			this.attributes.hasOwnProperty(s) &&
				(t += " " + s + '="' + N.escape(this.attributes[s]) + '"');
		t += ">";
	...
	mt = class {
		...
		toMarkup() {
			var e =
					...
					N.escape(this.src) +
					'"' +
					(' alt="' + N.escape(this.alt) + '"'),
				t = "";
			for (var a in this.style)
				this.style.hasOwnProperty(a) &&
					(t += N.hyphenate(a) + ":" + this.style[a] + ";");
			return t && (e += ' style="' + N.escape(t) + '"'), (e += "'/>"), e;
		}
	},
	Ka = {
		\u00EE: "\u0131\u0302",
	...
	u0 = class {
		constructor(e, t, a, n, s, o, h, c) {
			(this.text = void 0),
				...
				(this.style = c || {}),
				(this.maxFontSize = 0);
			var p = Ia(this.text.charCodeAt(0));
			p && this.classes.push(p + "_fallback"),
				/[îïíì]/.test(this.text) && (this.text = Ka[this.text]);
		}
		hasClass(e) {
			return N.contains(this.classes, e);
		}
		...
		toMarkup() {
			...
			for (var n in this.style)
				this.style.hasOwnProperty(n) &&
					(a += N.hyphenate(n) + ":" + this.style[n] + ";");
			a && ((e = !0), (t += ' style="' + N.escape(a) + '"'));
			var s = N.escape(this.text);
		...
		toMarkup() {
			...
			for (var t in this.attributes)
				Object.prototype.hasOwnProperty.call(this.attributes, t) &&
					(e += " " + t + '="' + N.escape(this.attributes[t]) + '"');
			e += ">";
		...
		toNode() {
			...
			return (
				this.alternate
					...
					: t.setAttribute("d", Ut[this.pathName]),
				t
			);
		}
		toMarkup() {
			return this.alternate
				? '<path d="' + N.escape(this.alternate) + '"/>'
				: '<path d="' + N.escape(Ut[this.pathName]) + '"/>';
		}
	},
	de = class {
		constructor(e) {
...
function Ja(r) {
	if (r instanceof W0) return r;
	throw new Error("Expected span<HtmlDomNode> but got " + String(r) + ".");
}
var Qa = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
	_a = { "accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1 },
	$ = { math: {}, text: {} };
...
i(l, u, R, "\u03C8", "\\psi", !0);
i(l, u, R, "\u03C9", "\\omega", !0);
i(l, u, R, "\u03B5", "\\varepsilon", !0);
i(l, u, R, "\u03D1", "\\vartheta", !0);
i(l, u, R, "\u03D6", "\\varpi", !0);
i(l, u, R, "\u03F1", "\\varrho", !0);
i(l, u, R, "\u03C2", "\\varsigma", !0);
i(l, u, R, "\u03C6", "\\varphi", !0);
i(l, u, D, "\u2217", "*", !0);
i(l, u, D, "+", "+");
i(l, u, D, "\u2212", "-", !0);
...
i(k, d, v, "\u2720", "\\maltese");
var jt = '0123456789/@."';
for (we = 0; we < jt.length; we++) (Qe = jt.charAt(we)), i(l, u, v, Qe, Qe);
var Qe,
	we,
	Zt = '0123456789!@*()-=+";:?/.,';
for (ke = 0; ke < Zt.length; ke++) (_e = Zt.charAt(ke)), i(k, u, v, _e, _e);
var _e,
	ke,
	Ie = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
for (Se = 0; Se < Ie.length; Se++)
	(se = Ie.charAt(Se)), i(l, u, R, se, se), i(k, u, v, se, se);
var se, Se;
i(l, d, v, "C", "\u2102");
i(k, d, v, "C", "\u2102");
i(l, d, v, "H", "\u210D");
...
i(k, u, R, "h", "\u210E");
var I = "";
for (r0 = 0; r0 < Ie.length; r0++)
	(Z = Ie.charAt(r0)),
		(I = String.fromCharCode(55349, 56320 + r0)),
		i(l, u, R, Z, I),
		i(k, u, v, Z, I),
		(I = String.fromCharCode(55349, 56372 + r0)),
		i(l, u, R, Z, I),
		i(k, u, v, Z, I),
		(I = String.fromCharCode(55349, 56424 + r0)),
		i(l, u, R, Z, I),
		i(k, u, v, Z, I),
		(I = String.fromCharCode(55349, 56580 + r0)),
		i(l, u, R, Z, I),
		i(k, u, v, Z, I),
		(I = String.fromCharCode(55349, 56684 + r0)),
		i(l, u, R, Z, I),
		i(k, u, v, Z, I),
		(I = String.fromCharCode(55349, 56736 + r0)),
		i(l, u, R, Z, I),
		i(k, u, v, Z, I),
		(I = String.fromCharCode(55349, 56788 + r0)),
		i(l, u, R, Z, I),
		i(k, u, v, Z, I),
		(I = String.fromCharCode(55349, 56840 + r0)),
		i(l, u, R, Z, I),
		i(k, u, v, Z, I),
		(I = String.fromCharCode(55349, 56944 + r0)),
		i(l, u, R, Z, I),
		i(k, u, v, Z, I),
		r0 < 26 &&
			((I = String.fromCharCode(55349, 56632 + r0)),
			i(l, u, R, Z, I),
			i(k, u, v, Z, I),
			(I = String.fromCharCode(55349, 56476 + r0)),
			i(l, u, R, Z, I),
			i(k, u, v, Z, I));
var Z, r0;
I = "\u{1D55C}";
...
for (F0 = 0; F0 < 10; F0++)
	(B0 = F0.toString()),
		(I = String.fromCharCode(55349, 57294 + F0)),
		i(l, u, R, B0, I),
		i(k, u, v, B0, I),
		(I = String.fromCharCode(55349, 57314 + F0)),
		i(l, u, R, B0, I),
		i(k, u, v, B0, I),
		(I = String.fromCharCode(55349, 57324 + F0)),
		i(l, u, R, B0, I),
		i(k, u, v, B0, I),
		(I = String.fromCharCode(55349, 57334 + F0)),
		i(l, u, R, B0, I),
		i(k, u, v, B0, I);
var B0,
	F0,
	ct = "\xD0\xDE\xFE";
for (Me = 0; Me < ct.length; Me++)
	(le = ct.charAt(Me)), i(l, u, R, le, le), i(k, u, v, le, le);
var le,
	Me,
	ze = [
	...
	e1 = function (e, t) {
		...
		if (119808 <= s && s < 120484) {
			...
			return [ze[h][2], ze[h][o]];
		} else if (120782 <= s && s <= 120831) {
			var c = Math.floor((s - 120782) / 10);
			return [Kt[c][2], Kt[c][o]];
		} else {
			if (s === 120485 || s === 120486) return [ze[0][2], ze[0][o]];
	...
	Ve = function (e, t, a) {
		return (
			$[a][e] && $[a][e].replace && (e = $[a][e].replace),
			{ value: e, metrics: kt(e, t, a) }
		);
	},
	b0 = function (e, t, a, n, s) {
		...
		if (h) {
			...
			(a === "text" || (n && n.font === "mathit")) && (p = 0),
				(c = new u0(e, h.height, h.depth, p, h.skew, h.width, s));
		} else
			typeof console < "u" &&
				console.warn(
	...
	t1 = function (e, t, a, n) {
		return (
			n === void 0 && (n = []),
			a.font === "boldsymbol" && Ve(e, "Main-Bold", t).metrics
	...
	r1 = function (e, t, a, n, s) {
		return s !== "textord" && Ve(e, "Math-BoldItalic", t).metrics
	...
	a1 = function (e, t, a) {
		...
		if (c) {
			...
			if (c === "boldsymbol") {
				...
				h
					? ((y = Dr[c].fontName), (w = [c]))
					: ((y = Ae(c, t.fontWeight, t.fontShape)),
						(w = [c, t.fontWeight, t.fontShape]));
			if (Ve(s, y, n).metrics) return b0(s, y, n, t, o.concat(w));
		...
		if (a === "textord") {
			...
			if (C === "ams") {
				...
				return b0(s, q, n, t, o.concat("amsrm", t.fontWeight, t.fontShape));
			} else if (C === "main" || !C) {
				var O = Ae("textrm", t.fontWeight, t.fontShape);
				return b0(s, O, n, t, o.concat(t.fontWeight, t.fontShape));
			} else {
				var H = Ae(C, t.fontWeight, t.fontShape);
	...
	l0 = function (e, t, a, n) {
		var s = new W0(e, t, a, n);
		return St(s), s;
	},
	Tr = (r, e, t, a) => new W0(r, e, t, a),
	s1 = function (e, t, a) {
		var n = l0([e], [], t);
		return (
			(n.height = Math.max(
	...
	o1 = function (e, t) {
		return e instanceof $0 ? l0([], [e], t) : e;
	},
	u1 = function (e) {
	...
	h1 = function (e, t) {
		for (
			var { children: a, depth: n } = u1(e), s = 0, o = 0;
			o < a.length;
			o++
		) {
			var h = a[o];
...
var Fe = function (e) {
	...
	N0 = b.makeSpan,
	p1 = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
	v1 = ["rightmost", "mrel", "mclose", "mpunct"],
	g1 = {
		display: E.DISPLAY,
		text: E.TEXT,
		script: E.SCRIPT,
	...
	t0 = function (e, t, a, n) {
		...
		if (e.length === 1) {
			...
			g.type === "sizing"
				...
				: g.type === "styling" && (p = t.havingStyle(g1[g.style]));
		}
		...
		return (
			Jt(
				...
				(z, T) => {
					var C = T.classes[0],
						q = z.classes[0];
					C === "mbin" && N.contains(v1, q)
						? (T.classes[0] = "mord")
						: q === "mbin" && N.contains(p1, C) && (z.classes[0] = "mord");
				},
				{ node: y },
				w,
				x,
			...
			Jt(
				...
				(z, T) => {
					var C = dt(T),
						q = dt(z),
						O = C && q ? (z.hasClass("mtight") ? f1[C][q] : d1[C][q]) : null;
	...
	Jt = function r(e, t, a, n, s) {
		...
		for (var o = 0; o < e.length; o++) {
			...
			p
				? (a.node = h)
				: s && h.hasClass("newline") && (a.node = N0(["leftmost"])),
				(a.insertAfter = ((y) => (w) => {
					e.splice(y + 1, 0, w), o++;
				})(o));
		}
	...
	Nr = function (e) {
		return e instanceof $0 ||
			e instanceof ce ||
			(e instanceof W0 && e.hasClass("enclosing"))
			? e
			: null;
	},
	y1 = function r(e, t) {
...
function ft(r, e) {
	...
	for (var s = [], o = [], h = 0; h < a.length; h++)
		if (
			...
			a[h].hasClass("mbin") ||
				a[h].hasClass("mrel") ||
				a[h].hasClass("allowbreak"))
		) {
			for (
				var c = !1;
				h < a.length - 1 &&
				a[h + 1].hasClass("mspace") &&
				!a[h + 1].hasClass("newline");
			)
				h++, o.push(a[h]), a[h].hasClass("nobreak") && (c = !0);
			c || (s.push(Te(o, e)), (o = []));
		} else
			a[h].hasClass("newline") &&
				(o.pop(), o.length > 0 && (s.push(Te(o, e)), (o = [])), s.push(a[h]));
	o.length > 0 && s.push(Te(o, e));
	var p;
	t
		? ((p = Te(t0(t, e, !0))), (p.classes = ["tag"]), s.push(p))
		: n && s.push(n);
...
var o0 = class {
		...
		toMarkup() {
			...
			for (var t in this.attributes)
				Object.prototype.hasOwnProperty.call(this.attributes, t) &&
					((e += " " + t + '="'),
					(e += N.escape(this.attributes[t])),
					(e += '"'));
			this.classes.length > 0 &&
				(e += ' class ="' + N.escape(P0(this.classes)) + '"'),
				(e += ">");
			for (var a = 0; a < this.children.length; a++)
				e += this.children[a].toMarkup();
	...
	S = { MathNode: o0, TextNode: X0, SpaceNode: pt, newDocumentFragment: Rr },
	v0 = function (e, t, a) {
		return (
			$[t][e] &&
				$[t][e].replace &&
	...
	zt = function (e, t) {
		...
		var s = e.text;
		if (N.contains(["\\imath", "\\jmath"], s)) return null;
		$[n][s] && $[n][s].replace && (s = $[n][s].replace);
		var o = b.fontMap[a].fontName;
		return kt(s, o, n) ? b.fontMap[a].variant : null;
	},
	h0 = function (e, t, a) {
		if (e.length === 1) {
			var n = X(e[0], t);
		...
		for (var s = [], o, h = 0; h < e.length; h++) {
			var c = X(e[h], t);
			if (c instanceof o0 && o instanceof o0) {
				if (
					c.type === "mtext" &&
					o.type === "mtext" &&
					...
					if (
						...
						y instanceof X0 &&
							y.text.length > 0 &&
							((y.text = y.text.slice(0, 1) + "\u0338" + y.text.slice(1)),
							s.pop());
					}
				}
			}
...
function Qt(r, e, t, a, n) {
	...
	s.length === 1 &&
	s[0] instanceof o0 &&
	N.contains(["mrow", "mtable"], s[0].type)
		? (o = s[0])
...
var Er = function (e) {
	...
	x1 = function (e, t, a) {
		...
		if (a.output === "html") {
			...
			var h = Qt(e, t, n, a.displayMode, !1),
				c = ft(e, n);
	...
	A1 = function (e, t) {
		function a() {
			var h = 4e5,
				c = e.label.slice(1);
			if (N.contains(["widehat", "widecheck", "widetilde", "utilde"], c)) {
				var p = e,
					g = z1(p.base),
					y,
					w,
				...
				for (var a0 = 0; a0 < G; a0++) {
					var e0 = new S0(H[a0]),
						...
						s0 = b.makeSvgSpan([j[a0]], [U0], t);
					if (G === 1) return { span: s0, minWidth: V, height: U };
					(s0.style.height = A(U)), q.push(s0);
				}
				return { span: b.makeSpan(["stretchy"], q, t), minWidth: V, height: U };
			}
		}
	...
	T1 = function (e, t, a, n, s) {
		...
		if (/fbox|color|angl/.test(t)) {
			...
			var g = new y0(p, { width: "100%", height: A(h) });
			o = b.makeSvgSpan([], [g], s);
		}
		return (o.height = h), (o.style.height = A(h)), o;
	},
	R0 = { encloseSpan: T1, mathMLnode: S1, svgSpan: A1 };
function F(r, e) {
	if (!r || r.type !== e)
		throw new Error(
...
var Tt = (r, e) => {
		...
		var s = P(t, e.havingCrampedStyle()),
			o = a.isShifty && N.isCharacterBox(t),
			h = 0;
		if (o) {
			var c = N.getBaseElem(t),
		...
		var q = b.makeSpan(["mord", "accent"], [w], e);
		return n
			? ((n.children[0] = q),
				(n.height = Math.max(q.height, n.height)),
				(n.classes[0] = "mord"),
				n)
			: q;
	},
	Or = (r, e) => {
		var t = r.isStretchy
				? R0.mathMLnode(r.label)
				: new S.MathNode("mo", [v0(r.label, r.mode)]),
	...
	return (
		r.mclass === "minner"
			...
			: r.mclass === "mord"
				...
				: (r.isCharacterBox
						? ((t = a[0]), (t.type = "mo"))
						: (t = new S.MathNode("mo", a)),
					r.mclass === "mbin"
						? ((t.attributes.lspace = "0.22em"),
							(t.attributes.rspace = "0.22em"))
						: r.mclass === "mpunct"
							? ((t.attributes.lspace = "0em"),
								(t.attributes.rspace = "0.17em"))
...
B({
	...
	handler(r, e) {
		...
		return {
			...
			mclass: "m" + a.slice(5),
			body: Q(n),
			isCharacterBox: N.isCharacterBox(n),
		};
	},
	htmlBuilder: Hr,
	mathmlBuilder: Fr,
...
B({
	...
	handler(r, e) {
		...
		return {
			...
			mclass: Ye(e[0]),
			body: Q(e[1]),
			isCharacterBox: N.isCharacterBox(e[1]),
		};
	},
});
B({
...
B({
	...
	handler(r, e) {
		var { parser: t } = r;
		return { type: "pmb", mode: t.mode, mclass: Ye(e[0]), body: Q(e[0]) };
	},
	htmlBuilder(r, e) {
		var t = t0(r.body, e, !0),
...
var C1 = {
	...
	_t = () => ({ type: "styling", body: [], mode: "math", style: "display" }),
	er = (r) => r.type === "textord" && r.text === "@",
	q1 = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function N1(r, e, t) {
	var a = C1[r];
	switch (a) {
		case "\\\\cdrightarrow":
...
function R1(r) {
	...
	for (var a = [], n = [a], s = 0; s < e.length; s++) {
		for (var o = e[s], h = _t(), c = 0; c < o.length; c++)
			if (!er(o[c])) h.body.push(o[c]);
			else {
				a.push(h), (c += 1);
				var p = At(o[c]).text,
					g = new Array(2);
	...
	htmlBuilder(r, e) {
		...
		return (
			r.newLine &&
				...
				r.size && (t.style.marginTop = A(J(r.size, e)))),
			t
		);
	},
	mathmlBuilder(r, e) {
		...
		return (
			r.newLine &&
				...
				r.size && t.setAttribute("height", A(J(r.size, e)))),
			t
		);
	},
});
...
B({
	...
	handler(r) {
		...
		if (vt[a.text])
			return (
				(t === "\\global" || t === "\\\\globallong") && (a.text = vt[a.text]),
...
B({
	...
	handler(r) {
		...
		return (
			...
			e.gullet.macros.set(
				n,
				{ tokens: c, numArgs: s, delimiters: h },
				t === vt[t],
			),
...
B({
	...
	handler(r) {
		var { parser: e, funcName: t } = r,
			a = Gr(e.gullet.popToken());
		e.gullet.consumeSpaces();
		var n = E1(e);
		return (
			Vr(e, a, n, t === "\\\\globallet"), { type: "internal", mode: e.mode }
		);
	},
});
B({
...
var oe = function (e, t, a) {
	...
	Bt = function (e, t, a, n) {
		...
		return (
			(o.height *= h), (o.depth *= h), (o.maxFontSize = s.sizeMultiplier), o
		);
	},
	Ur = function (e, t, a) {
	...
	Yr = function (e, t, a, n, s, o) {
		var h = O1(e, t, s, n),
			c = Bt(b.makeSpan(["delimsizing", "size" + t], [h], n), E.TEXT, n, o);
		return a && Ur(c, n, E.TEXT), c;
	},
	et = function (e, t, a) {
		var n;
	...
	tt = function (e, t, a) {
		var n = k0["Size4-Regular"][e.charCodeAt(0)]
			...
			s = new S0("inner", Ya(e, Math.round(1e3 * t))),
			o = new y0([s], {
				width: A(n),
				height: A(t),
				style: "width:" + A(n),
	...
	Xr = function (e, t, a, n, s, o) {
		...
		var G = T + H + V,
			j = Math.max(0, Math.ceil((t - G) / (L * q))),
			Y = G + j * L * q,
			T0 = n.fontMetrics().axisHeight;
		a && (T0 *= n.sizeMultiplier);
		var a0 = Y / 2 - T0,
			e0 = [];
		if (y.length > 0) {
			var U0 = Y - T - H,
				s0 = Math.round(Y * 1e3),
				g0 = Xa(y, Math.round(U0 * 1e3)),
				I0 = new S0(y, g0),
				Z0 = (w / 1e3).toFixed(3) + "em",
				K0 = (s0 / 1e3).toFixed(3) + "em",
				We = new y0([I0], {
					width: Z0,
					height: K0,
					viewBox: "0 0 " + w + " " + s0,
				}),
				O0 = b.makeSvgSpan([], [We], n);
			(O0.height = s0 / 1e3),
				(O0.style.width = Z0),
				(O0.style.height = K0),
				e0.push({ type: "elem", elem: O0 });
		} else {
			if ((e0.push(et(g, x, s)), e0.push(De), c === null)) {
				var H0 = Y - T - H + 2 * gt;
				e0.push(tt(p, H0, n));
			} else {
				var d0 = (Y - T - H - V) / 2 + 2 * gt;
				e0.push(tt(p, d0, n)),
					e0.push(De),
					e0.push(et(c, x, s)),
					e0.push(De),
			...
			e0.push(De), e0.push(et(h, x, s));
		}
		var ie = n.havingBaseStyle(E.TEXT),
			je = b.makeVList(
				{ positionType: "bottom", positionData: a0, children: e0 },
				ie,
			);
		return Bt(b.makeSpan(["delimsizing", "mult"], [je], ie), E.TEXT, n, o);
	},
	rt = 80,
	at = 0.08,
	nt = function (e, t, a, n, s) {
		var o = Ua(e, n, a),
			h = new S0(e, o),
			c = new y0([h], {
				width: "400em",
	...
	L1 = function (e, t) {
		var a = t.havingBaseSizing(),
			n = Zr("\\surd", e * a.sizeMultiplier, jr, a),
			s = a.sizeMultiplier,
			...
			n.type === "small"
				...
				: n.type === "large"
					? ((g = (1e3 + rt) * ue[n.size]),
						(p = (ue[n.size] + o) / s),
						(c = (ue[n.size] + o + at) / s),
						(h = nt("sqrtSize" + n.size, c, g, o, t)),
						(h.style.minWidth = "1.02em"),
						(y = 1 / s))
					: ((c = e + o + at),
						(p = e + o),
						(g = Math.floor(1e3 * e + o) + rt),
						(h = nt("sqrtTall", c, g, o, t)),
	...
	ue = [0, 1.2, 1.8, 2.4, 3],
	G1 = function (e, t, a, n, s) {
		if (
			(e === "<" || e === "\\lt" || e === "\u27E8"
				? (e = "\\langle")
				: (e === ">" || e === "\\gt" || e === "\u27E9") && (e = "\\rangle"),
			N.contains($r, e) || N.contains(Wr, e))
		)
			return Yr(e, t, !1, a, n, s);
		if (N.contains(P1, e)) return Xr(e, ue[t], !1, a, n, s);
	...
	Zr = function (e, t, a, n) {
		for (
			var s = Math.min(2, 3 - n.style.size), o = s;
			o < a.length && a[o].type !== "stack";
			o++
		) {
			var h = oe(e, Y1(a[o]), "math"),
				c = h.height + h.depth;
			if (a[o].type === "small") {
	...
	Kr = function (e, t, a, n, s, o) {
		e === "<" || e === "\\lt" || e === "\u27E8"
			? (e = "\\langle")
			: (e === ">" || e === "\\gt" || e === "\u27E9") && (e = "\\rangle");
		var h;
		N.contains(Wr, e) ? (h = V1) : N.contains($r, e) ? (h = jr) : (h = U1);
		var c = Zr(e, t, h, n);
		return c.type === "small"
			? I1(e, c.style, a, n, s, o)
			: c.type === "large"
				? Yr(e, c.size, a, n, s, o)
				: Xr(e, t, a, n, s, o);
	},
...
function Xe(r, e) {
	var t = Ue(r);
	if (t && N.contains($1, t.text)) return t;
	throw t
...
B({
	...
	htmlBuilder: (r, e) =>
		r.delim === "."
			? b.makeSpan([r.mclass])
			: q0.sizedDelim(r.delim, r.size, e, r.mode, [r.mclass]),
	mathmlBuilder: (r) => {
		var e = [];
		...
		var a = A(q0.sizeToMaxHeight[r.size]);
...
B({
	...
	htmlBuilder: (r, e) => {
		...
		if (
			(r.left === "."
				? (h = fe(e, ["mopen"]))
				: (h = q0.leftRightDelim(r.left, a, n, e, r.mode, ["mopen"])),
			t.unshift(h),
			s)
		)
			for (var c = 1; c < t.length; c++) {
				var p = t[c],
					g = p.isMiddle;
				g && (t[c] = q0.leftRightDelim(g.delim, a, n, g.options, r.mode, []));
			}
		var y;
		if (r.right === ".") y = fe(e, ["mclose"]);
		else {
			var w = r.rightColor ? e.withColor(r.rightColor) : e;
			y = q0.leftRightDelim(r.right, a, n, w, r.mode, ["mclose"]);
		}
		...
		if (a === "sout")
			...
			/box/.test(a)
				...
				: a === "angl"
					...
					: ((T = h ? 0.2 : 0), (C = T)),
				(s = R0.encloseSpan(t, a, T, C, e)),
				/fbox|boxed|fcolorbox/.test(a)
					? ((s.style.borderStyle = "solid"), (s.style.borderWidth = A(q)))
					: a === "angl" &&
						q !== 0.049 &&
						((s.style.borderTopWidth = A(q)),
						(s.style.borderRightWidth = A(q))),
				(o = t.depth + C),
				r.backgroundColor &&
...
function V0(r, e, t) {
	...
	if (
		(r.gullet.beginGroup(), p || r.gullet.macros.set("\\cr", "\\\\\\relax"), !o)
	) {
	...
	function V() {
		O &&
			(r.gullet.macros.get("\\df@tag")
				? (O.push(r.subparse([new p0("\\df@tag")])),
...
var z0 = function (e, t) {
		...
		var z =
				e.colSeparationType === "CD" ? J({ number: 3, unit: "ex" }, t) : 12 * y,
			T = 3 * y,
			C = e.arraystretch * z,
			q = 0.7 * C,
			O = 0.3 * C,
		...
		function V(be) {
			for (var ye = 0; ye < be.length; ++ye)
				ye > 0 && (H += 0.25), p.push({ pos: H, isDashed: be[ye] });
		}
		for (V(o[0]), a = 0; a < e.body.length; ++a) {
			...
			var T0 = e.rowGaps[a],
				a0 = 0;
			T0 &&
				((a0 = J(T0, t)), a0 > 0 && ((a0 += O), G < a0 && (G = a0), (a0 = 0))),
				e.addJot && (G += T),
				(j.height = U),
				(j.depth = G),
				(H += U),
		...
		if (e.tags && e.tags.some((be) => be))
			for (a = 0; a < s; ++a) {
				var K0 = c[a],
					...
					H0 = void 0;
				O0 === !0
					? (H0 = b.makeSpan(["eqn-num"], [], t))
					: O0 === !1
						? (H0 = b.makeSpan([], [], t))
						: (H0 = b.makeSpan([], t0(O0, t, !0), t)),
					(H0.depth = K0.depth),
					(H0.height = K0.height),
					Z0.push({ type: "elem", elem: H0, shift: We });
			}
		for (n = 0, I0 = 0; n < h || I0 < U0.length; ++n, ++I0) {
			for (var d0 = U0[I0] || {}, ie = !0; d0.type === "separator"; ) {
				if (
					(ie ||
					...
					var je = d0.separator === "|" ? "solid" : "dashed",
						J0 = b.makeSpan(["vertical-separator"], [], t);
					(J0.style.height = A(H)),
						(J0.style.borderRightWidth = A(g)),
						(J0.style.borderRightStyle = je),
						(J0.style.margin = "0 " + A(-g / 2));
					var Lt = H - e0;
					Lt && (J0.style.verticalAlign = A(-Lt)), s0.push(J0);
				} else throw new M("Invalid separator type: " + d0.separator);
				I0++, (d0 = U0[I0] || {}), (ie = !1);
			}
			if (!(n >= h)) {
				var Q0 = void 0;
				(n > 0 || e.hskipBeforeAndAfter) &&
					((Q0 = N.deflt(d0.pregap, w)),
					Q0 !== 0 &&
						((g0 = b.makeSpan(["arraycolsep"], [])),
						(g0.style.width = A(Q0)),
						s0.push(g0)));
				...
				for (a = 0; a < s; ++a) {
					...
					if (ge) {
						...
						(ge.depth = ve.depth),
							(ge.height = ve.height),
							_0.push({ type: "elem", elem: ge, shift: pa });
					}
				}
				(_0 = b.makeVList(
					{ positionType: "individualShift", children: _0 },
					t,
				)),
					(_0 = b.makeSpan(["col-align-" + (d0.align || "c")], [_0])),
					s0.push(_0),
					(n < h - 1 || e.hskipBeforeAndAfter) &&
						((Q0 = N.deflt(d0.postgap, w)),
						Q0 !== 0 &&
							((g0 = b.makeSpan(["arraycolsep"], [])),
							(g0.style.width = A(Q0)),
							s0.push(g0)));
		...
		if (((c = b.makeSpan(["mtable"], s0)), p.length > 0)) {
			for (
				var va = b.makeLineSpan("hline", t, g),
					ga = b.makeLineSpan("hdashline", t, g),
					Ze = [{ type: "elem", elem: c, shift: 0 }];
				p.length > 0;
			) {
				var Pt = p.pop(),
					Gt = Pt.pos - e0;
				Pt.isDashed
					? Ze.push({ type: "elem", elem: ga, shift: Gt })
					: Ze.push({ type: "elem", elem: va, shift: Gt });
			}
			c = b.makeVList({ positionType: "individualShift", children: Ze }, t);
		}
		if (Z0.length === 0) return b.makeSpan(["mord"], [c], t);
		var Ke = b.makeVList({ positionType: "individualShift", children: Z0 }, t);
		return (Ke = b.makeSpan(["tag"], [Ke], t)), b.makeFragment([c, Ke]);
	},
	W1 = { c: "center ", l: "left ", r: "right " },
	A0 = function (e, t) {
		for (
			var a = [],
			...
			e.tags &&
				e.tags[o] &&
				(c.unshift(n), c.push(n), e.leqno ? c.unshift(s) : c.push(s)),
		...
		if (e.cols && e.cols.length > 0) {
			var z = e.cols,
				...
				q = 0,
				O = z.length;
			z[0].type === "separator" && ((w += "top "), (q = 1)),
				z[z.length - 1].type === "separator" && ((w += "bottom "), (O -= 1));
			for (var H = q; H < O; H++)
				z[H].type === "align"
					? ((x += W1[z[H].align]), C && (T += "none "), (C = !0))
					: z[H].type === "separator" &&
						C &&
		...
		return (
			...
			w !== "" &&
				((g = new S.MathNode("menclose", [g])),
				g.setAttribute("notation", w.trim())),
			e.arraystretch &&
				e.arraystretch < 1 &&
				((g = new S.MathNode("mstyle", [g])),
				g.setAttribute("scriptlevel", "1")),
			g
		);
	},
	_r = function (e, t) {
		e.envName.indexOf("ed") === -1 && $e(e);
		var a = [],
		...
		o.body.forEach(function (q) {
			...
			if (x) c < q.length && (c = q.length);
				...
				if (h < L)
					throw new M(
						"Too many math in a row: " + ("expected " + h + ", but got " + L),
						q[0],
					);
			}
		});
...
M0({
	...
	handler(r, e) {
		...
		return V0(r.parser, s, Nt(r.envName));
	},
	htmlBuilder: z0,
	mathmlBuilder: A0,
});
M0({
	...
	handler(r) {
		...
		var s = V0(r.parser, a, Nt(r.envName)),
...
M0({
	...
	props: { numArgs: 0 },
	handler(r) {
		N.contains(["gather", "gather*"], r.envName) && $e(r);
		var e = {
			cols: [{ type: "align", align: "c" }],
			addJot: !0,
			colSeparationType: "gather",
			autoTag: qt(r.envName),
			emptySingleRow: !0,
...
B({
	...
	handler(r, e) {
		...
		if (a === "\\begin") {
			if (!nr.hasOwnProperty(s)) throw new M("No such environment: " + s, n);
			var h = nr[s],
			...
			if (x.name !== s)
				throw new M(
					"Mismatch: \\begin{" + s + "} matched by \\end{" + x.name + "}",
					w,
				);
			return y;
		}
...
B({
	...
	handler: (r, e) => {
		...
		return (
			s in ir && (s = ir[s]),
			{ type: "font", mode: t.mode, font: s.slice(1), body: n }
		);
	},
	htmlBuilder: ea,
	mathmlBuilder: ta,
...
var ra = (r, e) => {
		...
		return (
			r === "display"
				? (t = t.id >= E.SCRIPT.id ? t.text() : E.DISPLAY)
				: r === "text" && t.size === E.DISPLAY.size
					? (t = E.TEXT)
					: r === "script"
						? (t = E.SCRIPT)
						: r === "scriptscript" && (t = E.SCRIPTSCRIPT),
			t
		);
	},
	Rt = (r, e) => {
		...
		r.hasBarLine
			? (r.barSize
					? ((y = J(r.barSize, e)), (g = b.makeLineSpan("frac-line", e, y)))
					: (g = b.makeLineSpan("frac-line", e)),
				(y = g.height),
				(w = g.height))
			: ((g = null), (y = 0), (w = e.fontMetrics().defaultRuleThickness));
		var x, z, T;
		t.size === E.DISPLAY.size || r.size === "display"
			? ((x = e.fontMetrics().num1),
				y > 0 ? (z = 3 * w) : (z = 7 * w),
				(T = e.fontMetrics().denom1))
			: (y > 0
					? ((x = e.fontMetrics().num2), (z = w))
					: ((x = e.fontMetrics().num3), (z = 3 * w)),
				(T = e.fontMetrics().denom2));
		var C;
		if (g) {
			var O = e.fontMetrics().axisHeight;
			x - o.depth - (O + 0.5 * y) < z &&
				(x += z - (x - o.depth - (O + 0.5 * y))),
				O - 0.5 * y - (p.height - T) < z &&
					(T += z - (O - 0.5 * y - (p.height - T)));
			var H = -(O - 0.5 * y);
			C = b.makeVList(
				{
					positionType: "individualShift",
			...
			var q = x - o.depth - (p.height - T);
			q < z && ((x += 0.5 * (z - q)), (T += 0.5 * (z - q))),
				(C = b.makeVList(
					{
						positionType: "individualShift",
						children: [
		...
		var V;
		t.size === E.DISPLAY.size
			? (V = e.fontMetrics().delim1)
			: t.size === E.SCRIPTSCRIPT.size
				? (V = e.havingStyle(E.SCRIPT).fontMetrics().delim2)
				: (V = e.fontMetrics().delim2);
		var L, U;
		return (
			r.leftDelim == null
				? (L = fe(e, ["mopen"]))
				: (L = q0.customSizedDelim(
						r.leftDelim,
						V,
						!0,
						e.havingStyle(t),
			...
			b.makeSpan(
				["mord"].concat(s.sizingClasses(e)),
				[L, b.makeSpan(["mfrac"], [C]), U],
				e,
			)
		);
	},
	Et = (r, e) => {
		...
		if (r.leftDelim != null || r.rightDelim != null) {
			var o = [];
			if (r.leftDelim != null) {
				var h = new S.MathNode("mo", [
					new S.TextNode(r.leftDelim.replace("\\", "")),
				]);
				h.setAttribute("fence", "true"), o.push(h);
			}
			if ((o.push(t), r.rightDelim != null)) {
				var c = new S.MathNode("mo", [
					new S.TextNode(r.rightDelim.replace("\\", "")),
				]);
...
var sr = ["display", "text", "script", "scriptscript"],
	lr = function (e) {
		var t = null;
...
B({
	...
	handler(r, e) {
		var { parser: t } = r,
			...
			n = e[5],
			s = Fe(e[0]),
			o = s.type === "atom" && s.family === "open" ? lr(s.text) : null,
			h = Fe(e[1]),
			c = h.type === "atom" && h.family === "close" ? lr(h.text) : null,
			p = F(e[2], "size"),
			g,
			y = null;
		...
		} else (x = F(x, "textord")), (w = sr[Number(x.text)]);
		return {
			type: "genfrac",
			mode: t.mode,
			numer: a,
...
var aa = (r, e) => {
		...
		r.type === "supsub"
			? ((a = r.sup
					? P(r.sup, e.havingStyle(t.sup()), e)
					: P(r.sub, e.havingStyle(t.sub()), e)),
				(n = F(r.base, "horizBrace")))
			: (n = F(r, "horizBrace"));
		var s = P(n.base, e.havingBaseStyle(E.DISPLAY)),
			o = R0.svgSpan(n, e),
			h;
		if (
			(n.isOver
...
B({
	...
	mathmlBuilder: (r, e) => {
		var t = G0(r.body, e);
		return (
			t instanceof o0 || (t = new o0("mrow", [t])),
...
B({
	...
	mathmlBuilder(r, e) {
		return new S.MathNode("mrow", h0(r.body, e));
	},
});
B({
	type: "html",
	...
	htmlBuilder: (r, e) => {
		...
		for (var s in r.attributes)
			s !== "class" &&
				r.attributes.hasOwnProperty(s) &&
				n.setAttribute(s, r.attributes[s]);
		return n;
	},
...
B({
	...
	handler: (r, e, t) => {
		...
		if (t[0])
			for (
				var c = F(t[0], "raw").string, p = c.split(","), g = 0;
				g < p.length;
				g++
			) {
				var y = p[g].split("=");
	...
	mathmlBuilder: (r, e) => {
		...
		if (
			(r.totalheight.number > 0 &&
				((n = J(r.totalheight, e) - a), t.setAttribute("valign", A(-n))),
...
B({
	...
	htmlBuilder: (r, e) => {
		var t;
		r.alignment === "clap"
			? ((t = b.makeSpan([], [P(r.body, e)])),
				(t = b.makeSpan(["inner"], [t], e)))
...
var na = (r, e, t, a, n, s, o) => {
		r = b.makeSpan([], [r]);
		var h = t && N.isCharacterBox(t),
			c,
			p;
		if (e) {
			...
			p = {
				...
				kern: Math.max(
					...
					a.fontMetrics().bigOpSpacing3 - g.depth,
				),
			};
		}
		if (t) {
			...
			c = {
				...
				kern: Math.max(
					...
					a.fontMetrics().bigOpSpacing4 - y.height,
				),
			};
		}
		var w;
	...
	ne = (r, e) => {
		...
		if (s.symbol) {
			...
			if (
				...
				(c = b.makeSymbol(s.name, p, "math", e, [
					"mop",
					"op-symbol",
					h ? "large-op" : "small-op",
				])),
		...
		var C = 0,
			q = 0;
		return (
			(c instanceof u0 || s.name === "\\oiint" || s.name === "\\oiiint") &&
				!s.suppressBaseShift &&
	...
	pe = (r, e) => {
		var t;
		if (r.symbol)
			(t = new o0("mo", [v0(r.name, r.mode)])),
				N.contains(ia, r.name) && t.setAttribute("largeop", "false");
		else if (r.body) t = new o0("mo", h0(r.body, e));
		else {
			t = new o0("mi", [new X0(r.name.slice(1))]);
			var a = new o0("mo", [v0("\u2061", "text")]);
			r.parentIsSupSub ? (t = new o0("mrow", [t, a])) : (t = Rr([t, a]));
		}
		return t;
	},
	Z1 = {
...
var sa = (r, e) => {
			...
			for (
				var h = s.body.map((y) => {
						...
						return typeof w == "string"
							? { type: "textord", mode: y.mode, text: w }
							: y;
					}),
	...
	J1 = (r, e) => {
		...
		return r.parentIsSupSub
			? new S.MathNode("mrow", [c, p])
			: S.newDocumentFragment([c, p]);
	};
B({
	type: "operatorname",
...
function la(r, e, t) {
	for (
		var a = t0(r, e, !1), n = e.sizeMultiplier / t.sizeMultiplier, s = 0;
		s < a.length;
		s++
	) {
...
B({
	...
	handler: (r, e) => {
		...
		return { type: "sizing", mode: n.mode, size: ur.indexOf(a) + 1, body: s };
	},
	htmlBuilder: Q1,
	mathmlBuilder: (r, e) => {
		var t = e.havingSize(r.size),
...
B({
	...
	htmlBuilder(r, e) {
		...
		var o = n + s / 4,
			...
			{ span: c, ruleWidth: p, advanceWidth: g } = q0.sqrtImage(h, e),
			y = c.height - p;
		...
		if (r.index) {
			var z = e.havingStyle(E.SCRIPTSCRIPT),
				T = P(r.index, z, e),
	...
	mathmlBuilder(r, e) {
		...
		return a
			? new S.MathNode("mroot", [X(t, e), X(a, e)])
			: new S.MathNode("msqrt", [X(t, e)]);
	},
});
var hr = {
	display: E.DISPLAY,
...
B({
	...
	mathmlBuilder(r, e) {
		var t = hr[r.style],
			...
			h = o[r.style];
		return (
			s.setAttribute("scriptlevel", h[0]),
...
var _1 = function (e, t) {
	...
	if (a)
		if (a.type === "op") {
			var n =
				a.limits && (t.style.size === E.DISPLAY.size || a.alwaysHandleSupSub);
			return n ? ne : null;
		} else if (a.type === "operatorname") {
			var s =
				a.alwaysHandleSupSub && (t.style.size === E.DISPLAY.size || a.limits);
			return s ? sa : null;
		} else {
			if (a.type === "accent") return N.isCharacterBox(a.base) ? Tt : null;
...
j0({
	...
	htmlBuilder(r, e) {
		...
		if (n) {
			...
			(h = P(n, x, e)),
				w ||
					(g =
						o.height -
						(x.fontMetrics().supDrop * x.sizeMultiplier) / e.sizeMultiplier);
		}
		if (s) {
			...
			(c = P(s, z, e)),
				w ||
					(y =
						o.depth +
						(z.fontMetrics().subDrop * z.sizeMultiplier) / e.sizeMultiplier);
		}
		var T;
		e.style === E.DISPLAY
			? (T = p.sup1)
		...
		if (c) {
			...
			(o instanceof u0 || H) && (O = A(-o.italic));
		}
		var V;
		if (h && c) {
			...
			var j = [
				{ type: "elem", elem: c, shift: y, marginRight: q, marginLeft: O },
			...
			var Y = [{ type: "elem", elem: c, marginLeft: O, marginRight: q }];
			V = b.makeVList(
				...
				(V = b.makeVList(
					{
						positionType: "shift",
						positionData: -g,
						children: [{ type: "elem", elem: h, marginRight: q }],
					},
					e,
				));
		else throw new Error("supsub must have either sup or sub.");
		var T0 = dt(o, "right") || "mord";
		return b.makeSpan([T0], [o, b.makeSpan(["msupsub"], [V])], e);
	},
	mathmlBuilder(r, e) {
		var t = !1,
			a,
		...
		if (t) o = a ? "mover" : "munder";
			...
			if (r.sup) {
				var p = r.base;
				(p && p.type === "op" && p.limits && e.style === E.DISPLAY) ||
				(p &&
					p.type === "operatorname" &&
					p.alwaysHandleSupSub &&
					(e.style === E.DISPLAY || p.limits))
					? (o = "munderover")
					: (o = "msubsup");
			} else {
				var c = r.base;
				(c &&
					c.type === "op" &&
					c.limits &&
					(e.style === E.DISPLAY || c.alwaysHandleSupSub)) ||
				(c &&
					c.type === "operatorname" &&
					c.alwaysHandleSupSub &&
					(c.limits || e.style === E.DISPLAY))
					? (o = "munder")
					: (o = "msub");
			}
		else {
			...
			(h &&
				h.type === "op" &&
				h.limits &&
				(e.style === E.DISPLAY || h.alwaysHandleSupSub)) ||
			(h &&
				h.type === "operatorname" &&
				h.alwaysHandleSupSub &&
				(h.limits || e.style === E.DISPLAY))
				? (o = "mover")
				: (o = "msup");
		}
...
j0({
	...
	mathmlBuilder(r, e) {
		...
		return (
			...
			a !== oa[n.type] && n.setAttribute("mathvariant", a),
			n
		);
	},
});
...
j0({
	...
	htmlBuilder(r, e) {
		if (lt.hasOwnProperty(r.text)) {
			...
			if (st.hasOwnProperty(r.text))
				return b.makeSpan(["mspace", st[r.text]], [], e);
	...
	mathmlBuilder(r, e) {
		...
		if (lt.hasOwnProperty(r.text))
			...
			if (st.hasOwnProperty(r.text)) return new S.MathNode("mspace");
			throw new M('Unknown type of space "' + r.text + '"');
		}
		return t;
	},
...
var cr = {
	...
	dr = { "\\textbf": "textbf", "\\textmd": "textmd" },
	e4 = { "\\textit": "textit", "\\textup": "textup" },
	fr = (r, e) => {
		var t = r.font;
		return t
			? cr[t]
				? e.withTextFontFamily(cr[t])
				: dr[t]
					? e.withTextFontWeight(dr[t])
					: e.withTextFontShape(e4[t])
			: e;
	};
B({
	type: "text",
...
B({
	...
	htmlBuilder(r, e) {
		for (
			var t = pr(r), a = [], n = e.havingStyle(e.style.text()), s = 0;
			s < t.length;
			s++
		) {
			var o = t[s];
			o === "~" && (o = "\\textasciitilde"),
				a.push(
					b.makeSymbol(o, "Typewriter-Regular", r.mode, n, ["mord", "texttt"]),
				);
		}
		return b.makeSpan(
	...
	Le = class {
		constructor(e, t) {
			(this.input = void 0),
				...
				(this.input = e),
				(this.settings = t),
				(this.tokenRegex = new RegExp(s4, "g")),
				(this.catcodes = { "%": 14, "~": 13 });
		}
		setCatcode(e, t) {
			this.catcodes[e] = t;
		...
		lex() {
			...
			if (t === e.length) return new p0("EOF", new m0(this, t, t));
			var a = this.tokenRegex.exec(e);
			if (a === null || a.index !== t)
				throw new M(
					"Unexpected character: '" + e[t] + "'",
					new p0(e[t], new m0(this, t, t + 1)),
				);
			var n = a[6] || a[3] || (a[2] ? "\\ " : " ");
...
`,
			...
			return new p0(n, new m0(this, t, this.tokenRegex.lastIndex));
		}
	},
	yt = class {
		constructor(e, t) {
...
m("\\newcommand", (r) => It(r, !1, !0));
m("\\renewcommand", (r) => It(r, !0, !1));
m("\\providecommand", (r) => It(r, !0, !0));
m("\\message", (r) => {
...
m("\\dots", function (r) {
	...
	return (
		t in gr
			? (e = gr[t])
			: (t.slice(0, 4) === "\\not" ||
					(t in $.math && N.contains(["bin", "rel"], $.math[t].group))) &&
				(e = "\\dotsb"),
		e
	);
});
...
m("\\dotso", function (r) {
	var e = r.future().text;
	return e in Ot ? "\\ldots\\," : "\\ldots";
});
m("\\dotsc", function (r) {
	var e = r.future().text;
	return e in Ot && e !== "," ? "\\ldots\\," : "\\ldots";
});
m("\\cdots", function (r) {
	var e = r.future().text;
	return e in Ot ? "\\@cdots\\," : "\\@cdots";
});
m("\\dotsb", "\\cdots");
m("\\dotsm", "\\cdots");
m("\\dotsi", "\\!\\cdots");
...
var ha = A(k0["Main-Regular"][84][1] - 0.7 * k0["Main-Regular"][65][1]);
m(
	"\\LaTeX",
	"\\textrm{\\html@mathml{" +
		("L\\kern-.36em\\raisebox{" + ha + "}{\\scriptstyle A}") +
		"\\kern-.15em\\TeX}{LaTeX}}",
);
m(
	"\\KaTeX",
	"\\textrm{\\html@mathml{" +
		("K\\kern-.17em\\raisebox{" + ha + "}{\\scriptstyle A}") +
		"\\kern-.15em\\TeX}{KaTeX}}",
);
	...
	xt = class {
		constructor(e, t, a) {
			(this.settings = void 0),
				...
				this.feed(e),
				(this.macros = new yt(l4, t.macros)),
				(this.mode = a),
				(this.stack = []);
		}
		feed(e) {
			this.lexer = new Le(e, this.settings);
		}
		switchMode(e) {
			this.mode = e;
		}
		...
		scanArgument(e) {
			...
			return (
				this.pushToken(new p0("EOF", a.loc)), this.pushTokens(n), t.range(a, "")
			);
		}
		consumeSpaces() {
			for (;;) {
			...
			if (typeof n == "string") {
				...
				if (n.indexOf("#") !== -1)
					for (var o = n.replace(/##/g, ""); o.indexOf("#" + (s + 1)) !== -1; )
						++s;
				for (
					var h = new Le(n, this.settings), c = [], p = h.lex();
					p.text !== "EOF";
				)
					c.push(p), (p = h.lex());
				c.reverse();
	...
	Pe = class r {
		constructor(e, t) {
			(this.mode = void 0),
				...
				(this.mode = "math"),
				(this.gullet = new xt(e, t, this.mode)),
				(this.settings = t),
		...
		parseExpression(e, t) {
			for (var a = []; ; ) {
				...
				var n = this.fetch();
				if (
					r.endOfExpression.indexOf(n.text) !== -1 ||
					(t && n.text === t) ||
		...
		parseAtom(e) {
			...
			for (var a, n; ; ) {
				...
				if (s.text === "\\limits" || s.text === "\\nolimits") {
					...
					var p = br.test(s.text),
						g = [];
					for (g.push(new p0(Ce[s.text])), this.consume(); ; ) {
						var y = this.fetch().text;
						if (!Ce[y] || br.test(y) !== p) break;
						g.unshift(new p0(Ce[y])), this.consume();
					}
		...
		parseSizeGroup(e) {
			...
			if (!kr(s)) throw new M("Invalid unit: '" + s.unit + "'", t);
		...
		parseGroup(e, t) {
			...
			if (n === "{" || n === "\\begingroup") {
				...
				s == null && n[0] === "\\" && !ca.hasOwnProperty(n))
			) {
		...
		parseSymbol() {
			...
			if (/^\\verb[^a-zA-Z]/.test(t)) {
				...
				var a = t.slice(5),
					n = a.charAt(0) === "*";
				if (
					(n && (a = a.slice(1)), a.length < 2 || a.charAt(0) !== a.slice(-1))
				)
			...
			if ((this.consume(), s))
				for (var y = 0; y < s[0].length; y++) {
					var w = s[0][y];
					if (!ot[w]) throw new M("Unknown accent ' " + w + "'", e);
					var x = ot[w][this.mode] || ot[w].text;
					if (!x)
						throw new M(
...
Pe.endOfExpression = ["}", "\\endgroup", "\\end", "\\right", "&"];
var Ht = function (e, t) {
...
var o4 = function (e, t) {
	...
	fa = function (e, t, a) {
		...
		var n = b.makeSpan(["katex-error"], [new u0(t)]);
		return (
