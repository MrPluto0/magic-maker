...
var r = {
		...
		lineEditor: { edit: "Rediger linje", exit: "Avslutt linjeredigering" },
		elementLock: {
			lock: "L\xE5s",
			unlock: "L\xE5s opp",
			lockAll: "L\xE5s alle",
	...
	i = {
		...
		hint_emptyLibrary:
			"Velg et objekt p\xE5 lerretet for \xE5 legge det til her, eller installer et bibliotek fra den offentlige samlingen under.",
		hint_emptyPrivateLibrary:
			"Velg et objekt p\xE5 lerretet for \xE5 legge det til her.",
	},
	n = {
	...
	l = {
		...
		couldNotCreateShareableLinkTooBig:
			"Kunne ikke opprette lenke til deling: scenen er for stor",
		...
		uploadedSecurly:
			"Opplastingen er kryptert og kan ikke leses av Excalidraw-serveren eller tredjeparter.",
		loadSceneOverridePrompt:
			"\xC5 laste inn ekstern tegning vil erstatte det eksisterende innholdet. \xD8nsker du \xE5 fortsette?",
...
(Hvis du \xF8nsker \xE5 beholde din lokale tegning, bare lukk nettleserfanen i stedet.)`,
		...
		confirmAddLibrary:
			"Dette vil legge til {{numShapes}} figur(er) i biblioteket ditt. Er du sikker?",
		imageDoesNotContainScene:
			"Det ser ikke ut til at dette bildet inneholder noen scenedata. Har du aktivert innebygging av scene under eksporten?",
		cannotRestoreFromImage:
			"Scenen kunne ikke gjenopprettes fra denne bildefilen",
		invalidSceneUrl:
			"Kunne ikke importere scene fra den oppgitte URL-en. Den er enten \xF8delagt, eller inneholder ikke gyldig Excalidraw JSON-data.",
		...
		invalidEncryptionKey:
			"Krypteringsn\xF8kkel m\xE5 ha 22 tegn. Live-samarbeid er deaktivert.",
...
Endringer dine vil ikke bli lagret!`,
	...
	a = {
		...
		fileTooBig:
			"Filen er for stor. Maksimal tillatt st\xF8rrelse er {{maxSize}}.",
		svgImageInsertError:
			"Kunne ikke sette inn SVG-bilde. SVG-koden ser ugyldig ut.",
		failedToFetchImage: "",
		invalidSVGString: "Ugyldig SVG.",
		cannotResolveCollabServer:
			"Kunne ikke koble til samarbeidsserveren. Vennligst oppdater siden og pr\xF8v p\xE5 nytt.",
		importLibraryError: "Kunne ikke laste bibliotek",
		collabSaveFailed:
			"Kan ikke lagre i backend-databasen. Hvis problemer vedvarer, b\xF8r du lagre filen lokalt for \xE5 sikre at du ikke mister arbeidet.",
		collabSaveFailed_sizeExceeded:
			"Kunne ikke lagre til backend-databasen, lerretet ser ut til \xE5 v\xE6re for stort. Du b\xF8r lagre filen lokalt for \xE5 sikre at du ikke mister arbeidet ditt.",
		imageToolNotSupported: "",
		brave_measure_text_error: {
			line1:
				"Ser ut som om du bruker Brave nettleser med <bold>Aggressivt Block Finger</bold> -innstillingen aktivert.",
			line2:
				"Dette kan resultere i \xE5 bryte <bold>tekst-elementene</bold> i tegningene.",
			line3:
				"Vi anbefaler p\xE5 det sterkeste \xE5 deaktivere denne innstillingen. Du kan f\xF8lge <link>disse trinnene</link> om hvordan du gj\xF8r det.",
			line4:
				"Hvis deaktivering av denne innstillingen ikke fikser visningen av tekstelementer, vennligst \xE5pne en <issueLink>sak</issueLink> p\xE5 v\xE5r GitHub, eller skriv oss p\xE5 <discordLink>Discord</discordLink>",
		},
	...
	d = {
		canvasPanning:
			"For \xE5 flytte lerretet, hold musehjulet eller mellomromstasten mens du drar, eller bruk h\xE5nd-verkt\xF8yet",
		linearElement:
			"Klikk for \xE5 starte linje med flere punkter, eller dra for en enkel linje",
		...
		text_editing:
			"Trykk Escape eller Ctrl/Cmd+Enter for \xE5 fullf\xF8re redigering",
		linearElementMulti:
			"Klikk p\xE5 siste punkt eller trykk Escape eller Enter for \xE5 fullf\xF8re",
...
hold ALT for \xE5 endre st\xF8rrelse fra midten`,
		...
		lineEditor_info:
			"Hold Ctrl/Cmd og dobbelklikk eller trykk Ctrl/Cmd + Enter for \xE5 endre punkter",
		lineEditor_pointSelected:
			"Trykk p\xE5 Slett for \xE5 fjerne punktet, Ctrl / Cmd+D for \xE5 duplisere, eller dra for \xE5 flytte",
...
eller hold Alt og klikk for \xE5 legge til nye punkter`,
		placeImage:
			"Klikk for \xE5 plassere bildet, eller klikk og dra for \xE5 angi st\xF8rrelsen manuelt",
		...
		firefox_clipboard_write:
			'Denne funksjonen kan sannsynligvis aktiveres ved \xE5 sette "dom.events.asyncClipboard.clipboardItem" flagget til "true". For \xE5 endre nettleserens flagg i Firefox, bes\xF8k "about:config"-siden.',
		disableSnapping: "",
	},
	k = {
		...
		canvasTooBigTip:
			"Tips: Pr\xF8v \xE5 flytte de ytterste elementene litt tettere sammen.",
	},
	g = {
		headingMain:
			"En feil oppsto. Pr\xF8v <button>\xE5 laste siden p\xE5 nytt.</button>",
		clearCanvasMessage:
			"Om ny sidelasting ikke fungerer, pr\xF8v <button>\xE5 t\xF8mme lerretet.</button>",
		clearCanvasCaveat: " Dette vil f\xF8re til tap av arbeid ",
		trackedToSentry:
			"Feilen med identifikator {{eventId}} ble logget i v\xE5rt system.",
		openIssueMessage:
			"Vi er veldig n\xF8ye med \xE5 ikke inkludere dine scene-opplysninger i feilen. Hvis din scene ikke er privat, vurder \xE5 f\xF8lge opp i v\xE5rt <button>feilrapporteringssystem.</button> Ta med opplysningene nedenfor ved \xE5 kopiere og lime inn i GitHub-saken.",
		sceneContent: "Scene-innhold:",
	},
	b = {
		desc_intro:
			"Du kan invitere personer til scenen din for \xE5 samarbeide med deg.",
		desc_privacy:
			"Ta det med ro, sesjonen bruker ende-til-ende-kryptering, s\xE5 alt du tegner forblir privat. Ikke en gang serveren v\xE5r kan se hva du lager.",
		...
		desc_exitSession:
			"Dersom du avslutter sesjonen blir du frakoblet rommet, men du kan fortsette \xE5 arbeide med scenen lokalt. V\xE6r oppmerksom p\xE5 at dette ikke vil p\xE5virke andre personer, og de vil fortsatt ha mulighet til \xE5 samarbeide p\xE5 deres versjon.",
	...
	p = {
		...
		disk_details:
			"Eksporter scene-dataene til en fil som du kan importere fra senere.",
		...
		excalidrawplus_description:
			"Lagre scenen til ditt Excalidraw+ arbeidsomr\xE5de.",
		excalidrawplus_button: "Eksporter",
		excalidrawplus_exportError:
			"Kunne ikke eksportere til Excalidraw+ for \xF8yeblikket...",
	},
	u = {
	...
	c = {
		...
		placeholder: {
			...
			libraryDesc:
				"Beskrivelse av biblioteket ditt for \xE5 hjelpe folk med \xE5 forst\xE5 bruken",
			githubHandle:
				"Github-brukernavn (valgfritt), slik at du kan redigere biblioteket n\xE5r du har sendt inn for gjennomgang",
			twitterHandle:
				"Twitter-brukernavn (valgfritt), slik at vi vet hvem vi skal kreditere n\xE5r promotert p\xE5 Twitter",
			website:
				"Lenke til din personlige nettside eller et annet sted (valgfritt)",
		},
		errors: { required: "P\xE5krevd", website: "Angi en gyldig nettadresse" },
		noteDescription:
			"Send inn biblioteket ditt som skal inkluderes i <link>kildekode for offentlig bibliotek</link>for andre \xE5 bruke dem i tegninger.",
		noteGuidelines:
			"Biblioteket m\xE5 godkjennes manuelt f\xF8rst. Les <link>retningslinjene</link> f\xF8r innsending. Du vil trenge en GitHub-konto for \xE5 kommunisere og gj\xF8re endringer hvis \xF8nsket, men det er ikke p\xE5krevd.",
		noteLicense:
			"Ved \xE5 sende inn godtar du at biblioteket blir publisert under <link>MIT-lisens, </link>som kortfattet betyr at andre kan bruke dem uten begrensninger.",
		noteItems:
			"Hvert bibliotek m\xE5 ha sitt eget navn, s\xE5 det er filtrerbart. F\xF8lgende bibliotekselementer vil bli inkludert:",
		atleastOneLibItem:
			"Vennligst velg minst ett bibliotek for \xE5 komme i gang",
		republishWarning:
			"Merk: noen av de valgte elementene er merket som allerede publisert/sendt. Du b\xF8r kun sende inn elementer p\xE5 nytt n\xE5r du oppdaterer et eksisterende bibliotek eller innlevering.",
	},
	f = {
		title: "Bibliotek innsendt",
		content:
			"Takk {{authorName}}. Ditt bibliotek har blitt sendt inn for gjennomgang. Du kan spore statusen<link>her</link>",
	},
	y = {
		resetLibrary: "Nullstill bibliotek",
...
Det vil \xF8ke den eksporterte filst\xF8rrelsen.`,
	...
	S = {
		tooltip:
			"Dine tegninger er ende-til-ende-krypterte slik at Excalidraw sine servere aldri vil se dem.",
...
eller lim inn i en eksisterende tekstbehandler`,
		unableToEmbed:
			"Innbygging av denne nettadressen er ikke tillatt. Oppret en sak p\xE5 GitHub for \xE5 be om url-hvitelisting",
		unrecognizedLinkFormat:
			'Linken du bygget inn samsvarer ikke med det forventede formatet. Pr\xF8v \xE5 lime inn "bygg inn"-strengen fra kildesiden',
	},
	E = {
	...
	x = {
		...
		modal: {
			loadFromFile: {
				...
				description:
					"\xC5 laste fra en fil vil <bold>erstatte ditt eksisterende innhold</bold>.<br></br>Du kan sikkerhetskopiere tegningen din f\xF8rst ved \xE5 bruke en av valgene under.",
			},
			shareableLink: {
				title: "Last inn fra lenke",
				button: "Erstatt innholdet mitt",
				description:
					"Lasting av ekstern tegning vil <bold>erstatte ditt eksisterende innhold</bold>.<br></br>Du kan sikkerhetskopiere tegningen din f\xF8rst ved \xE5 bruke en av valgene nedenfor.",
			},
		},
	},
	D = { title: "", button: "", description: "", syntax: "", preview: "" },
	j = {
		labels: r,
		library: i,
		buttons: n,
