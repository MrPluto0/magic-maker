import { a as we } from "./chunk-LA5IGN2Q.js";
import { A as ve } from "./chunk-4IXHFASB.js";
import {
	G as Ae,
	Ga as he,
	J as ze,
...
import { a as xe } from "./chunk-M2JW2GFW.js";
import { f as ce } from "./chunk-SXMPUQ6M.js";
xe();
var Vt = ce(Ke(), 1),
	qt = ce(Ge(), 1),
	Ot = ce(ze(), 1);
var pe = (function () {
	var e = function (V, i, n, a) {
		...
		c = [1, 5],
		u = [1, 6],
		d = [5, 6, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63],
		p = [1, 18],
		h = [2, 7],
		o = [1, 22],
		g = [1, 23],
		...
		x = [1, 29],
		F = [62, 63],
		_e = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 51, 53, 62, 63],
		ge = [1, 47],
		Ee = [1, 48],
		Re = [1, 49],
		me = [1, 50],
		...
		X = [1, 67],
		J = [1, 68],
		m = [5, 8, 9, 11, 13, 31, 32, 33, 34, 35, 36, 44, 62, 63],
		re = {
			trace: function () {},
			yy: {},
			symbols_: {
			...
			performAction: function (i, n, a, r, f, s, W) {
				var _ = s.length - 1;
				switch (f) {
					case 4:
			...
			table: [
				{ 3: 1, 4: 2, 6: t, 9: l, 11: c, 13: u },
				{ 1: [3] },
				{ 3: 8, 4: 2, 5: [1, 7], 6: t, 9: l, 11: c, 13: u },
				{ 5: [1, 9] },
				{ 10: [1, 10] },
				{ 12: [1, 11] },
				e(d, [2, 6]),
				{ 3: 12, 4: 2, 6: t, 9: l, 11: c, 13: u },
				{ 1: [2, 2] },
				{
					4: 17,
					5: p,
				...
				{ 19: [2, 53] },
				{ 19: [2, 54] },
				{ 52: 46, 55: ge, 56: Ee, 57: Re, 58: me, 59: Ie, 60: be, 61: ke },
				{ 52: 54, 55: ge, 56: Ee, 57: Re, 58: me, 59: Ie, 60: be, 61: ke },
				{ 5: [1, 55] },
				{ 5: [1, 56] },
				{ 53: [1, 57] },
				e(O, [2, 40]),
				...
				e(O, [2, 46]),
				{ 54: [1, 58] },
				{ 5: M, 20: 59, 21: D, 24: P, 26: Y, 28: U, 30: B },
				{ 5: z, 30: j, 46: 66, 47: X, 49: J },
				{ 23: 71, 62: k, 63: x },
				{ 23: 72, 62: k, 63: x },
				e(m, [2, 13]),
				{ 22: [1, 73] },
				...
				{ 22: [1, 75] },
				{ 22: [1, 76] },
				{ 5: M, 20: 77, 21: D, 24: P, 26: Y, 28: U, 30: B },
				e(m, [2, 19]),
				e(m, [2, 33]),
				{ 22: [1, 78] },
				{ 22: [1, 79] },
				{ 5: z, 30: j, 46: 80, 47: X, 49: J },
				e(m, [2, 37]),
				e(m, [2, 38]),
				e(m, [2, 39]),
				{ 23: 81, 62: k, 63: x },
				...
				{ 5: [2, 57] },
				{ 5: [2, 58] },
				{ 5: M, 20: 106, 21: D, 24: P, 26: Y, 28: U, 30: B },
				{ 5: M, 20: 107, 21: D, 24: P, 26: Y, 28: U, 30: B },
				{ 5: M, 20: 108, 21: D, 24: P, 26: Y, 28: U, 30: B },
				{ 5: M, 20: 109, 21: D, 24: P, 26: Y, 28: U, 30: B },
				{ 5: z, 30: j, 46: 110, 47: X, 49: J },
				{ 5: z, 30: j, 46: 111, 47: X, 49: J },
				e(m, [2, 14]),
				e(m, [2, 15]),
				e(m, [2, 16]),
				e(m, [2, 17]),
			...
			parse: function (i) {
				...
				var ae = E.yylloc;
				s.push(ae);
				var He = E.options && E.options.ranges;
				...
				function We() {
					...
					return (
						($ = r.pop() || E.lex() || Te),
						typeof $ != "number" &&
							($ instanceof Array && ((r = $), ($ = r.pop())),
							($ = n.symbols_[$] || $)),
						$
					);
				}
				for (var I, C, S, le, Q = {}, ee, w, Ne, te; ; ) {
					if (
						((C = a[a.length - 1]),
						this.defaultActions[C]
							? (S = this.defaultActions[C])
							: ((I === null || typeof I > "u") && (I = We()),
								(S = W[C] && W[C][I])),
					...
					switch (S[0]) {
						...
						case 2:
							...
							w &&
								...
								f.push(Q.$),
								s.push(Q._$),
								(Ne = W[a[a.length - 2]][a[a.length - 1]]),
								a.push(Ne);
							break;
						case 3:
							return !0;
			...
			var V = {
				...
				unput: function (i) {
					...
					return (
						...
						this.options.ranges &&
							(this.yylloc.range = [f[0], f[0] + this.yyleng - n]),
...
` +
				...
				test_match: function (i, n) {
					...
					if (
						(this.options.backtrack_lexer &&
							...
							this.options.ranges &&
								(f.yylloc.range = this.yylloc.range.slice(0))),
						(r = i[0].match(/(?:\r\n?|\n).*/g)),
				...
				next: function () {
					...
					for (var f = this._currentRules(), s = 0; s < f.length; s++)
						if (
							((a = this._input.match(this.rules[f[s]])),
							a && (!n || a[0].length > n[0].length))
						) {
							if (((n = a), (r = s), this.options.backtrack_lexer)) {
								if (((i = this.test_match(a, f[s])), i !== !1)) return i;
								if (this._backtrack) {
									n = !1;
									continue;
								} else return !1;
					...
					return n
						? ((i = this.test_match(n, f[r])), i !== !1 ? i : !1)
						: this._input === ""
							? this.EOF
							: this.parseError(
									"Lexical error on line " +
...
` +
				...
				performAction: function (n, a, r, f) {
					switch (r) {
						case 0:
							return "title";
						case 1:
...
var je = pe,
	...
	Je = { LOW_RISK: "Low", MED_RISK: "Medium", HIGH_RISK: "High" },
	Ze = {
	...
	lt = (e) => (
		G[e] === void 0 &&
			((G[e] = { name: e, type: q.type, docRef: q.docRef }),
			he.info("Added new requirement: ", e)),
		(q = {}),
		G[e]
	),
	ot = () => G,
...
`,
	_t = yt,
	fe = { CONTAINS: "contains", ARROW: "arrow" },
	gt = (e, t) => {
		let l = e
			.append("defs")
			.append("marker")
			.attr("id", fe.CONTAINS + "_line_ending")
			.attr("refX", 0)
	...
	Me = { ReqMarkers: fe, insertLineEndings: gt },
	y = {},
	Fe = 0,
	De = (e, t) =>
		e
			...
			.attr("x", 0)
			.attr("y", 0)
			.attr("width", y.rect_min_width + "px")
			.attr("height", y.rect_min_height + "px"),
	Pe = (e, t, l) => {
		let c = y.rect_min_width / 2,
			u = e
				.append("text")
				.attr("class", "req reqLabel reqTitle")
				.attr("id", t)
				.attr("x", c)
				.attr("y", y.rect_padding)
		...
		l.forEach((g) => {
			d == 0
				...
				: u
						...
						.attr("text-anchor", "middle")
						.attr("x", y.rect_min_width / 2)
						.attr("dy", y.line_height * 0.75)
						.text(g),
				d++;
		});
		let p = 1.5 * y.rect_padding,
			h = d * y.line_height * 0.75,
			o = p + h;
		return (
			e
				.append("line")
	...
	Et = (e, t, l, c) => {
		let u = t.node().getTotalLength(),
			d = t.node().getPointAtLength(u * 0.5),
			p = "rel" + Fe;
		Fe++;
		let o = e
			.append("text")
		...
		e.insert("rect", "#" + p)
			...
			.attr("x", d.x - o.width / 2)
			.attr("y", d.y - o.height / 2)
			.attr("width", o.width)
			.attr("height", o.height)
			.attr("fill", "white")
			.attr("fill-opacity", "85%");
	},
	Rt = function (e, t, l, c, u) {
		let d = l.edge(H(t.src), H(t.dst)),
			p = Ae()
				.x(function (o) {
					return o.x;
				})
			...
			h = e
				...
				.attr("d", p(d.points))
				.attr("fill", "none");
		t.type == u.db.Relationships.CONTAINS
			? h.attr(
					"marker-start",
					"url(" +
						ue.getUrl(y.arrowMarkerAbsolute) +
						"#" +
						t.type +
						"_line_ending)",
				)
			: (h.attr("stroke-dasharray", "10,7"),
				h.attr(
					"marker-end",
					"url(" +
						ue.getUrl(y.arrowMarkerAbsolute) +
	...
	mt = (e, t, l) => {
		Object.keys(e).forEach((c) => {
			let u = e[c];
			(c = H(c)), he.info("Added new requirement: ", c);
			let d = l.append("g").attr("id", c),
				p = "req-" + c,
				h = De(d, p),
				o = Pe(d, c + "_title", [`<<${u.type}>>`, `${u.name}`]);
			Ye(
				d,
				c + "_body",
				[
			...
			t.setNode(c, { width: g.width, height: g.height, shape: "rect", id: c });
		});
	},
	It = (e, t, l) => {
		Object.keys(e).forEach((c) => {
			let u = e[c],
				d = H(c),
				p = l.append("g").attr("id", d),
				h = "element-" + d,
				o = De(p, h),
				g = Pe(p, h + "_title", ["<<Element>>", `${c}`]);
			Ye(
				p,
				h + "_body",
				[
					`Type: ${u.type || "Not Specified"}`,
					`Doc Ref: ${u.docRef || "None"}`,
				],
				g.y,
			);
			let R = o.node().getBBox();
			t.setNode(d, { width: R.width, height: R.height, shape: "rect", id: d });
		});
	},
	bt = (e, t) => (
			...
			l !== void 0 &&
				...
				e
					...
					.attr(
						"transform",
						"translate(" +
							(t.node(l).x - t.node(l).width / 2) +
							"," +
							(t.node(l).y - t.node(l).height / 2) +
							" )",
					));
		});
	},
	H = (e) => e.replace(/\s/g, "").replace(/\./g, "_"),
	St = (e, t, l, c) => {
		y = de().requirement;
		let u = y.securityLevel,
			d;
		u === "sandbox" && (d = ie("#i" + t));
		let h = (
			u === "sandbox" ? ie(d.nodes()[0].contentDocument.body) : ie("body")
		).select(`[id='${t}']`);
		Me.insertLineEndings(h, y);
		let o = new ve({ multigraph: !1, compound: !1, directed: !0 })
				.setGraph({
			...
			g = c.db.getRequirements(),
			R = c.db.getElements(),
			A = c.db.getRelationships();
		mt(g, o, h),
			It(R, o, h),
			bt(A, o),
			we(o),
		...
		let T = y.rect_padding,
			N = h.node().getBBox(),
			v = N.width + T * 2,
			k = N.height + T * 2;
		$e(h, k, v, y.useMaxWidth),
			h.attr("viewBox", `${N.x - T} ${N.y - T} ${v} ${k}`);
	},
	Tt = { draw: St },
	Lt = { parser: je, db: ft, renderer: Tt, styles: _t };
