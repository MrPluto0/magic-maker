...
var a = {
	...
	l = { noItems: "", hint_emptyLibrary: "", hint_emptyPrivateLibrary: "" },
	s = {
	...
	r = {
		...
		couldNotCreateShareableLink:
			"Nem siker\xFClt megoszthat\xF3 linket l\xE9trehozni.",
		couldNotCreateShareableLinkTooBig:
			"Nem siker\xFClt megoszthat\xF3 linket l\xE1trehozni: t\xFAl nagy a jelenet",
		couldNotLoadInvalidFile:
			"Nem siker\xFClt bet\xF6lteni a helytelen f\xE1jlt",
		...
		uploadedSecurly:
			"A felt\xF6lt\xE9st v\xE9gpontok k\xF6z\xF6tti titkos\xEDt\xE1ssal biztos\xEDtottuk, ami azt jelenti, hogy egy harmadik f\xE9l nem tudja megn\xE9zni a tartalm\xE1t, bele\xE9rtve az Excalidraw szervereit is.",
		loadSceneOverridePrompt:
			"A bet\xF6lt\xF6tt k\xFCls\u0151 rajz fel\xFCl fogja \xEDrnia megl\xE9v\u0151t. Szeretn\xE9d folytatni?",
...
(Ha meg akarod tartani a helyben t\xE1rolt rajzot, egyszer\u0171en csak z\xE1rd be a b\xF6ng\xE9sz\u0151 f\xFClet)`,
		errorAddingToLibrary:
			"A t\xE9tel nem addhat\xF3 hozz\xE1 a k\xF6nyvt\xE1rhoz",
		errorRemovingFromLibrary:
			"A t\xE9tel nem t\xE1vol\xEDthat\xF3 el a k\xF6nyvt\xE1rb\xF3l",
		confirmAddLibrary:
			"Ez a m\u0171velet {{numShapes}} form\xE1t fog hozz\xE1adni a k\xF6nyvt\xE1radhoz. Biztos vagy benne?",
		imageDoesNotContainScene:
			"\xDAgy t\u0171nik, hogy ez a k\xE9p nem tartalmaz jelenetadatokat. Enged\xE9lyezted a jelenetbe\xE1gyaz\xE1st az export\xE1l\xE1s sor\xE1n?",
		cannotRestoreFromImage:
			"A jelenet vissza\xE1ll\xEDt\xE1sa nem siker\xFClt ebb\u0151l a k\xE9p f\xE1jlb\xF3l",
		invalidSceneUrl:
			"Nem siker\xFClt import\xE1lni a jelenetet a megadott URL-r\u0151l. Rossz form\xE1tum\xFA, vagy nem tartalmaz \xE9rv\xE9nyes Excalidraw JSON-adatokat.",
		resetLibrary:
			"Ezzel t\xF6rl\xF6d a k\xF6nyvt\xE1r\xE1t. biztos vagy ebben?",
		removeItemsFromsLibrary:
			"{{count}} elemet t\xF6r\xF6lsz a k\xF6nyvt\xE1rb\xF3l?",
		invalidEncryptionKey:
			"A titkos\xEDt\xE1si kulcsnak 22 karakterb\u0151l kell \xE1llnia. Az \xE9l\u0151 egy\xFCttm\u0171k\xF6d\xE9s le van tiltva.",
		collabOfflineWarning: "",
	},
	o = {
		unsupportedFileType: "Nem t\xE1mogatott f\xE1jlt\xEDpus.",
		imageInsertError:
			"Nem siker\xFClt besz\xFArni a k\xE9pet. Pr\xF3b\xE1ld \xFAjra k\xE9s\u0151bb...",
		fileTooBig:
			"A f\xE1jl t\xFAl nagy. A megengedett maxim\xE1lis m\xE9ret {{maxSize}}.",
		svgImageInsertError:
			"Nem siker\xFClt besz\xFArni az SVG-k\xE9pet. Az SVG szintaktika \xE9rv\xE9nytelennek t\u0171nik.",
		failedToFetchImage: "",
	...
	z = {
		canvasPanning: "",
		linearElement:
			"Kattint\xE1ssal g\xF6rbe, az eger h\xFAz\xE1s\xE1val pedig egyenes nyilat rajzolhatsz",
		...
		embeddable: "",
		text_selected:
			"Kattints dupl\xE1n, vagy nyomj entert a sz\xF6veg szerkeszt\xE9s\xE9hez",
		text_editing:
			"Nyomjd meg az Escape vagy a Ctrl/Cmd+ENTER billenty\u0171kombin\xE1ci\xF3t a szerkeszt\xE9s befejez\xE9s\xE9hez",
		linearElementMulti:
			"Kattints a k\xF6vetkez\u0151 \xEDv poz\xEDci\xF3j\xE1ra, vagy fejezd be a nyilat az Escape vagy Enter megnyom\xE1s\xE1val",
		lockAngle:
			"A SHIFT billenty\u0171 lenyomva tart\xE1s\xE1val korl\xE1tozhatja forgat\xE1s sz\xF6g\xE9t",
...
tartsd lenyomva az ALT billenty\u0171t a k\xF6z\xE9pr\u0151l val\xF3 \xE1tm\xE9retez\xE9shez`,
		rotate:
			"A SHIFT billenty\u0171 lenyomva tart\xE1s\xE1val korl\xE1tozhatja a sz\xF6gek illeszt\xE9s\xE9t",
		lineEditor_info: "",
...
vagy Alt, \xE9s kattintson az \xFAj pontok hozz\xE1ad\xE1s\xE1hoz`,
		placeImage:
			"Kattints a k\xE9p elhelyez\xE9s\xE9hez, vagy kattints \xE9s m\xE9retezd manu\xE1lisan",
		...
		deepBoxSelect:
			"Tartsd lenyomva a Ctrl/Cmd billenty\u0171t a m\xE9ly kijel\xF6l\xE9shez \xE9s a h\xFAz\xE1s megakad\xE1lyoz\xE1s\xE1hoz",
		eraserRevert: "",
	...
	d = {
		...
		canvasTooBigTip:
			"Tipp: pr\xF3b\xE1ld meg a legt\xE1volabbi elemeket k\xF6zelebb hozni egy m\xE1shoz.",
	},
	k = {
		headingMain:
			"Hiba t\xF6rt\xE9nt. Pr\xF3b\xE1ld <button>\xFAjrat\xF6lteni az oldalt.</button>",
		clearCanvasMessage:
			"Ha az \xFAjrat\xF6lt\xE9s nem m\u0171k\xF6dik, pr\xF3b\xE1ld <button>let\xF6r\xF6lni a v\xE1szont.</button>",
		clearCanvasCaveat: " Ezzel az eddigi munka elveszik ",
		trackedToSentry:
			"A hibak\xF3d azonos\xEDt\xF3val {{eventId}} nyomon van k\xF6vetve a rendszer\xFCnkben.",
		openIssueMessage:
			"Vigy\xE1ztunk arra, hogy a jelenthez tartoz\xF3 inform\xE1ci\xF3 ne jelenjen meg a hiba\xFCzenetben. Ha a jeleneted nem bizalmas, k\xE9rj\xFCk add hozz\xE1 a <button>hibak\xF6vet\u0151 rendszer\xFCnkh\xF6z.</button> K\xE9rj\xFCk, m\xE1solja be az al\xE1bbi inform\xE1ci\xF3kat a GitHub probl\xE9m\xE1ba.",
		sceneContent: "Jelenet tartalma:",
	},
	m = {
		desc_intro:
			"Megh\xEDvhat embereket a jelenlegi jelenetbe, hogy egy\xFCttm\u0171k\xF6djenek \xF6nnel.",
		desc_privacy:
			"Ne agg\xF3dj, a munkamenet v\xE9gpontok k\xF6z\xF6tti titkos\xEDt\xE1st haszn\xE1l, teh\xE1t b\xE1rmit rajzolsz, priv\xE1t marad. M\xE9g a szerver\xFCnkr\u0151l se lehet belen\xE9zni.",
		button_startSession: "Munkamenet ind\xEDt\xE1sa",
		button_stopSession: "Munkamenet le\xE1ll\xEDt\xE1sa",
		desc_inProgressIntro:
			"Az \xE9l\u0151 egy\xFCttm\u0171k\xF6d\xE9si munkamenet folyamatban van.",
		desc_shareLink:
			"Ossza meg ezt a linket b\xE1rkivel, akivel egy\xFCtt szeretne m\u0171k\xF6dni:",
		desc_exitSession:
			"Az munkamenet le\xE1ll\xEDt\xE1sa kil\xE9pteti \xF6nt a szob\xE1b\xF3l, de folytathatja a munk\xE1t a saj\xE1t g\xE9p\xE9n. Vegye figyelembe, hogy ez nem \xE9rinti m\xE1s emberek munk\xE1j\xE1t \xE9s \u0151k tov\xE1bbra is egy\xFCttm\u0171k\xF6dhetnek a saj\xE1t v\xE1ltozatukon.",
		shareTitle:
			"Csatlakoz\xE1s egy \xE9l\u0151 egy\xFCttm\u0171k\xF6d\xE9si munkamenethez az Excalidraw-ban",
	},
	g = { title: "Hiba" },
	b = {
		disk_title: "Ment\xE9s lemezre",
		disk_details:
			"Export\xE1lja a jelenetadatokat egy f\xE1jlba, amelyb\u0151l k\xE9s\u0151bb import\xE1lhatja.",
		...
		excalidrawplus_description:
			"Mentse el a jelenetet az Excalidraw+ munkater\xFClet\xE9re.",
		excalidrawplus_button: "Export\xE1l\xE1s",
		excalidrawplus_exportError:
			"Jelenleg nem lehet export\xE1lni az Excalidraw+-ba...",
	},
	v = {
		...
		deepBoxSelect:
			"M\xE9ly kijel\xF6l\xE9s a dobozon bel\xFCl, \xE9s a h\xFAz\xE1s megakad\xE1lyoz\xE1sa",
	...
	y = { title: "Rajzv\xE1szon alaphelyzetbe" },
	c = {
		...
		placeholder: {
			...
			libraryDesc:
				"A k\xF6nyvt\xE1rad haszn\xE1lat\xE1t seg\xEDt\u0151 le\xEDr\xE1s",
			githubHandle:
				"GitHub-handle(opcion\xE1lis), \xEDgy szerkesztheted a k\xF6nyvt\xE1rat, miut\xE1n elk\xFCldted ellen\u0151rz\xE9sre",
			twitterHandle:
				"Twitter-felhaszn\xE1l\xF3n\xE9v (opcion\xE1lis), \xEDgy tudjuk, kinek kell j\xF3v\xE1\xEDrni a Twitteren kereszt\xFCli rekl\xE1moz\xE1st",
			website:
				"Hivatkoz\xE1s szem\xE9lyes webhelyedre vagy m\xE1shov\xE1 (nem k\xF6telez\u0151)",
		},
		errors: {
		...
		noteDescription:
			"K\xFCld be k\xF6nyvt\xE1radat, hogy beker\xFClj\xF6n a <link>nyilv\xE1nos k\xF6nyvt\xE1r t\xE1rol\xF3ba</link>hogy m\xE1sok is felhaszn\xE1lhass\xE1k a rajzaikban.",
		noteGuidelines:
			"A k\xF6nyvt\xE1rat el\u0151sz\xF6r manu\xE1lisan kell j\xF3v\xE1hagyni. K\xE9rj\xFCk, olvassa el a <link>seg\xE9dletet</link> beny\xFAjt\xE1sa el\u0151tt. Sz\xFCks\xE9ge lesz egy GitHub-fi\xF3kra a kommunik\xE1ci\xF3hoz \xE9s a m\xF3dos\xEDt\xE1sokhoz, ha k\xE9rik, de ez nem felt\xE9tlen\xFCl sz\xFCks\xE9ges.",
		noteLicense:
			"A bek\xFCld\xE9ssel elfogadja, hogy a k\xF6nyvt\xE1r a k\xF6vetkez\u0151 alatt ker\xFCl k\xF6zz\xE9t\xE9telre <link>MIT Licensz </link>ami r\xF6viden azt jelenti, hogy b\xE1rki korl\xE1toz\xE1s n\xE9lk\xFCl haszn\xE1lhatja \u0151ket.",
		noteItems:
			"Minden k\xF6nyvt\xE1relemnek saj\xE1t nev\xE9vel kell rendelkeznie, hogy sz\u0171rhet\u0151 legyen. A k\xF6vetkez\u0151 k\xF6nyvt\xE1ri t\xE9telek ker\xFClnek bele:",
		atleastOneLibItem:
			"A kezd\xE9shez v\xE1lassz ki legal\xE1bb egy k\xF6nyvt\xE1ri elemet",
		republishWarning: "",
	},
	h = {
		title: "A k\xF6nyvt\xE1r bek\xFCldve",
		content:
			"K\xF6sz\xF6nj\xFCk {{authorName}}. K\xF6nyvt\xE1radat elk\xFCldt\xFCk fel\xFClvizsg\xE1latra. Nyomon k\xF6vetheted az \xE1llapotot<link>itt</link>",
	},
	p = {
		resetLibrary: "K\xF6nyvt\xE1r alaphelyzetbe \xE1ll\xEDt\xE1sa",
		removeItemsFromLib:
			"A kiv\xE1lasztott elemek elt\xE1vol\xEDt\xE1sa a k\xF6nyvt\xE1rb\xF3l",
	},
	u = {
	...
	j = {
		tooltip:
			"A rajzaidat v\xE9gpontok k\xF6z\xF6tti titkos\xEDt\xE1ssal t\xE1roljuk, teh\xE1t az Excalidraw szervereir\u0151l se tud m\xE1s belen\xE9zni.",
...
({{exportColorScheme}})`,
	...
	w = {
		action: {
			...
			excalidrawPlus: { title: "Excalidraw+", button: "", description: "" },
		},
		modal: {
			loadFromFile: {
