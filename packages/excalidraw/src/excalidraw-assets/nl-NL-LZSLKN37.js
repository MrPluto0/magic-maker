...
var t = {
		...
		lineEditor: { edit: "Bewerk regel", exit: "Verlaat regel-editor" },
		elementLock: {
			lock: "Vergrendel",
			unlock: "Ontgrendel",
	...
	i = {
		...
		hint_emptyLibrary:
			"Selecteer een item op het canvas om het hier toe te voegen of installeer een bibliotheek uit de openbare repository, hieronder.",
		hint_emptyPrivateLibrary:
			"Selecteer een item op het canvas om het hier toe te voegen.",
	},
	a = {
	...
	o = {
		...
		couldNotCreateShareableLinkTooBig:
			"Kan geen deelbare link aanmaken: de sc\xE8ne is te groot",
		...
		uploadedSecurly:
			"De upload is beveiligd met end-to-end encryptie, wat betekent dat de Excalidraw server en derden de inhoud niet kunnen lezen.",
		loadSceneOverridePrompt:
			"Het inladen van een externe tekening zal je bestaande inhoud vervangen. Wil je verdergaan?",
...
(Als je de lokale tekening wilt behouden, sluit je in plaats daarvan het browsertabblad)`,
		...
		confirmAddLibrary:
			"Dit zal {{numShapes}} vorm(en) toevoegen aan je bibliotheek. Weet je het zeker?",
		imageDoesNotContainScene:
			"Deze afbeelding lijkt geen sc\xE8ne gegevens te bevatten. Heb je sc\xE8ne embedding tijdens het exporteren ingeschakeld?",
		cannotRestoreFromImage:
			"Sc\xE8ne kan niet worden hersteld vanuit dit afbeeldingsbestand",
		invalidSceneUrl:
			"Kan sc\xE8ne niet importeren vanuit de opgegeven URL. Het is onjuist of bevat geen geldige Excalidraw JSON-gegevens.",
		...
		invalidEncryptionKey:
			"Encryptiesleutel moet 22 tekens zijn. Live samenwerking is uitgeschakeld.",
...
Je wijzigingen worden niet opgeslagen!`,
	...
	r = {
		...
		imageInsertError:
			"Afbeelding invoegen mislukt. Probeer het later opnieuw...",
		fileTooBig: "Bestand is te groot. Maximale grootte is {{maxSize}}.",
		svgImageInsertError:
			"Kon geen SVG-afbeelding invoegen. De SVG-opmaak ziet er niet geldig uit.",
		failedToFetchImage: "",
		invalidSVGString: "Ongeldige SVG.",
		cannotResolveCollabServer:
			"Kan geen verbinding maken met de collab server. Herlaad de pagina en probeer het opnieuw.",
		importLibraryError: "Kon bibliotheek niet laden",
		collabSaveFailed:
			"Kan niet opslaan in de backend database. Als de problemen blijven bestaan, moet u het bestand lokaal opslaan om ervoor te zorgen dat u uw werk niet verliest.",
		collabSaveFailed_sizeExceeded:
			"Kan de backend database niet opslaan, het canvas lijkt te groot te zijn. U moet het bestand lokaal opslaan om ervoor te zorgen dat u uw werk niet verliest.",
		imageToolNotSupported: "",
		brave_measure_text_error: { line1: "", line2: "", line3: "", line4: "" },
		libraryElementTypeError: {
			embeddable:
				"Ingesloten elementen kunnen niet worden toegevoegd aan de bibliotheek.",
			iframe: "",
			image:
				"Ondersteuning voor het toevoegen van afbeeldingen aan de bibliotheek komt binnenkort!",
		},
	...
	d = {
		canvasPanning:
			"Om de canvas te verplaatsen, houd muiswiel of spatiebalk ingedrukt tijdens slepen, of gebruik het handgereedschap",
		linearElement:
			"Klik om meerdere punten te starten, sleep voor \xE9\xE9n lijn",
		...
		text_editing:
			"Druk op Escape of CtrlOrCmd+ENTER om het bewerken te voltooien",
		linearElementMulti:
			"Klik op het laatste punt of druk op Escape of Enter om te stoppen",
...
gebruik ALT om vanuit het midden te vergroten/verkleinen`,
		resizeImage: "",
		rotate:
			"Je kan hoeken beperken door SHIFT ingedrukt te houden wanneer je draait",
		lineEditor_info:
			"Houd CtrlOrCmd en Dubbelklik of druk op CtrlOrCmd + Enter om punten te bewerken",
	...
	c = {
		headingMain:
			"Fout opgetreden. Probeer <button>de pagina opnieuw laden.</button>",
		clearCanvasMessage:
			"Als herladen niet werkt, probeer <button>het canvas te wissen.</button>",
		...
		openIssueMessage:
			"We waren voorzichtig om je sc\xE8ne-informatie niet in de fout toe te voegen. Als je sc\xE8ne niet priv\xE9 is, overweeg dan alstublieft het opvolgen op onze <button>bugtracker.</button> Kopieer de informatie hieronder naar de GitHub issue.",
		sceneContent: "Sc\xE8ne-inhoud:",
	},
	k = {
		desc_intro: "Je kunt mensen uitnodigen om met je samen te werken.",
		desc_privacy:
			"Geen zorgen, de sessie gebruikt end-to-end encryptie, dus wat je tekent blijft priv\xE9. Zelfs onze server zal niet kunnen zien wat je tekent.",
...
Pas op: dit heeft geen invloed op andere mensen en dat zij nog steeds in staat zullen zijn om samen te werken aan hun versie.`,
	...
	m = {
		...
		disk_details:
			"De sc\xE8negegevens exporteren naar een bestand waaruit u later kunt importeren.",
		...
		excalidrawplus_description:
			"Sla de sc\xE8ne op in je Excalidraw+ werkruimte.",
		excalidrawplus_button: "Exporteer",
		excalidrawplus_exportError:
			"Kan op dit moment niet exporteren naar Excalidraw+...",
	},
	p = {
		blog: "Lees onze blog",
		click: "klik",
	...
	h = {
		...
		placeholder: {
			...
			libraryDesc:
				"Beschrijving van je bibliotheek om mensen te helpen het gebruik ervan te begrijpen",
			githubHandle: "",
			twitterHandle: "",
			website: "Link naar je persoonlijke website of elders (optioneel)",
		},
		errors: { required: "Vereist", website: "Vul een geldige URL in" },
	...
	v = { title: "Bibliotheek ingediend", content: "<link>Hier</link>" },
	w = {
	...
	y = {
		tooltip:
			"Je tekeningen zijn beveiligd met end-to-end encryptie, dus Excalidraw's servers zullen nooit zien wat je tekent.",
...
of plak in een bestaande teksteditor`,
		unableToEmbed:
			"Het insluiten van deze url is momenteel niet toegestaan. Zet een probleem op GitHub om de URL op de whitelist te zetten",
		unrecognizedLinkFormat:
			"De link die u hebt ingesloten komt niet overeen met het verwachte formaat. Probeer de 'embed' string van de bronsite te plakken",
	},
	T = {
