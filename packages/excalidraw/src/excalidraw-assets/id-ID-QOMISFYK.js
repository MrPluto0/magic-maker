...
var n = {
		...
		lineEditor: { edit: "Edit tautan", exit: "Keluar editor garis" },
		elementLock: {
			lock: "Kunci",
			unlock: "Lepas",
			lockAll: "Kunci semua",
	...
	i = {
		...
		hint_emptyLibrary:
			"Pilih item pada kanvas untuk menambahkan nya di sini, atau pasang pustaka dari gudang di bawah ini.",
		hint_emptyPrivateLibrary:
			"Pilih item pada kanvas untuk menambahkan nya di sini.",
	},
	t = {
	...
	r = {
		clearReset:
			"Ini akan menghapus semua yang ada dikanvas. Apakah kamu yakin ?",
		couldNotCreateShareableLink:
			"Tidak bisa membuat tautan yang bisa dibagikan",
		couldNotCreateShareableLinkTooBig:
			"Tidak dapat membuat tautan yang dapat dibagikan: pemandangan terlalu besar",
		...
		uploadedSecurly:
			"Pengunggahan ini telah diamankan menggunakan enkripsi end-to-end, artinya server Excalidraw dan pihak ketiga tidak data membaca nya",
		loadSceneOverridePrompt:
			"Memuat gambar external akan mengganti konten Anda yang ada. Apakah Anda ingin melanjutkan?",
...
(Jika Anda ingin menyimpan gambar lokal Anda, gantinya cukup tutup tab browser.)`,
		...
		confirmAddLibrary:
			"Ini akan menambahkan {{numShapes}} bentuk ke pustaka Anda. Anda yakin?",
		imageDoesNotContainScene:
			"Gambar ini sepertinya tidak terdapat data pemandangan. Sudahkah Anda mengaktifkan penyematan pemandangan ketika ekspor?",
		cannotRestoreFromImage:
			"Pemandangan tidak dapat dipulihkan dari file gambar ini",
		invalidSceneUrl:
			"Tidak dapat impor pemandangan dari URL. Kemungkinan URL itu rusak atau tidak berisi data JSON Excalidraw yang valid.",
		resetLibrary: "Ini akan menghapus pustaka Anda. Anda yakin?",
		removeItemsFromsLibrary: "Hapus {{count}} item dari pustaka?",
		invalidEncryptionKey:
			"Sandi enkripsi harus 22 karakter. Kolaborasi langsung dinonaktifkan.",
...
Perubahan tidak akan disimpan!`,
	...
	l = {
		...
		fileTooBig:
			"File terlalu besar. Ukuran maksimum yang dibolehkan {{maxSize}}.",
		svgImageInsertError:
			"Tidak dapat menyisipkan gambar SVG. Markup SVG sepertinya tidak valid.",
		failedToFetchImage: "",
		invalidSVGString: "SVG tidak valid.",
		cannotResolveCollabServer:
			"Tidak dapat terhubung ke server kolab. Muat ulang laman dan coba lagi.",
		importLibraryError: "Tidak dapat memuat pustaka",
		collabSaveFailed:
			"Tidak dapat menyimpan ke dalam basis data server. Jika masih berlanjut, Anda sebaiknya simpan berkas Anda secara lokal untuk memastikan pekerjaan Anda tidak hilang.",
		collabSaveFailed_sizeExceeded:
			"Tidak dapat menyimpan ke dalam basis data server, tampaknya ukuran kanvas terlalu besar. Anda sebaiknya simpan berkas Anda secara lokal untuk memastikan pekerjaan Anda tidak hilang.",
		imageToolNotSupported: "",
		brave_measure_text_error: {
			line1:
				"Sepertinya Anda menggunkan peramban Brave dengan pengaturan <bold>Blokir Fingerprinting yang Agresif</bold> diaktifkan.",
			line2: "Ini dapat membuat <bold>Elemen Teks</bold> dalam gambar mu.",
			line3:
				"Kami sangat menyarankan mematikan pengaturan ini. Anda dapat mengikuti <link>langkah-langkah ini</link> untuk melakukannya.",
...
<issueLink>isu</issueLink> di GitHub kami, atau chat kami di <discordLink>Discord</discordLink>`,
	...
	k = {
		canvasPanning:
			"Untuk memindahkan kanvas, tekan roda mouse atau spacebar sambil menyeret, atau menggunakan alat tangan",
		...
		linearElementMulti:
			"Klik pada titik akhir atau tekan Escape atau Enter untuk menyelesaikan",
...
Tekan ALT untuk mengubah dari tengah`,
		...
		lineEditor_info:
			"Tekan Ctrl/Cmd dan Dobel-klik atau tekan Ctrl/Cmd +Enter untuk mengedit poin",
		lineEditor_pointSelected:
			"Tekan Delete untuk menghapus titik, Ctrl/Cmd + D untuk menduplikasi, atau seret untuk memindahkan",
		lineEditor_nothingSelected:
			"Pilih titik untuk mengedit (tekan SHIFT untuk pilih banyak), atau tekan Alt dan klik untuk tambahkan titik baru",
		placeImage:
			"Klik untuk tempatkan gambar, atau klik dan jatuhkan untuk tetapkan ukuran secara manual",
		publishLibrary: "Terbitkan pustaka Anda",
		bindTextToElement: "Tekan enter untuk tambahkan teks",
		deepBoxSelect:
			"Tekan Ctrl atau Cmd untuk memilih yang di dalam, dan mencegah penggeseran",
		eraserRevert:
			"Tahan Alt untuk mengembalikan elemen yang ditandai untuk dihapus",
	...
	u = {
		headingMain:
			"Mengalami sebuah kesalahan. Cobalah <button>muat ulang halaman.</button>",
		clearCanvasMessage:
			"Jika memuat ulang tidak bekerja, cobalah <button>bersihkan canvas.</button>",
		clearCanvasCaveat: " Ini akan menghasilkan hilangnya pekerjaan ",
		trackedToSentry:
			"Kesalahan dengan pengidentifikasi {{eventId}} dilacak di sistem kami.",
		openIssueMessage:
			"Kami sangat berhati-hati untuk tidak menyertakan informasi pemandangan Anda pada kesalahan. Jika pemandangan Anda tidak bersifat pribadi, mohon pertimbangkan menindak lanjut pada <button>pelacak bug.</button> Mohon sertakan informasi dibawah ini dengan menyalin dan menempelkan di Github issue.",
		sceneContent: "Pemandangan konten:",
	},
	m = {
		desc_intro:
			"Anda dapat mengundang orang ke pemandangan Anda saat ini untuk berkolaborasi dengan Anda.",
		desc_privacy:
			"Jangan khawatir, sesi menggunakan enkripsi end-to-end, sehingga apa pun yang Anda gambar akan tetap bersifat pribadi. Bahkan server kami tidak dapat melihat apa yang Anda lakukan.",
		...
		desc_shareLink:
			"Bagikan tautan ini dengan siapa pun yang Anda inginkan untuk kolaborasi bersama:",
		desc_exitSession:
			"Menghentikan sesi akan memutuskan hubungan Anda dari ruangan, tetapi Anda dapat melanjutkan bekerja dengan pemandangan Anda secara lokal. Perhatikan bahwa ini tidak memengaruhi orang lain, dan mereka masih dapat berkolaborasi pada versi mereka.",
	...
	g = {
		...
		excalidrawplus_description:
			"Simpan pemandangan ke ruang kerja Excalidraw+ Anda.",
	...
	c = {
		...
		placeholder: {
			...
			libraryDesc:
				"Deskripsi pustaka Anda untuk membantu orang mengerti penggunaannya",
			githubHandle:
				"Akun GitHub (opsional), jadi Anda dapat mengubah pustaka ketika diserahkan untuk review",
			twitterHandle:
				"Nama pengguna Twitter (opsional), jadi kami tahu siapa dipuji ketika mempromosikannya melalui Twitter",
			website: "Hubungkan ke situs personal Anda atau lainnya (opsional)",
		},
		errors: { required: "Dibutuhkan", website: "Masukkan URL valid" },
		noteDescription:
			"Kirimkan pustaka Anda untuk disertakan di <link>repositori pustaka publik</link>untuk orang lain menggunakannya dalam gambar mereka.",
		noteGuidelines:
			"Pustaka butuh disetujui secara manual terlebih dahulu. Baca <link>pedoman</link> sebelum mengirim. Anda butuh akun GitHub untuk berkomunikasi dan membuat perubahan jika dibutuhkan, tetapi tidak wajib dibutukan.",
		noteLicense:
			"Dengan mengkirimkannya, Anda setuju pustaka akan diterbitkan dibawah <link>Lisensi MIT, </link>yang artinya siapa pun dapat menggunakannya tanpa batasan.",
		noteItems:
			"Setiap item pustaka harus memiliki nama, sehingga bisa disortir. Item pustaka di bawah ini akan dimasukan:",
		atleastOneLibItem: "Pilih setidaknya satu item pustaka untuk mulai",
		republishWarning:
			"Catatan: beberapa item yang dipilih telah ditandai sebagai sudah dipublikasikan/diserahkan. Anda hanya dapat menyerahkan kembali item-item ketika memperbarui pustaka atau pengumpulan.",
	},
	y = {
		title: "Pustaka telah dikirm",
		content:
			"Terima kasih {{authorName}}. pustaka Anda telah diserahkan untuk ditinjau ulang. Anda dapat cek statusnya<link>di sini</link>",
	},
	T = {
		resetLibrary: "Reset pustaka",
...
Akan membesarkan ukuran file yang diekspor.`,
	...
	A = {
		tooltip:
			"Gambar anda terenkripsi end-to-end sehingga server Excalidraw tidak akan pernah dapat melihatnya.",
...
atau tempelkan ke teks editor yang ada`,
	...
	x = {
		action: {
			exportToImage: {
				...
				description:
					"Ekspor data pemandangan sebagai gambar yang dapat anda impor nanti.",
			},
			saveToDisk: {
				title: "Simpan ke disk",
				button: "Simpan ke disk",
				description:
					"Ekspor data pemandangan ke file yang dapat Anda dapat impor nanti.",
			},
			excalidrawPlus: {
				title: "Excalidraw+",
		...
		modal: {
			loadFromFile: {
				...
				description:
					"Memuat dari file yang akan <bold>menggantikan konten Anda sekarang</bold>.<br></br>Anda dapat mencadangkan gambar anda dulu menggunakan opsi-opsi ini.",
			},
			shareableLink: {
	...
	L = { title: "", button: "", description: "", syntax: "", preview: "" },
	B = {
		labels: n,
		library: i,
		buttons: t,
