...
var o = {
		...
		lineEditor: { edit: "Editar linha", exit: "Sair do editor de linha" },
		elementLock: {
			lock: "Bloquear",
			unlock: "Desbloquear",
	...
	r = {
		...
		hint_emptyLibrary:
			"Selecione um item na tela para adicion\xE1-lo aqui, ou instale uma biblioteca do reposit\xF3rio p\xFAblico, abaixo.",
		hint_emptyPrivateLibrary:
			"Selecione um item na tela para adicion\xE1-lo aqui.",
	},
	i = {
	...
	t = {
		...
		couldNotCreateShareableLink:
			"N\xE3o foi poss\xEDvel criar um link de compartilhamento.",
		couldNotCreateShareableLinkTooBig:
			"N\xE3o foi poss\xEDvel criar um link compartilh\xE1vel: a cena \xE9 muito grande",
		couldNotLoadInvalidFile:
			"N\xE3o foi poss\xEDvel carregar o arquivo inv\xE1lido",
		importBackendFailed: "A importa\xE7\xE3o do servidor falhou.",
		cannotExportEmptyCanvas:
			"N\xE3o \xE9 poss\xEDvel exportar um canvas vazio.",
		couldNotCopyToClipboard:
			"N\xE3o foi poss\xEDvel copiar para a \xE1rea de transfer\xEAncia.",
		decryptFailed: "N\xE3o foi poss\xEDvel descriptografar os dados.",
		uploadedSecurly:
			"O upload foi protegido com criptografia de ponta a ponta, o que significa que o servidor do Excalidraw e terceiros n\xE3o podem ler o conte\xFAdo.",
		loadSceneOverridePrompt:
			"Carregar um desenho externo substituir\xE1 o seu conte\xFAdo existente. Deseja continuar?",
...
(Se voc\xEA deseja manter seu desenho local, simplesmente feche a aba do navegador.)`,
		errorAddingToLibrary:
			"N\xE3o foi poss\xEDvel adicionar o item \xE0 biblioteca",
		errorRemovingFromLibrary:
			"N\xE3o foi poss\xEDvel remover o item da biblioteca",
		confirmAddLibrary:
			"Isso adicionar\xE1 {{numShapes}} forma(s) \xE0 sua biblioteca. Tem certeza?",
		imageDoesNotContainScene:
			"Esta imagem parece n\xE3o conter dados de cenas. Voc\xEA ativou a incorpora\xE7\xE3o da cena durante a exporta\xE7\xE3o?",
		cannotRestoreFromImage:
			"N\xE3o foi poss\xEDvel restaurar a cena deste arquivo de imagem",
		invalidSceneUrl:
			"N\xE3o foi poss\xEDvel importar a cena da URL fornecida. Ela est\xE1 incompleta ou n\xE3o cont\xE9m dados JSON v\xE1lidos do Excalidraw.",
		...
		invalidEncryptionKey:
			"A chave de encripta\xE7\xE3o deve ter 22 caracteres. A colabora\xE7\xE3o ao vivo est\xE1 desabilitada.",
...
Suas altera\xE7\xF5es n\xE3o ser\xE3o salvas!`,
	...
	n = {
		...
		imageInsertError:
			"N\xE3o foi poss\xEDvel inserir imagem. Tente novamente mais tarde...",
		fileTooBig:
			"O arquivo \xE9 muito grande. O tamanho m\xE1ximo permitido \xE9 {{maxSize}}.",
		svgImageInsertError:
			"N\xE3o foi poss\xEDvel inserir a imagem SVG. A marca\xE7\xE3o SVG parece inv\xE1lida.",
		failedToFetchImage: "",
		invalidSVGString: "SVG Inv\xE1lido.",
		cannotResolveCollabServer:
			"N\xE3o foi poss\xEDvel conectar-se ao servidor colaborativo. Por favor, recarregue a p\xE1gina e tente novamente.",
		importLibraryError: "N\xE3o foi poss\xEDvel carregar a biblioteca",
		collabSaveFailed:
			"N\xE3o foi poss\xEDvel salvar no banco de dados do servidor. Se os problemas persistirem, salve o arquivo localmente para garantir que n\xE3o perca o seu trabalho.",
		collabSaveFailed_sizeExceeded:
			"N\xE3o foi poss\xEDvel salvar no banco de dados do servidor, a tela parece ser muito grande. Se os problemas persistirem, salve o arquivo localmente para garantir que n\xE3o perca o seu trabalho.",
		imageToolNotSupported: "",
		brave_measure_text_error: {
			line1:
				"Parece que voc\xEA est\xE1 usando o navegador Brave com a configura\xE7\xE3o <bold>Bloquear Impress\xF5es Digitais</bold> no modo agressivo.",
			line2:
				"Isso pode acabar quebrando <bold>Elementos de Texto</bold> em seus desenhos.",
			line3:
				"Recomendamos fortemente desativar essa configura\xE7\xE3o. Voc\xEA pode acessar o <link>passo a passo</link> sobre como fazer isso.",
			line4:
				"Se desativar essa configura\xE7\xE3o n\xE3o corrigir a exibi\xE7\xE3o de elementos de texto, por favor abra uma <issueLink>issue</issueLink> em nosso GitHub, ou mande uma mensagem em nosso <discordLink>Discord</discordLink>",
		},
	...
	d = {
		canvasPanning:
			"Para mover a tela, segure a roda do mouse ou a barra de espa\xE7o enquanto arrasta ou use a ferramenta de m\xE3o",
		linearElement:
			"Clique para iniciar v\xE1rios pontos, arraste para uma \xFAnica linha",
		...
		text_editing:
			"Pressione Esc ou Ctrl/Cmd+ENTER para encerrar a edi\xE7\xE3o",
		linearElementMulti:
			"Clique no \xFAltimo ponto ou pressione Escape ou Enter para terminar",
...
segure ALT para redimensionar a partir do centro`,
		rotate:
			"Voc\xEA pode restringir os \xE2ngulos segurando SHIFT enquanto gira",
		lineEditor_info:
			"Pressione CtrlOuCmd e duplo-clique ou pressione CtrlOuCmd + Enter para editar pontos",
		lineEditor_pointSelected: `Pressione Delete para remover o(s) ponto(s),
Ctrl/Cmd+D para duplicar ou arraste para mover`,
		lineEditor_nothingSelected:
			"Selecione um ponto para editar (segure SHIFT para selecionar v\xE1rios) ou segure Alt e clique para adicionar novos pontos",
		placeImage:
			"Clique para colocar a imagem, ou clique e arraste para definir manualmente o seu tamanho",
		publishLibrary: "Publicar sua pr\xF3pria biblioteca",
		bindTextToElement: "Pressione Enter para adicionar o texto",
		deepBoxSelect:
			"Segure Ctrl/Cmd para sele\xE7\xE3o profunda e para evitar arrastar",
		eraserRevert:
			"Segure a tecla Alt para inverter os elementos marcados para exclus\xE3o",
		firefox_clipboard_write:
			'Esse recurso pode ser ativado configurando a op\xE7\xE3o "dom.events.asyncClipboard.clipboardItem" como "true". Para alterar os sinalizadores do navegador no Firefox, visite a p\xE1gina "about:config".',
		disableSnapping: "",
	},
	c = {
		cannotShowPreview:
			"N\xE3o \xE9 poss\xEDvel mostrar pr\xE9-visualiza\xE7\xE3o",
		canvasTooBig: "A tela pode ser muito grande.",
		canvasTooBigTip:
			"Dica: tente aproximar um pouco os elementos mais distantes.",
	},
	m = {
		headingMain:
			"Foi encontrado um erro. Tente <button>recarregar a p\xE1gina.</button>",
		clearCanvasMessage:
			"Se recarregar a p\xE1gina n\xE3o funcionar, tente <button>limpando a tela.</button>",
		clearCanvasCaveat: " Isso resultar\xE1 em perda de trabalho ",
		trackedToSentry:
			"O erro com o identificador {{eventId}} foi rastreado no nosso sistema.",
		openIssueMessage:
			"Fomos muito cautelosos para n\xE3o incluir suas informa\xE7\xF5es de cena no erro. Se sua cena n\xE3o for privada, por favor, considere seguir nosso <button>rastreador de bugs.</button> Por favor, inclua informa\xE7\xF5es abaixo, copiando e colando para a issue do GitHub.",
		sceneContent: "Conte\xFAdo da cena:",
	},
	u = {
		desc_intro:
			"Voc\xEA pode convidar pessoas para sua cena atual para colaborar com voc\xEA.",
		desc_privacy:
			"N\xE3o se preocupe, a sess\xE3o usa criptografia de ponta a ponta; portanto, o que voc\xEA desenhar permanecer\xE1 privado. Nem mesmo nosso servidor poder\xE1 ver o que voc\xEA cria.",
		button_startSession: "Iniciar sess\xE3o",
		button_stopSession: "Parar sess\xE3o",
		desc_inProgressIntro:
			"A sess\xE3o de colabora\xE7\xE3o ao vivo est\xE1 agora em andamento.",
		desc_shareLink:
			"Compartilhe este link com qualquer pessoa com quem voc\xEA queira colaborar:",
		desc_exitSession:
			"Interrompendo a sess\xE3o voc\xEA ir\xE1 se desconectar da sala, mas voc\xEA poder\xE1 continuar trabalhando com a cena localmente. Observe que isso n\xE3o afetar\xE1 outras pessoas, e elas ainda poder\xE3o colaborar em suas vers\xF5es.",
		shareTitle:
			"Participe de uma sess\xE3o ao vivo de colabora\xE7\xE3o no Excalidraw",
	},
	p = { title: "Erro" },
	b = {
		disk_title: "Salvar no computador",
		disk_details:
			"Exportar os dados da cena para um arquivo que voc\xEA poder\xE1 importar mais tarde.",
		...
		excalidrawplus_description:
			"Salvar a cena na sua \xE1rea de trabalho Excalidraw+.",
		excalidrawplus_button: "Exportar",
		excalidrawplus_exportError:
			"N\xE3o \xE9 poss\xEDvel exportar para o Excalidraw+ neste momento...",
	},
	v = {
		...
		deepBoxSelect:
			"Use a sele\xE7\xE3o profunda dentro da caixa para previnir arrastar",
	...
	h = {
		...
		placeholder: {
			...
			libraryDesc:
				"Descri\xE7\xE3o para ajudar as pessoas a entenderem o uso da sua da sua biblioteca",
			githubHandle:
				"Identificador do GitHub (opcional), para que voc\xEA possa editar a biblioteca depois de enviar para revis\xE3o",
			twitterHandle:
				"Nome de usu\xE1rio do Twitter (opcional), para que saibamos quem deve ser creditado se promovermos no Twitter",
		...
		noteDescription:
			"Envie sua biblioteca para ser inclu\xEDda no <link>reposit\xF3rio de biblioteca p\xFAblica</link>para outras pessoas usarem em seus desenhos.",
		noteGuidelines:
			"A biblioteca precisa ser aprovada manualmente primeiro. Por favor leia o <link>orienta\xE7\xF5es</link> antes de enviar. Voc\xEA precisar\xE1 de uma conta do GitHub para se comunicar e fazer altera\xE7\xF5es quando solicitado, mas n\xE3o \xE9 estritamente necess\xE1rio.",
		noteLicense:
			"Ao enviar, voc\xEA concorda que a biblioteca ser\xE1 publicada sob a <link>Licen\xE7a MIT, </link>o que, em suma, significa que qualquer pessoa pode utiliz\xE1-los sem restri\xE7\xF5es.",
		noteItems:
			"Cada item da biblioteca deve ter seu pr\xF3prio nome para que seja filtr\xE1vel. Os seguintes itens da biblioteca ser\xE3o inclu\xEDdos:",
		atleastOneLibItem:
			"Por favor, selecione pelo menos um item da biblioteca para come\xE7ar",
		republishWarning:
			"Nota: alguns dos itens selecionados est\xE3o marcados como j\xE1 publicado/enviado. Voc\xEA s\xF3 deve reenviar itens ao atualizar uma biblioteca existente ou submiss\xE3o.",
	},
	x = {
		title: "Biblioteca enviada",
		content:
			"Obrigado {{authorName}}. Sua biblioteca foi enviada para an\xE1lise. Voc\xEA pode acompanhar o status<link>aqui</link>",
	},
	f = {
		resetLibrary: "Redefinir biblioteca",
...
Isso aumentar\xE1 o tamanho do arquivo exportado.`,
	...
	E = {
		tooltip:
			"Seus desenhos s\xE3o criptografados de ponta a ponta, ent\xE3o os servidores do Excalidraw nunca os ver\xE3o.",
	...
	q = {
		...
		copyToClipboardAsPng:
			"{{exportSelection}} copiado para a \xE1rea de transfer\xEAncia como PNG ({{exportColorScheme}})",
...
ou cole em um editor de texto j\xE1 existente`,
	...
	k = {
		app: {
			center_heading:
				"Todos os dados s\xE3o salvos localmente no seu navegador.",
	...
	A = {
		...
		modal: {
			loadFromFile: {
				...
				description:
					"Carregar de um arquivo ir\xE1 <bold> substituir o conte\xFAdo existente</bold>.<br></br>Voc\xEA pode salvar seu desenho primeiro usando uma das op\xE7\xF5es abaixo.",
			},
			shareableLink: {
				title: "Carregar de um link",
				button: "Substituir meu conte\xFAdo",
				description:
					"Carregar um desenho externo ir\xE1 <bold> substituir seu conte\xFAdo existente</bold>.<br></br>Voc\xEA pode salvar seu desenho antes utilizando uma das op\xE7\xF5es abaixo.",
			},
		},
	},
	w = { title: "", button: "", description: "", syntax: "", preview: "" },
	N = {
		labels: o,
		library: r,
		buttons: i,
