import { a as N } from "./chunk-M2JW2GFW.js";
...
var rt = q,
	at = et,
	W = { assign: tt, pick: rt, pick_pica_resize_options: at };
function X(A) {
	var I = { exports: {} };
		...
		(function (d) {
			...
			return (function () {
				function d(h, x, g) {
					...
					for (var r = typeof H == "function" && H, t = 0; t < g.length; t++)
						c(g[t]);
					return c;
				}
				return d;
			})()(
				{
					1: [
						function (d, h, x) {
							...
							g(e, c),
								(e.prototype.resizeAndUnsharp = function (a, n) {
					...
					2: [
						function (d, h, x) {
							...
							h.exports = { convolveHorizontally: c, convolveVertically: r };
						},
						{},
					],
					3: [
					...
					5: [
						function (d, h, x) {
							var g = d("./resize_filter_gen"),
								c = d("./convolve").convolveHorizontally,
								r = d("./convolve").convolveVertically;
							function t(e, i, a) {
							...
							h.exports = function (i) {
								var a = i.src,
									...
									f = i.toWidth,
									u = i.toHeight,
									l = i.scaleX || i.toWidth / i.width,
									y = i.scaleY || i.toHeight / i.height,
									m = i.offsetX || 0,
									b = i.offsetY || 0,
									B = i.dest || new Uint8Array(f * u * 4),
									C = typeof i.quality > "u" ? 3 : i.quality,
									F = i.alpha || !1,
									O = g(C, n, f, l, m),
									E = g(C, s, u, y, b),
									k = new Uint8Array(f * s * 4);
								return (
									c(a, k, n, s, f, O), r(k, B, s, f, u, E), F || t(B, f, u), B
								);
							};
						},
						...
						function (d, h, x) {
							...
							h.exports = function (e, i, a, n, s) {
								var f = g[e].filter,
									...
									v,
									w = Math.floor((y + 1) * 2),
									U = new Int16Array((w + 2) * a),
									Q = 0,
									M = !U.subarray || !U.set;
								for (m = 0; m < a; m++) {
									for (
										b = (m + 0.5) * u + s,
											B = Math.max(0, Math.floor(b - y)),
											C = Math.min(i - 1, Math.ceil(b + y)),
											F = C - B + 1,
						...
						function (d, h, x) {
							h.exports = [
								...
								},
								{
									...
									filter: function (c) {
										if (c <= -1 || c >= 1) return 0;
										if (c > -11920929e-14 && c < 11920929e-14) return 1;
										var r = c * Math.PI;
						...
						function (d, h, x) {
							...
							h.exports = function (a) {
								var n = a.src,
									...
									u = a.toWidth,
									l = a.toHeight,
									y = a.scaleX || a.toWidth / a.width,
									m = a.scaleY || a.toHeight / a.height,
									b = a.offsetX || 0,
									B = a.offsetY || 0,
									C = a.dest || new Uint8Array(u * l * 4),
									F = typeof a.quality > "u" ? 3 : a.quality,
									O = a.alpha || !1,
									E = g(F, s, u, y, b),
									k = g(F, f, l, m, B),
									R = 0,
									D = this.__align(R + Math.max(n.byteLength, C.byteLength)),
									S = this.__align(D + f * u * 4),
									P = this.__align(S + E.byteLength),
									G = P + k.byteLength,
									o = this.__instance("resize", G),
									p = new Uint8Array(this.__memory.buffer),
									_ = new Uint32Array(this.__memory.buffer),
									v = new Uint32Array(n.buffer);
								_.set(v), e(E, p, S), e(k, p, P);
								var w = o.exports.convolveHV || o.exports._convolveHV;
								w(S, P, D, s, f, u, l);
								var U = new Uint32Array(C.buffer);
								return (
									U.set(new Uint32Array(this.__memory.buffer, 0, l * u)),
									O || c(C, u, l),
									C
								);
							};
					...
					10: [
						function (d, h, x) {
							...
							function c(r, t, e) {
								for (
									var i = t * e, a = new Uint16Array(i), n, s, f, u, l = 0;
									l < i;
									l++
								)
									(n = r[4 * l]),
									...
									for (
										...
										(f = b[E]),
											...
											Math.abs(y) >= F &&
												...
												(m = E * 4),
												(t[m] = (t[m] * l + 2048) >> 12),
												(t[m + 1] = (t[m + 1] * l + 2048) >> 12),
												(t[m + 2] = (t[m + 2] * l + 2048) >> 12));
								}
							};
						},
						{ "glur/mono16": 18 },
							...
							h.exports = function (c, r, t, e, i, a) {
								if (!(e === 0 || i < 0.5)) {
									...
									var n = r * t,
										...
										F = C + u,
										O = F + l,
										E = this.__instance("unsharp_mask", s + f + u * 2 + l + y, {
											exp: Math.exp,
										}),
										k = new Uint32Array(c.buffer),
										R = new Uint32Array(this.__memory.buffer);
									R.set(k);
									var D = E.exports.hsv_v16 || E.exports._hsv_v16;
									D(m, b, r, t),
										(D = E.exports.blurMono16 || E.exports._blurMono16),
										D(b, B, C, F, O, r, t, i),
										(D = E.exports.unsharp || E.exports._unsharp),
										D(m, m, b, B, r, t, e, a),
										k.set(new Uint32Array(this.__memory.buffer, 0, n));
								}
							};
						},
						{},
						...
						function (d, h, x) {
							...
							h.exports = function (r, t, e, i, a, n) {
								...
								for (var y = [], m = 0; m < l; m++) {
									var b = Math.round(
											Math.pow(
												Math.pow(r, l - m - 1) * Math.pow(e, m + 1),
												1 / l,
											),
										),
										B = Math.round(
											Math.pow(
												Math.pow(t, l - m - 1) * Math.pow(i, m + 1),
												1 / l,
											),
										);
									y.push([b, B]);
					...
					15: [
						function (d, h, x) {
							...
							h.exports = function (e) {
								var i = e.toWidth / e.width,
									a = e.toHeight / e.height,
									n = c(e.srcTileSize * i) - 2 * e.destTileBorder,
									s = c(e.srcTileSize * a) - 2 * e.destTileBorder;
								if (n < 1 || s < 1)
									throw new Error(
								...
								for (y = 0; y < e.toHeight; y += s)
									for (l = 0; l < e.toWidth; l += n)
										(f = l - e.destTileBorder),
											f < 0 && (f = 0),
											(m = l + n + e.destTileBorder - f),
											f + m >= e.toWidth && (m = e.toWidth - f),
											(u = y - e.destTileBorder),
											u < 0 && (u = 0),
											(b = y + s + e.destTileBorder - u),
											u + b >= e.toHeight && (b = e.toHeight - u),
											(C = {
												toX: f,
												toY: u,
												toWidth: m,
					...
					16: [
						function (d, h, x) {
							...
							(h.exports.isCanvas = function (r) {
								var t = g(r);
								return (
									t === "[object HTMLCanvasElement]" ||
									t === "[object OffscreenCanvas]" ||
									t === "[object Canvas]"
								);
							}),
								...
								(h.exports.worker_offscreen_canvas_support = function () {
									return new Promise(function (r, t) {
										...
										function e(n) {
											...
											Promise.resolve()
												.then(function () {
													var s = new OffscreenCanvas(10, 10),
														f = s.getContext("2d");
													return (
														f.rect(0, 0, 1, 1), createImageBitmap(s, 0, 0, 1, 1)
													);
												})
												.then(
													function () {
										...
										var i = btoa("(".concat(e.toString(), ")(self);")),
											a = new Worker("data:text/javascript;base64,".concat(i));
								...
								(h.exports.cib_can_use_region = function () {
									return new Promise(function (r) {
										...
										(t.src =
											...
											(t.onload = function () {
												createImageBitmap(t, 0, 0, t.width, t.height).then(
													function (e) {
							...
							h.exports = function () {
								...
								onmessage = function (t) {
									...
									if (!e.src && e.srcBitmap) {
										var a = new OffscreenCanvas(e.width, e.height),
											n = a.getContext("2d", { alpha: !!e.alpha });
										n.drawImage(e.srcBitmap, 0, 0),
											(e.src = n.getImageData(0, 0, e.width, e.height).data),
											(a.width = a.height = 0),
											(a = null),
											e.srcBitmap.close(),
											(e.srcBitmap = null),
									...
									if (i) {
										var f = new ImageData(
											...
											u = new OffscreenCanvas(e.toWidth, e.toHeight),
											l = u.getContext("2d", { alpha: !!e.alpha });
										l.putImageData(f, 0, 0),
											createImageBitmap(u).then(function (y) {
												postMessage({ bitmap: y }, [y]);
											});
									} else postMessage({ data: s }, [s.buffer]);
								};
							};
						},
						{ "./mathlib": 1 },
						...
						function (d, h, x) {
							...
							function s(l) {
								...
								return (
									...
									(a = (g + c) / (1 - e - i)),
									(n = (r + t) / (1 - e - i)),
									new Float32Array([g, c, r, t, e, i, a, n])
								);
							}
							function f(l, y, m, b, B, C) {
								var F, O, E, k, R, D, S, P, G, o, p, _, v, w;
								for (G = 0; G < C; G++) {
									for (
										D = G * B,
											S = G,
							...
							function u(l, y, m, b) {
								if (b) {
									var B = new Uint16Array(l.length),
										C = new Float32Array(Math.max(y, m)),
										F = s(b);
					...
					20: [
						function (d, h, x) {
							...
							(e.prototype.has_wasm = r),
								(e.prototype.use = function (i) {
									return (
										(this.__modules[i.name] = i),
										this.options.wasm && this.has_wasm() && i.wasm_fn
											? (this[i.name] = i.wasm_fn)
											: (this[i.name] = i.fn),
										this
									);
								}),
								(e.prototype.init = function () {
									...
									return (
										(this.__init_promise = Promise.all(
											Object.keys(i.__modules).map(function (a) {
												var n = i.__modules[a];
												return !i.options.wasm ||
													!i.has_wasm() ||
													!n.wasm_fn ||
													i.__wasm[a]
													? null
													: WebAssembly.compile(
															i.__base64decode(n.wasm_src),
														).then(function (s) {
															i.__wasm[a] = s;
														});
											}),
								...
								(e.prototype.__base64decode = c),
								(e.prototype.__reallocate = function (a) {
									if (!this.__memory)
										return (
									...
									return (
										n < a &&
											this.__memory.grow(Math.ceil((a - n) / (64 * 1024))),
										this.__memory
									);
								}),
								(e.prototype.__instance = function (a, n, s) {
									if ((n && this.__reallocate(n), !this.__wasm[a])) {
										...
										this.__wasm[a] = new WebAssembly.Module(
											this.__base64decode(f.wasm_src),
										);
									}
									if (!this.__cache[a]) {
										var u = {
					...
					22: [
						function (d, h, x) {
							var g;
							h.exports = function () {
								if (typeof g < "u" || ((g = !1), typeof WebAssembly > "u"))
									return g;
								try {
									var r = new Uint8Array([
										...
										t = new WebAssembly.Module(r),
										e = new WebAssembly.Instance(t, {});
							...
							h.exports = e()
								...
								: function (i, a) {
										for (var n, s = t(i), f, u = 1; u < arguments.length; u++) {
											...
											for (var l in n) c.call(n, l) && (s[l] = n[l]);
											if (g) {
												f = g(n);
					...
					24: [
						function (d, h, x) {
							...
							h.exports = function (e, i) {
								for (
									var a, n = Object.keys(r), s = 0, f = n.length;
									s < f;
									s++
								) {
									var u = n[s],
								...
								var m = Math.floor(Math.pow(16, 8) * Math.random()).toString(
										16,
									),
									b = {};
								(b[a] = a),
								...
								var F =
									...
									O =
										...
										window.mozURL ||
										window.msURL,
									E = new Blob([F], { type: "text/javascript" });
								if (i && i.bare) return E;
								var k = O.createObjectURL(E),
									R = new Worker(k);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
							...
							function t(o, p) {
								...
								for (var _ = 0, v = new Array(p); _ < p; _++) v[_] = o[_];
								return v;
							}
							function e(o, p) {
								var _ =
							...
							try {
								typeof navigator < "u" &&
									navigator.userAgent &&
									(B = navigator.userAgent.indexOf("Safari") >= 0);
							} catch {}
							var C = 1;
							typeof navigator < "u" &&
								(C = Math.min(navigator.hardwareConcurrency || 1, 4));
							var F = {
									tile: 1024,
									concurrency: C,
									features: ["js", "wasm", "ww"],
									...
									destroy: function () {
										if ((this.value.terminate(), typeof window < "u")) {
											...
											p &&
												...
												p.revokeObjectURL(this.value.objectURL);
										}
									},
								};
							}
							...
							(G.prototype.init = function () {
								...
								if (
									(p.indexOf("all") >= 0 && (p = ["cib", "wasm", "js", "ww"]),
									(this.__requested_features = p),
									(this.__mathlib = new s(p)),
									p.indexOf("ww") >= 0 &&
										typeof window < "u" &&
										"Worker" in window)
								)
									try {
										...
										b[v]
											? (this.__workersPool = b[v])
											: ((this.__workersPool = new f(P, this.options.idle)),
												(b[v] = this.__workersPool));
									} catch {}
								var w = this.__mathlib.init().then(function (j) {
										a(o.features, j.features);
									}),
									U;
								k
									? (U = u
											...
											.then(function (j) {
												...
												p.indexOf("cib") >= 0 && (o.features.cib = j);
											}))
									: (U = Promise.resolve(!1)),
									(R = u.can_use_canvas(this.options.createCanvas));
								var Q;
								k && E && p.indexOf("ww") !== -1
									? (Q = u.worker_offscreen_canvas_support())
									: (Q = Promise.resolve(!1)),
									(Q = Q.then(function (j) {
										D = j;
									}));
								var M = u.cib_can_use_region().then(function (j) {
									S = j;
								});
								return (
									(this.__initPromise = Promise.all([w, U, Q, M]).then(
										function () {
											return o;
										},
									)),
								...
								(G.prototype.__invokeResize = function (o, p) {
									var _ = this;
									return (
										(p.__mathCache = p.__mathCache || {}),
										Promise.resolve().then(function () {
											return _.features.ww
												? new Promise(function (v, w) {
														var U = _.__workersPool.acquire();
														p.cancelToken &&
															p.cancelToken.catch(function (M) {
																return w(M);
															}),
															(U.value.onmessage = function (M) {
																U.release(),
																	M.data.err ? w(M.data.err) : v(M.data);
															});
														var Q = [];
														o.src && Q.push(o.src.buffer),
															o.srcBitmap && Q.push(o.srcBitmap),
															U.value.postMessage(
																{
																	opts: o,
																	features: _.__requested_features,
																	preload: { wasm_nodule: _.__mathlib.__ },
																},
																Q,
															);
													})
												: {
														data: _.__mathlib.resizeAndUnsharp(
															o,
															p.__mathCache,
														),
													};
								...
								(G.prototype.__extractTileData = function (o, p, _, v, w) {
									if (this.features.ww && D && (u.isCanvas(p) || S))
										return (
									...
									if (u.isCanvas(p))
										return (
											v.srcCtx ||
												(v.srcCtx = p.getContext("2d", { alpha: !!_.alpha })),
											this.debug("Get tile pixel data"),
											(w.src = v.srcCtx.getImageData(
												o.x,
												o.y,
												o.width,
												o.height,
									...
									var U = this.options.createCanvas(o.width, o.height),
										Q = U.getContext("2d", { alpha: !!_.alpha });
									return (
										...
										this.debug("Get tile pixel data"),
										(w.src = Q.getImageData(0, 0, o.width, o.height).data),
										(U.width = U.height = 0),
										w
									);
								}),
								(G.prototype.__landTileData = function (o, p, _) {
									...
									if (E)
										...
										((v = _.toCtx.createImageData(o.toWidth, o.toHeight)),
										v.data.set)
									)
										v.data.set(p.data);
									else
								...
								(G.prototype.__tileAndResize = function (o, p, _) {
									...
									return Promise.resolve()
										.then(function () {
											if (
												((w.toCtx = p.getContext("2d", { alpha: !!_.alpha })),
												u.isCanvas(o))
											)
												return null;
											if (u.isImageBitmap(o))
												return (
													(w.srcImageBitmap = o),
													(w.isImageBitmapReused = !0),
													null
												);
											if (u.isImage(o))
												return k
													? (v.debug("Decode image via createImageBitmap"),
														createImageBitmap(o)
															.then(function (Q) {
																w.srcImageBitmap = Q;
															})
										...
										.then(function () {
											...
											return (
												v.debug("Process tiles"),
												Promise.all(M).then(
													function () {
														return v.debug("Finished!"), j(w), p;
													},
													function (T) {
														throw (j(w), T);
													},
								...
								(G.prototype.__processStages = function (o, p, _, v) {
									...
									var z;
									return (
										T || (z = this.options.createCanvas(M, j)),
										this.__tileAndResize(p, T ? _ : z, v)
											.then(function () {
												return T
													? _
													: ((v.width = M),
														(v.height = j),
														w.__processStages(o, z, _, v));
											})
											.then(function ($) {
								...
								(G.prototype.__resizeViaCreateImageBitmap = function (o, p, _) {
									var v = this,
										w = p.getContext("2d", { alpha: !!_.alpha });
									return (
										...
										createImageBitmap(o, {
											...
											var Q = v.options.createCanvas(_.toWidth, _.toHeight),
												M = Q.getContext("2d", { alpha: !!_.alpha });
											M.drawImage(U, 0, 0), U.close();
											var j = M.getImageData(0, 0, _.toWidth, _.toHeight);
											return (
								...
								(G.prototype.resize = function (o, p, _) {
									...
									var w = a({}, O);
									if (
										(isNaN(_) ? _ && (w = a(w, _)) : (w = a(w, { quality: _ })),
										(w.toWidth = p.width),
										(w.toHeight = p.height),
										(w.width = o.naturalWidth || o.width),
										(w.height = o.naturalHeight || o.height),
									...
									w.unsharpRadius > 2 && (w.unsharpRadius = 2),
										(w.canceled = !1),
										w.cancelToken &&
											(w.cancelToken = w.cancelToken.then(
												function (Q) {
									...
									var U = 3;
									return (
										(w.__destTileBorder = Math.ceil(
											Math.max(U, (2.5 * w.unsharpRadius) | 0),
										)),
								...
								(G.prototype.toBlob = function (o, p, _) {
									return (
										...
										new Promise(function (v) {
											...
											if (o.convertToBlob) {
												v(o.convertToBlob({ type: p, quality: _ }));
												return;
											}
											for (
												var w = atob(o.toDataURL(p, _).split(",")[1]),
													U = w.length,
													Q = new Uint8Array(U),
													M = 0;
												M < U;
	...
	Y = X(function (A) {
		...
		function d(r) {
			for (var t = r.toString(16).toUpperCase(), e = 2 - t.length; e > 0; e--)
				t = "0" + t;
			return "0x" + t;
		}
		function h(r) {
		...
		(c.prototype.each = function (r) {
			...
			for (
				this.ifds_to_read = [{ id: 0, offset: t }];
			...
			(c.prototype.filter = function (r) {
				...
				(t.ifd0 = { id: 0, entries: [] }),
					this.each(function (n) {
						(r(n) === !1 && !n.is_subifd_link) ||
							(n.is_subifd_link && n.count !== 1 && n.format !== 4) ||
							(t["ifd" + n.ifd] ||
								(t["ifd" + n.ifd] = { id: n.ifd, entries: [] }),
				...
				Object.keys(t).forEach(function (n) {
					(e += 2),
						t[n].entries.forEach(function (s) {
							e +=
								12 + (s.data_length > 4 ? Math.ceil(s.data_length / 2) * 2 : 0);
						}),
						(e += 4);
				}),
					(this.output = new Uint8Array(e)),
				...
				if (
					...
					Object.keys(t).forEach(function (n) {
						...
						var s = i,
							f = s + 2 + t[n].entries.length * 12 + 4;
						(i = f),
							a.write_uint16(s, t[n].entries.length),
							t[n].entries
								.sort(function (l, y) {
									return l.tag - y.tag;
								})
								.forEach(function (l, y) {
									var m = s + 2 + y * 12;
									a.write_uint16(m, l.tag),
										a.write_uint16(m + 2, l.format),
										a.write_uint32(m + 4, l.count),
										l.is_subifd_link
											? t["ifd" + l.tag] &&
												(t["ifd" + l.tag].link_offset = m + 8)
											: l.data_length <= 4
												? a.output.set(
														a.input.subarray(
															l.data_offset - a.start,
															l.data_offset - a.start + 4,
														),
														m + 8,
													)
												: (a.write_uint32(m + 8, i),
													a.output.set(
														a.input.subarray(
															l.data_offset - a.start,
															l.data_offset - a.start + l.data_length,
														),
														i,
													),
					...
					Object.keys(t).forEach(function (n) {
						t[n].written_offset &&
							t[n].link_offset &&
							a.write_uint32(t[n].link_offset, t[n].written_offset);
					}),
					this.output.length !== i)
				)
					throw I("internal error: incorrect buffer size allocated");
				return this.output;
			}),
			...
			(c.prototype.read_uint32 = function (r) {
				...
				return this.big_endian
					? t[r] * 16777216 + t[r + 1] * 65536 + t[r + 2] * 256 + t[r + 3]
					: t[r] + t[r + 1] * 256 + t[r + 2] * 65536 + t[r + 3] * 16777216;
			}),
			(c.prototype.write_uint16 = function (r, t) {
				var e = this.output;
				this.big_endian
					? ((e[r] = (t >>> 8) & 255), (e[r + 1] = t & 255))
			...
			(c.prototype.scan_ifd = function (r, t, e) {
				...
				t += 2;
				for (var a = 0; a < i; a++) {
					var n = this.read_uint16(t),
						s = this.read_uint16(t + 2),
						f = this.read_uint32(t + 4),
						u = this.exif_format_length(s),
						l = f * u,
						y = l <= 4 ? t + 8 : this.read_uint32(t + 8),
						m = !1;
					if (y + l > this.input.length) throw I("unexpected EOF", "EBADDATA");
					...
					this.is_subifd_link(r, n) &&
						Array.isArray(b) &&
						Number.isInteger(b[0]) &&
						b[0] > 0 &&
						(this.ifds_to_read.push({ id: n, offset: b[0] }), (m = !0));
					var O = {
				...
				r === 0 &&
					this.ifds_to_read.push({ id: 1, offset: this.read_uint32(t) });
			}),
			...
			(A.exports.jpeg_segments_each = function (r, t) {
				...
				if (!A.exports.is_jpeg(r)) throw I("Unknown file format", "ENOTJPEG");
				for (var e = 0, i = r.length, a = !1; ; ) {
					var n, s;
					if (e + 1 >= i) throw I("Unexpected EOF", "EBADDATA");
					var f = r[e],
						u = r[e + 1];
					if (f === 255 && u === 255) (n = 255), (s = 1);
					else if (f === 255 && u !== 0) {
						if (((n = u), (s = 2), !((208 <= n && n <= 217) || n === 1))) {
							if (e + 3 >= i) throw I("Unexpected EOF", "EBADDATA");
							if (((s += r[e + 2] * 256 + r[e + 3]), s < 2))
								throw I("Invalid segment length", "EBADDATA");
			...
			(A.exports.jpeg_segments_filter = function (r, t) {
				...
				A.exports.jpeg_segments_each(r, function (s) {
					var f = t(s);
					if (g(f)) e.push({ data: f }), (i += f.length);
						...
						e.length > 0 && e[e.length - 1].end === u.start
							? (e[e.length - 1].end = u.end)
							: e.push(u),
							(i += s.length);
					}
				});
			...
			(A.exports.jpeg_exif_tags_filter = function (r, t) {
				...
				return A.exports.jpeg_segments_filter(r, function (i) {
					if (
						...
						return (
							n.set(r.slice(i.offset, i.offset + 10)),
							(n[2] = ((a.length + 8) >>> 8) & 255),
							(n[3] = (a.length + 8) & 255),
							(e = !0),
							[n, a]
						);
			...
			(A.exports.jpeg_add_comment = function (r, t) {
				...
				return A.exports.jpeg_segments_filter(r, function (a) {
					if (
						(i++,
						!(i === 1 && a.code === 216) && !(i === 2 && a.code === 224) && !e)
					) {
						t = h(t);
						var n = new Uint8Array(5 + t.length),
							s = 0;
						return (
							(n[s++] = 255),
							(n[s++] = 254),
							(n[s++] = ((t.length + 3) >>> 8) & 255),
							(n[s++] = (t.length + 3) & 255),
							t.split("").forEach(function (f) {
								n[s++] = f.charCodeAt(0) & 255;
							}),
							(n[s++] = 0),
							(e = !0),
							[n, r.subarray(a.offset, a.offset + a.length)]
						);
					}
				});
			});
...
function K(A) {
	return this._getUint8Array(A.blob).then(function (I) {
		...
		try {
			var d, h;
			if (
				(Y.jpeg_exif_tags_each(I, function (g) {
					if (g.ifd === 0 && g.tag === 274 && Array.isArray(g.value))
						return (
							(A.orientation = g.value[0] || 1),
							(d = g.is_big_endian),
							(h = g.data_offset),
							!1
						);
				...
				A.blob = new Blob([I.slice(0, h), x, I.slice(h + 2)], {
					type: "image/jpeg",
				});
			}
		} catch {}
...
function V(A) {
	...
	var d;
	I & 4
		? (d = this.pica.options.createCanvas(
				A.out_canvas.height,
				A.out_canvas.width,
			))
		: (d = this.pica.options.createCanvas(
	...
	return (
		h.save(),
		I & 1 && h.transform(-1, 0, 0, 1, d.width, 0),
		I & 2 && h.transform(-1, 0, 0, -1, d.width, d.height),
		I & 4 && h.transform(0, 1, 1, 0, 0, 0),
		h.drawImage(A.out_canvas, 0, 0),
		h.restore(),
		(A.out_canvas.width = A.out_canvas.height = 0),
		(A.out_canvas = d),
		Promise.resolve(A)
	);
}
function J(A) {
	return A.is_jpeg
		? Promise.all([
				...
				var x = [];
				return (
					Y.jpeg_segments_each(d, function (g) {
					...
					(x = x
						.filter(function (g) {
							return g.code === 226
								? !1
								: (g.code >= 224 && g.code < 240) || g.code === 254;
						})
						.map(function (g) {
...
function it(A) {
	A.before("_blob_to_image", K),
		A.after("_transform", V),
		A.after("_create_blob", J);
}
var nt = K,
	ot = V,
	st = J,
	...
	ft = {
		jpeg_patch_exif: nt,
		jpeg_rotate_canvas: ot,
		jpeg_attach_orig_segments: st,
		assign: At,
	};
function L(A) {
...
L.prototype._blob_to_image = function (A) {
	...
	return (
		...
		(A.image_url = I.createObjectURL(A.blob)),
		(A.image.src = A.image_url),
...
L.prototype._calculate_size = function (A) {
	...
	return (
		I > 1 && (I = 1),
		(A.transform_width = Math.max(Math.round(A.image.width * I), 1)),
		(A.transform_height = Math.max(Math.round(A.image.height * I), 1)),
		(A.scale_factor = I),
		Promise.resolve(A)
	);
};
L.prototype._transform = function (A) {
	(A.out_canvas = this.pica.options.createCanvas(
		A.transform_width,
		A.transform_height,
	)),
		(A.transform_width = null),
		(A.transform_height = null);
	var I = { alpha: A.blob.type === "image/png" };
	return (
		this.utils.assign(I, this.utils.pick_pica_resize_options(A.opts)),
		this.pica.resize(A.image, A.out_canvas, I).then(function () {
			return A;
		})
	);
};
L.prototype._cleanup = function (A) {
	...
	var I = window.URL || window.webkitURL || window.mozURL || window.msURL;
	return (
		I.revokeObjectURL && I.revokeObjectURL(A.image_url),
		(A.image_url = null),
		Promise.resolve(A)
	);
};
	...
	return A.arrayBuffer
		...
		: new Promise(function (I, d) {
				...
				h.readAsArrayBuffer(A),
					...
					(h.onerror = function () {
						d(
							new Error("ImageBlobReduce: failed to load data from input blob"),
						),
							h.abort();
					}),
					(h.onabort = function () {
