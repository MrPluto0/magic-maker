...
var o = {
	...
	r = {
		...
		hint_emptyLibrary:
			"Seleccione un elemento no lenzo para engadilo aqu\xED, ou instale unha biblioteca dende o repositorio p\xFAblico, como se detalla a continuaci\xF3n.",
		hint_emptyPrivateLibrary:
			"Seleccione un elemento do lenzo para engadilo aqu\xED.",
	},
	i = {
	...
	n = {
		...
		couldNotCreateShareableLink:
			"Non se puido crear unha ligaz\xF3n para compartir.",
		couldNotCreateShareableLinkTooBig:
			"Non se puido crear a ligaz\xF3n para compartir: a escena \xE9 demasiado grande",
		...
		uploadedSecurly:
			"A carga foi asegurada con cifrado de extremo a extremo, o que significa que o servidor de Excalidraw e terceiros non poden ler o contido.",
		loadSceneOverridePrompt:
			"A carga dun debuxo externo substituir\xE1 o contido existente. Desexa continuar?",
...
(Se quere manter o seu debuxo local, simplemente peche a lapela do navegador.)`,
		...
		confirmAddLibrary:
			"Isto engadir\xE1 {{numShapes}} forma(s) a t\xFAa biblioteca. Est\xE1s seguro?",
		imageDoesNotContainScene:
			"Esta imaxe non parece conter ning\xFAn dato da escena. Activou a inserci\xF3n de escenas durante a exportaci\xF3n?",
		cannotRestoreFromImage:
			"Non se puido restaurar a escena dende este arquivo de imaxe",
		invalidSceneUrl:
			"Non se puido importar a escena dende a URL proporcionada. Ou ben est\xE1 malformada ou non cont\xE9n un JSON con informaci\xF3n v\xE1lida para Excalidraw.",
		...
		invalidEncryptionKey:
			"A clave de cifrado debe ter 22 caracteres. A colaboraci\xF3n en directo est\xE1 desactivada.",
...
Os teus cambios non ser\xE1n gardados!`,
	...
	t = {
		...
		imageInsertError:
			"Non se puido inserir a imaxe. Probe de novo m\xE1is tarde...",
		fileTooBig:
			"O ficheiro \xE9 demasiado grande. O tama\xF1o m\xE1ximo permitido \xE9 {{maxSize}}.",
		svgImageInsertError:
			"Non se puido inserir como imaxe SVG. O marcado SVG semella inv\xE1lido.",
		failedToFetchImage: "",
		invalidSVGString: "SVG inv\xE1lido.",
		cannotResolveCollabServer:
			"Non se puido conectar ao servidor de colaboraci\xF3n. Por favor recargue a p\xE1xina e probe de novo.",
		importLibraryError: "Non se puido cargar a biblioteca",
		collabSaveFailed:
			"Non se puido gardar na base de datos. Se o problema persiste, deber\xEDas gardar o teu arquivo de maneira local para asegurarte de non perdelo teu traballo.",
		collabSaveFailed_sizeExceeded:
			"Non se puido gardar na base de datos, o lenzo semella demasiado grande. Deber\xEDas gardar o teu arquivo de maneira local para asegurarte de non perdelo teu traballo.",
	...
	d = {
		canvasPanning:
			"Para mover o lenzo, mante\xF1a pulsada a roda do rato ou a barra de espazo mentres arrastra, ou utilice a ferramenta da man",
		linearElement:
			"Faga clic para iniciar varios puntos, arrastre para unha sola li\xF1a",
		...
		linearElementMulti:
			"Faga clic no \xFAltimo punto ou prema Escape ou Enter para rematar",
...
mante\xF1a ALT para axustalo dende o centro`,
		...
		lineEditor_info:
			"Mante\xF1a pulsado CtrlOrCmd e faga dobre clic ou prema CtrlOrCmd + Enter para editar puntos",
...
ou mante\xF1a pulsado Alt e faga clic para engadir novos puntos`,
		placeImage:
			"Faga clic para colocar a imaxe, ou faga clic e arrastre para establecer o seu tama\xF1o manualmente",
		publishLibrary: "Publica a t\xFAa propia biblioteca",
		bindTextToElement: "Prema a tecla enter para engadir texto",
		deepBoxSelect:
			"Mante\xF1a pulsado CtrlOrCmd para seleccionar en profundidade e evitar o arrastre",
		eraserRevert:
			"Mante\xF1a pulsado Alt para reverter os elementos marcados para a s\xFAa eliminaci\xF3n",
		firefox_clipboard_write:
			'Esta funci\xF3n p\xF3dese activar establecendo a opci\xF3n "dom.events.asyncClipboard.clipboardItem" a "true". Para cambiar as opci\xF3ns do navegador en Firefox, visita a p\xE1xina "about:config".',
		disableSnapping: "",
	},
	c = {
		...
		canvasTooBigTip:
			"Consello: Probe a acercar un pouco os elementos m\xE1is afastados.",
	},
	u = {
		headingMain:
			"Atopouse un erro. Probe <button>recargando a p\xE1xina.</button>",
		clearCanvasMessage:
			"Se recargar non funcionou, probe <button>limpando o lenzo.</button>",
		clearCanvasCaveat: " Isto resultar\xE1 nunha perda do seu traballo ",
		trackedToSentry:
			"O erro con identificador {{eventId}} foi rastrexado no noso sistema.",
		openIssueMessage:
			"Fomos moi cautelosos de non inclu\xEDr a informaci\xF3n da s\xFAa escena no erro. Se a s\xFAa escena non \xE9 privada, por favor, considere o seguimento do noso <button>rastrexador de erros.</button> Por favor incl\xFAa a seguinte informaci\xF3n copi\xE1ndoa e peg\xE1ndoa na issue de Github.",
		sceneContent: "Contido da escena:",
	},
	p = {
		desc_intro:
			"Podes invitar xente a colaborar contigo na t\xFAa escena actual.",
		desc_privacy:
			"Non te preocupes, a sesi\xF3n usa cifrado de punto a punto, polo que calquera cousa que debuxes mantense privada. Nin tan sequera o noso servidor ser\xE1 capaz de ver o que fas.",
		button_startSession: "Comezar sesi\xF3n",
		button_stopSession: "Rematar sesi\xF3n",
		desc_inProgressIntro:
			"A sesi\xF3n de colaboraci\xF3n en directo est\xE1 agora en progreso.",
		desc_shareLink:
			"Comparte esta ligaz\xF3n con calquera que queiras colaborar:",
		desc_exitSession:
			"Deter a sesi\xF3n desconectarao da sala, pero poder\xE1 seguir traballando coa escena de maneira local. Te\xF1a en conta que isto non afectar\xE1 a outras persoas, que poder\xE1n seguir colaborando na s\xFAa versi\xF3n.",
		shareTitle:
			"\xDAnase a unha sesi\xF3n de colaboraci\xF3n en directo en Excalidraw",
	},
	m = { title: "Erro" },
	b = {
		disk_title: "Gardar no disco",
		disk_details:
			"Exporte os datos da escena a un ficheiro que poder\xE1s importar m\xE1is tarde.",
		...
		excalidrawplus_description:
			"Garde a escena no seu espazo de traballo en Excalidraw+.",
		excalidrawplus_button: "Exportar",
		excalidrawplus_exportError:
			"Non se puido exportar a Excalidraw+ neste momento...",
	},
	g = {
		blog: "Le o noso blog",
		click: "clic",
		...
		deepBoxSelect:
			"Selecci\xF3n en profundidade dentro da caixa, evitando o arrastre",
	...
	v = {
		...
		placeholder: {
			...
			libraryDesc:
				"Descrici\xF3n da s\xFAa biblioteca para axudar a xente a entender o seu uso",
			githubHandle:
				"Nome de usuario de GitHub (opcional), as\xED poder\xE1s editar a biblioteca unha vez enviada para a s\xFAa revisi\xF3n",
			twitterHandle:
				"Nome de usuario en Twitter(opcional), as\xED sabemos a quen darlle cr\xE9dito cando se lle de promoci\xF3n a trav\xE9s de Twitter",
			website:
				"Ligaz\xF3n ao teu sitio web persoal ou a outro sitio (opcional)",
		},
		errors: {
		...
		noteDescription:
			"Env\xEDe a s\xFAa biblioteca para que sexa inclu\xEDda no <link>repositorio p\xFAblico de bibliotecas</link>para que outra xente a poida usar nos seus debuxos.",
		noteGuidelines:
			"A biblioteca necesita ser aprobada manualmente primeiro. Por favor, lea as <link>normas</link> antes de ser enviado. Necesitar\xE1s unha conta de GitHub para comunicarte ou facer cambios se se solicitan, pero non \xE9 estritamente necesario.",
		noteLicense:
			"Ao enviar, est\xE1s de acordo con que a biblioteca sexa publicada baixo a <link>Licenza MIT, </link>o cal significa que, en resumo, calquera pode usalo sen restrici\xF3ns.",
		noteItems:
			"Cada elemento da biblioteca debe ter o seu nome propio para que se poida filtrar. Os seguintes elementos da biblioteca ser\xE1n inclu\xEDdos:",
		atleastOneLibItem:
			"Por favor seleccione polo menos un elemento da biblioteca para comezar",
		republishWarning:
			"Nota: alg\xFAns dos elementos seleccionados est\xE1n marcados como xa publicados/enviados. S\xF3 deber\xEDas reenviar elementos cando se actualice unha biblioteca ou env\xEDo.",
	},
	h = {
		title: "Biblioteca enviada",
		content:
			"Grazas {{authorName}}. A s\xFAa biblioteca foi enviada para ser revisada. Pode seguir o estado<link>aqu\xED</link>",
	},
	E = {
	...
	S = {
		tooltip:
			"Os teus debuxos est\xE1n cifrados de punto a punto, polo que os servidores de Excalidraw nunca os ver\xE1n.",
...
ou pega nun editor de texto existente`,
	...
	T = {
		app: {
			center_heading:
				"Toda a informaci\xF3n \xE9 gardada de maneira local no seu navegador.",
