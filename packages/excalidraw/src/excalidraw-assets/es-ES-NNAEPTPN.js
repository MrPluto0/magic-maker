...
var o = {
	...
	r = {
		...
		hint_emptyLibrary:
			"Seleccione un elemento en el lienzo para a\xF1adirlo aqu\xED, o instale una biblioteca del repositorio p\xFAblico, a continuaci\xF3n.",
		hint_emptyPrivateLibrary:
			"Seleccione un elemento del lienzo para a\xF1adirlo aqu\xED.",
	},
	i = {
	...
	n = {
		...
		couldNotCreateShareableLinkTooBig:
			"No se pudo crear el enlace para compartir: la escena es demasiado grande",
		...
		uploadedSecurly:
			"La carga ha sido asegurada con cifrado de principio a fin, lo que significa que el servidor de Excalidraw y terceros no pueden leer el contenido.",
		loadSceneOverridePrompt:
			"Si carga este dibujo externo, reemplazar\xE1 el que tiene. \xBFDesea continuar?",
...
(Si desea mantener su dibujo local, simplemente cierre la pesta\xF1a del navegador.)`,
		...
		confirmAddLibrary:
			"Esto a\xF1adir\xE1 {{numShapes}} forma(s) a tu biblioteca. \xBFEst\xE1s seguro?",
		imageDoesNotContainScene:
			"Esta imagen no parece contener datos de escena. \xBFHa habilitado la inserci\xF3n de la escena durante la exportaci\xF3n?",
		cannotRestoreFromImage:
			"No se pudo restaurar la escena desde este archivo de imagen",
		invalidSceneUrl:
			"No se ha podido importar la escena desde la URL proporcionada. Est\xE1 mal formada, o no contiene datos de Excalidraw JSON v\xE1lidos.",
		resetLibrary: "Esto borrar\xE1 tu biblioteca. \xBFEst\xE1s seguro?",
		removeItemsFromsLibrary:
			"\xBFEliminar {{count}} elemento(s) de la biblioteca?",
		invalidEncryptionKey:
			"La clave de cifrado debe tener 22 caracteres. La colaboraci\xF3n en vivo est\xE1 deshabilitada.",
...
\xA1No se guardar\xE1n los cambios!`,
	...
	t = {
		...
		imageInsertError:
			"No se pudo insertar la imagen. Int\xE9ntelo de nuevo m\xE1s tarde...",
		fileTooBig:
			"Archivo demasiado grande. El tama\xF1o m\xE1ximo permitido es {{maxSize}}.",
		svgImageInsertError:
			"No se pudo insertar la imagen SVG. El c\xF3digo SVG parece inv\xE1lido.",
		failedToFetchImage: "Error al obtener la imagen.",
		invalidSVGString: "SVG no v\xE1lido.",
		cannotResolveCollabServer:
			"No se pudo conectar al servidor colaborador. Por favor, vuelva a cargar la p\xE1gina y vuelva a intentarlo.",
		importLibraryError: "No se pudo cargar la librer\xEDa",
		collabSaveFailed:
			"No se pudo guardar en la base de datos del backend. Si los problemas persisten, deber\xEDa guardar su archivo localmente para asegurarse de que no pierde su trabajo.",
		collabSaveFailed_sizeExceeded:
			"No se pudo guardar en la base de datos del backend, el lienzo parece ser demasiado grande. Deber\xEDa guardar el archivo localmente para asegurarse de que no pierde su trabajo.",
		imageToolNotSupported: "",
		brave_measure_text_error: {
			line1:
				"Parece que est\xE1s usando el navegador Brave con el ajuste <bold>Forzar el bloqueo de huellas digitales</bold> habilitado.",
			line2:
				"Esto podr\xEDa resultar en errores en los <bold>Elementos de Texto</bold> en tus dibujos.",
			line3:
				"Recomendamos fuertemente deshabilitar esta configuraci\xF3n. Puedes seguir <link>estos pasos</link> sobre c\xF3mo hacerlo.",
			line4: "",
		},
		...
		asyncPasteFailedOnRead:
			"No se pudo pegar (no se pudo leer desde el portapapeles del sistema).",
	...
	d = {
		canvasPanning:
			"Para mover el lienzo, mantenga la rueda del rat\xF3n o la barra espaciadora mientras arrastra o utilice la herramienta de mano",
		linearElement:
			"Haz clic para dibujar m\xFAltiples puntos, arrastrar para solo una l\xEDnea",
		...
		linearElementMulti:
			"Haz clic en el \xFAltimo punto o presiona Escape o Enter para finalizar",
		lockAngle:
			"Puedes restringir el \xE1ngulo manteniendo presionado el bot\xF3n SHIFT",
...
pulse ALT para redimensionar desde el centro`,
		rotate:
			"Puedes restringir los \xE1ngulos manteniendo presionado SHIFT mientras giras",
		lineEditor_info:
			"Mantenga pulsado CtrlOrCmd y haga doble click o presione CtrlOrCmd + Enter para editar puntos",
		lineEditor_pointSelected:
			"Presione Suprimir para eliminar el/los punto(s), CtrlOrCmd+D para duplicarlo, o arr\xE1strelo para moverlo",
...
o mantenga pulsado Alt y haga click para a\xF1adir nuevos puntos`,
		placeImage:
			"Haga clic para colocar la imagen o haga click y arrastre para establecer su tama\xF1o manualmente",
		publishLibrary: "Publica tu propia biblioteca",
		bindTextToElement: "Presione Entrar para agregar",
		deepBoxSelect:
			"Mant\xE9n CtrlOrCmd para seleccionar en profundidad, y para evitar arrastrar",
		eraserRevert:
			"Mantenga pulsado Alt para revertir los elementos marcados para su eliminaci\xF3n",
		firefox_clipboard_write:
			'Esta caracter\xEDstica puede ser habilitada estableciendo la bandera "dom.events.asyncClipboard.clipboardItem" a "true". Para cambiar las banderas del navegador en Firefox, visite la p\xE1gina "about:config".',
	...
	c = {
		...
		canvasTooBigTip:
			"Sugerencia: intenta acercar un poco m\xE1s los elementos m\xE1s lejanos.",
	},
	u = {
		headingMain:
			"Se encontr\xF3 un error. Intente <button>recargando la p\xE1gina.</button>",
		clearCanvasMessage:
			"Si la recarga no funciona, intente <button>limpiando el lienzo.</button>",
		clearCanvasCaveat: " Esto provocar\xE1 la p\xE9rdida de su trabajo ",
		trackedToSentry:
			"El error con el identificador {{eventId}} fue rastreado en nuestro sistema.",
		openIssueMessage:
			"Fuimos muy cautelosos de no incluir la informaci\xF3n de tu escena en el error. Si tu escena no es privada, por favor considera seguir nuestro <button>rastreador de errores.</button> Por favor, incluya la siguiente informaci\xF3n copi\xE1ndola y peg\xE1ndola en el issue de GitHub.",
		sceneContent: "Contenido de la escena:",
	},
	p = {
		desc_intro:
			"Puede invitar a otras personas a tu actual escena para que colaboren contigo.",
		desc_privacy:
			"No te preocupes, la sesi\xF3n usa encriptaci\xF3n de punta a punta, por lo que todo lo que se dibuje se mantendr\xE1 privadamente. Ni siquiera nuestro servidor podr\xE1 ver lo que haces.",
		button_startSession: "Iniciar sesi\xF3n",
		button_stopSession: "Detener sesi\xF3n",
		desc_inProgressIntro:
			"La sesi\xF3n de colaboraci\xF3n en vivo est\xE1 ahora en progreso.",
		desc_shareLink:
			"Comparte este enlace con cualquier persona con quien quieras colaborar:",
		desc_exitSession:
			"Detener la sesi\xF3n te desconectar\xE1 de la sala, pero podr\xE1s seguir trabajando con la escena en su computadora, esto es de modo local. Ten en cuenta que esto no afectar\xE1 a otras personas, y que las mismas seguir\xE1n siendo capaces de colaborar en tu escena.",
	...
	b = {
		...
		disk_details:
			"Exportar los datos de la escena a un archivo desde el cual pueda importar m\xE1s tarde.",
		...
		excalidrawplus_description:
			"Guarde la escena en su espacio de trabajo de Excalidraw+.",
		excalidrawplus_button: "Exportar",
		excalidrawplus_exportError:
			"No se pudo exportar a Excalidraw+ en este momento...",
	},
	g = {
		...
		deepBoxSelect:
			"Seleccione en profundidad dentro de la caja, y evite arrastrar",
	...
	h = {
		...
		placeholder: {
			...
			libraryDesc:
				"Descripci\xF3n de su biblioteca para ayudar a la gente a entender su uso",
			githubHandle:
				"Nombre de usuario de GitHub (opcional), as\xED podr\xE1 editar la biblioteca una vez enviada para su revisi\xF3n",
			twitterHandle:
				"Nombre de usuario de Twitter (opcional), as\xED sabemos a qui\xE9n acreditar cuando se promociona en Twitter",
			website:
				"Enlace a su sitio web personal o en cualquier otro lugar (opcional)",
		},
		errors: { required: "Requerido", website: "Introduce una URL v\xE1lida" },
		noteDescription:
			"Env\xEDa tu biblioteca para ser incluida en el <link>repositorio de librer\xEDa p\xFAblica</link>para que otras personas utilicen en sus dibujos.",
		noteGuidelines:
			"La biblioteca debe ser aprobada manualmente primero. Por favor, lea la <link>pautas</link> antes de enviar. Necesitar\xE1 una cuenta de GitHub para comunicarse y hacer cambios si se solicita, pero no es estrictamente necesario.",
		noteLicense:
			"Al enviar, usted acepta que la biblioteca se publicar\xE1 bajo el <link>Licencia MIT </link>que en breve significa que cualquiera puede utilizarlos sin restricciones.",
		noteItems:
			"Cada elemento de la biblioteca debe tener su propio nombre para que sea filtrable. Los siguientes elementos de la biblioteca ser\xE1n incluidos:",
		atleastOneLibItem:
			"Por favor, seleccione al menos un elemento de la biblioteca para empezar",
		republishWarning:
			"Nota: algunos de los elementos seleccionados est\xE1n marcados como ya publicados/enviados. S\xF3lo deber\xEDa volver a enviar elementos cuando se actualice una biblioteca o env\xEDo.",
	},
	E = {
		title: "Biblioteca enviada",
		content:
			"Gracias {{authorName}}. Su biblioteca ha sido enviada para ser revisada. Puede seguir el estado<link>aqu\xED</link>",
	},
	S = {
		resetLibrary: "Reiniciar biblioteca",
	...
	y = {
		tooltip:
			"Tus dibujos est\xE1n cifrados de punto a punto, por lo que los servidores de Excalidraw nunca los ver\xE1n.",
...
o pegar en un editor de texto existente`,
	...
	k = {
		app: {
			center_heading:
				"Toda su informaci\xF3n es guardada localmente en su navegador.",
	...
	z = {
		action: {
			...
			saveToDisk: {
				...
				description:
					"Exporta los datos de la escena a un archivo desde el cual podr\xE1s importar m\xE1s tarde.",
			},
			excalidrawPlus: {
				title: "",
		...
		modal: {
			...
			shareableLink: {
				...
				description:
					"Cargar un dibujo externo <bold>reemplazar\xE1 tu contenido existente</bold>.<br></br>Puedes primero hacer una copia de seguridad de tu dibujo usando una de las opciones de abajo.",
			},
		},
	},
	N = {
		...
		button: "Insertar",
		description:
			"Actualmente s\xF3lo <flowchartLink>Flowchart</flowchartLink>,<sequenceLink> Secuencia, </sequenceLink> y <classLink>Class </classLink>Diagramas son soportados. Los otros tipos se renderizar\xE1n como imagen en Excalidraw.",
...
export {
	...
	r as library,
	N as mermaid,
	z as overwriteConfirm,
	h as publishDialog,
	E as publishSuccessDialog,
	p as roomDialog,
	C as stats,
	f as toast,
	l as toolBar,
