...
var t = {
		...
		lineEditor: { edit: "Rediger Linje", exit: "Afslut linjeeditor" },
		elementLock: {
			lock: "L\xE5s",
			unlock: "L\xE5s op",
			lockAll: "L\xE5s alle",
	...
	i = {
		...
		hint_emptyLibrary:
			"V\xE6lg et element p\xE5 l\xE6rred for at tilf\xF8je det her, eller installer et bibliotek fra det offentlige arkiv, nedenfor.",
		hint_emptyPrivateLibrary:
			"V\xE6lg et element p\xE5 l\xE6rred for at tilf\xF8je det her.",
	},
	n = {
	...
	l = {
		...
		couldNotCreateShareableLinkTooBig:
			"Kunne ikke oprette delbart link: scenen er for stor",
		...
		uploadedSecurly:
			"Upload er blevet sikret med ende-til-ende kryptering, hvilket betyder, at Excalidraw server og tredjeparter ikke kan l\xE6se indholdet.",
		loadSceneOverridePrompt:
			"Indl\xE6sning af ekstern tegning erstatter dit eksisterende indhold. \xD8nsker du at forts\xE6tte?",
...
(Hvis du \xF8nsker at beholde din lokale tegning, skal du blot lukke browserfanen i stedet.)`,
		...
		confirmAddLibrary:
			"Dette vil tilf\xF8je {{numShapes}} form(er) til dit bibliotek. Er du sikker?",
		imageDoesNotContainScene:
			"Dette billede synes ikke at indeholde scene data. Har du aktiveret scene indlejring under eksport?",
		cannotRestoreFromImage: "Scene kunne ikke gendannes fra denne billedfil",
		invalidSceneUrl:
			"Kunne ikke importere scene fra den angivne URL. Det er enten misdannet eller indeholder ikke gyldige Excalidraw JSON data.",
		resetLibrary: "Dette vil rydde hele l\xE6rredet. Er du sikker?",
		removeItemsFromsLibrary: "Slet {{count}} vare(r) fra biblioteket?",
		invalidEncryptionKey:
			"Krypteringsn\xF8glen skal v\xE6re p\xE5 22 tegn. Live-samarbejde er deaktiveret.",
...
Dine \xE6ndringer vil ikke blive gemt!`,
	...
	a = {
		...
		imageInsertError:
			"Billedet kunne ikke inds\xE6ttes. Pr\xF8v igen senere...",
		fileTooBig:
			"Filen er for stor. Maksimal tilladt st\xF8rrelse er {{maxSize}}.",
		svgImageInsertError:
			"Kunne ikke inds\xE6tte SVG-billede. SVG-markup'en ser ugyldig ud.",
		failedToFetchImage: "Dataene blev ikke hentet.",
		invalidSVGString: "Ugyldig SVG.",
		cannotResolveCollabServer:
			"Kunne ikke oprette forbindelse til samarbejdsserveren. Genindl\xE6s siden og pr\xF8v igen.",
		importLibraryError: "Biblioteket kunne ikke indl\xE6ses",
		collabSaveFailed:
			"Kunne ikke gemme i databasen. Hvis problemerne forts\xE6tter, b\xF8r du gemme din fil lokalt for at sikre, at du ikke mister dit arbejde.",
		collabSaveFailed_sizeExceeded:
			"Kunne ikke gemme i databasen, l\xE6rredet lader til at v\xE6re for stort. Du b\xF8r gemme filen lokalt for at sikre, at du ikke mister dit arbejde.",
		imageToolNotSupported: "Billeder er deaktiveret.",
		brave_measure_text_error: {
			line1:
				"Det ser ud til, at du bruger Brave browser med indstillingen <bold>Aggressively Block Fingerprinting</bold> aktiveret.",
			line2:
				"Dette kan resultere i brud p\xE5 <bold>tekstelementerne</bold> i dine tegninger.",
			line3:
				"Vi anbefaler kraftigt at deaktivere denne indstilling. Du kan f\xF8lge <link>disse trin</link> om, hvordan du g\xF8r det.",
			line4:
				"Hvis deaktivering af denne indstilling ikke l\xF8ser visning af tekstelementer, \xE5bn venligst et <issueLink>issue</issueLink> p\xE5 vores GitHub, eller skriv os p\xE5 <discordLink>Discord</discordLink>",
		},
		libraryElementTypeError: {
			...
			image:
				"Underst\xF8ttelse af at tilf\xF8je billeder til biblioteket kommer snart!",
		},
		asyncPasteFailedOnRead:
			"Kunne ikke inds\xE6tte (kan ikke l\xE6se fra systemets udklipsholder).",
	...
	s = {
		canvasPanning:
			"For at flytte l\xE6rred, hold musehjulet eller mellemrumstasten mens du tr\xE6kker, eller brug h\xE5ndv\xE6rkt\xF8jet",
	...
	k = {
		...
		canvasTooBigTip:
			"Tip: Pr\xF8v at flytte de fjerneste elementer lidt t\xE6ttere sammen.",
	},
	g = {
		headingMain:
			"Der opstod en fejl. Pr\xF8v <button>at genindl\xE6se siden</button>.",
		clearCanvasMessage: "",
		clearCanvasCaveat: "",
		trackedToSentry: "",
		openIssueMessage:
			"<button></button> Kopiere og inds\xE6t venligst oplysningerne nedenfor i et GitHub problem.",
		sceneContent: "Scene indhold:",
	},
	m = {
		desc_intro:
			"Du kan invitere folk til din nuv\xE6rende scene, s\xE5 de kan samarbejde med dig.",
		desc_privacy:
			"Bare rolig, sessionen bruger end-to-end kryptering, s\xE5 uanset hvad du tegner vil det forblive privat. Ikke engang vores server vil kunne se, hvad du kommer op med.",
		button_startSession: "Start session",
		button_stopSession: "Stop session",
		desc_inProgressIntro: "Live-samarbejde session er nu begyndt.",
		desc_shareLink:
			"Del dette link med enhver, du \xF8nsker at samarbejde med:",
		desc_exitSession: "",
		shareTitle: "",
	},
	b = { title: "Fejl" },
	...
	f = { title: "", content: "" },
	h = { resetLibrary: "", removeItemsFromLib: "" },
	y = {
		header: "",
		label: {
			withBackground: "",
...
({{exportColorScheme}})`,
	...
	_ = { title: "", button: "", description: "", syntax: "", preview: "" },
	E = {
		labels: t,
		library: i,
		buttons: n,
