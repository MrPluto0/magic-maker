...
var a = {
	...
	o = {
		...
		hint_emptyLibrary:
			"Seleziona un elemento sulla tela per aggiungerlo qui, o installa una libreria dal repository pubblico qui sotto.",
		hint_emptyPrivateLibrary:
			"Seleziona un elemento sulla tela per aggiungerlo qui.",
	},
	r = {
	...
	t = {
		...
		couldNotCreateShareableLinkTooBig:
			"Impossibile creare il link condivisibile: la scena \xE8 troppo grande",
		...
		uploadedSecurly:
			"L'upload \xE8 stato protetto con la crittografia end-to-end, il che significa che il server Excalidraw e terze parti non possono leggere il contenuto.",
		loadSceneOverridePrompt:
			"Se carichi questo disegno esterno, sostituir\xE0 quello che hai. Vuoi continuare?",
...
(Se vuoi mantenere il tuo disegno locale, chiudi semplicemente la scheda del browser.)`,
		...
		confirmAddLibrary:
			"Questo aggiunger\xE0 {{numShapes}} forma(e) alla tua libreria. Sei sicuro?",
		imageDoesNotContainScene:
			"Questa immagine pare non contenere alcuna scena. Avevi incluso la scena durante l'esportazione?",
		cannotRestoreFromImage:
			"Impossibile ripristinare la scena da questo file immagine",
		invalidSceneUrl:
			"Impossibile importare la scena dall'URL fornito. Potrebbe essere malformato o non contenere dati JSON Excalidraw validi.",
		...
		invalidEncryptionKey:
			"La chiave di cifratura deve essere composta da 22 caratteri. La collaborazione live \xE8 disabilitata.",
...
Le tue modifiche non verranno salvate!`,
	...
	n = {
		...
		imageInsertError:
			"Non \xE8 stato possibile inserire l'immagine. Riprova pi\xF9 tardi...",
		fileTooBig:
			"Il file \xE8 troppo grande. La dimensione massima consentita \xE8 {{maxSize}}.",
		svgImageInsertError:
			"Impossibile inserire l'immagine SVG. Il markup SVG non sembra corretto.",
		failedToFetchImage: "Impossibile recuperare l'immagine.",
		invalidSVGString: "SVG non valido.",
		cannotResolveCollabServer:
			"Impossibile connettersi al server di collab. Ricarica la pagina e riprova.",
		importLibraryError: "Impossibile caricare la libreria",
		collabSaveFailed:
			"Impossibile salvare nel database di backend. Se i problemi persistono, dovresti salvare il tuo file localmente per assicurarti di non perdere il tuo lavoro.",
		collabSaveFailed_sizeExceeded:
			"Impossibile salvare nel database di backend, la tela sembra essere troppo grande. Dovresti salvare il file localmente per assicurarti di non perdere il tuo lavoro.",
		imageToolNotSupported: "Le immagini sono disabilitate.",
		brave_measure_text_error: {
			line1:
				"Sembra che tu stia utilizzando il browser Brave con l'impostazione <bold>Blocco aggressivo delle impronte digitali</bold> abilitata.",
			line2:
				"Ci\xF2 potrebbe causare la rottura degli <bold>Elementi di testo</bold> nei tuoi disegni.",
			line3:
				"Consigliamo vivamente di disabilitare questa impostazione. Puoi seguire <link>questi passaggi</link> su come farlo.",
			line4:
				"Se la disattivazione di questa impostazione non risolve la visualizzazione degli elementi di testo, apri un <issueLink>problema</issueLink> sul nostro GitHub o scrivici su <discordLink>Discord</discordLink>",
		},
		libraryElementTypeError: {
			embeddable:
				"Gli elementi incorporabili non possono essere aggiunti alla libreria.",
			iframe: "Gli elementi IFrame non possono essere aggiunti alla libreria.",
			image:
				"Il supporto per l'aggiunta d'immagini alla libreria verr\xE0 aggiunto a breve!",
		},
		asyncPasteFailedOnRead:
			"Impossibile incollare (non \xE8 possibile leggere dagli appunti di sistema).",
	...
	c = {
		canvasPanning:
			"Per spostare la tela, tieni premuta la rotellina del mouse o la barra spaziatrice mentre trascini oppure usa lo strumento mano",
		linearElement:
			"Clicca per iniziare una linea in pi\xF9 punti, trascina per singola linea",
		...
		linearElementMulti:
			"Clicca sull'ultimo punto o premi Esc o Invio per finire",
...
tieni premuto ALT per ridimensionare dal centro`,
		rotate:
			"Puoi mantenere gli angoli tenendo premuto SHIFT durante la rotazione",
		lineEditor_info:
			"Tieni premuto Ctrl o Cmd e doppio clic oppure premi Ctrl o Cmd + Invio per modificare i punti",
...
oppure tieni premuto Alt e fai clic per aggiungere nuovi punti`,
		placeImage:
			"Fai click per posizionare l'immagine, o click e trascina per impostarne la dimensione manualmente",
		publishLibrary: "Pubblica la tua libreria",
		bindTextToElement: "Premi invio per aggiungere il testo",
		deepBoxSelect:
			"Tieni premuto CtrlOCmd per selezionare in profondit\xE0 e per impedire il trascinamento",
		eraserRevert:
			"Tieni premuto Alt per ripristinare gli elementi contrassegnati per l'eliminazione",
		firefox_clipboard_write:
			'Questa funzione pu\xF2 essere abilitata impostando il flag "dom.events.asyncClipboard.clipboardItem" su "true". Per modificare i flag del browser in Firefox, visitare la pagina "about:config".',
	...
	d = {
		...
		canvasTooBigTip:
			"Suggerimento: prova a spostare gli elementi pi\xF9 lontani pi\xF9 vicini tra loro.",
	},
	p = {
		headingMain:
			"Si \xE8 verificato un errore. Provare <button>ricaricando la pagina.</button>",
		clearCanvasMessage:
			"Se ricaricare non funziona, prova <button>pulire la tela.</button>",
		clearCanvasCaveat: " Questo risulter\xE0 nella perdita del lavoro ",
		trackedToSentry:
			"L'errore con identificativo {{eventId}} \xE8 stato tracciato nel nostro sistema.",
		openIssueMessage:
			"Siamo stati molto cauti nel non includere informazioni della scena nell'errore. Se la tua scena non \xE8 privata, ti preghiamo di considerare la sua inclusione nel nostro <button>bug tracker.</button> Per favore includi le informazioni riportate qui sotto copiandole e incollandole nella issue di GitHub.",
		sceneContent: "Contenuto della scena:",
	},
	u = {
		desc_intro:
			"Puoi invitare persone nella tua scena attuale per collaborare con te.",
		desc_privacy:
			"Non preoccuparti, la sessione utilizza la crittografia end-to-end, quindi qualsiasi cosa disegni rimarr\xE0 privata. Nemmeno il nostro server sar\xE0 in grado di vedere cosa hai creato.",
		button_startSession: "Avvia sessione",
		button_stopSession: "Termina sessione",
		desc_inProgressIntro:
			"La sessione di collaborazione \xE8 attualmente in corso.",
		desc_shareLink: "Condividi questo link con chiunque desideri collaborare:",
		desc_exitSession:
			"Interrompere la sessione scollegher\xE0 la tua stanza ma potrai continuare a lavorare con la scena, localmente. Tieni presente che questo non influir\xE0 sulle altre persone, e che saranno ancora in grado di collaborare alla loro versione.",
	...
	g = {
		...
		excalidrawplus_description:
			"Salva la scena nel tuo spazio di lavoro Excalidraw+.",
		excalidrawplus_button: "Esporta",
		excalidrawplus_exportError:
			"Non \xE8 stato possibile esportare su Excalidraw+ al questo momento...",
	},
	b = {
		...
		deepBoxSelect:
			"Seleziona in profondit\xE0 all'interno della casella e previene il trascinamento",
	...
	S = {
		...
		placeholder: {
			...
			libraryDesc:
				"Descrizione della tua libreria per aiutare le persone a comprenderne lo scopo",
			githubHandle:
				"Handle di GitHub (opzionale), cos\xEC che tu possa modificare la libreria una volta inviata per la revisione",
			twitterHandle:
				"Nome utente di Twitter (opzionale), cos\xEC che sappiamo chi accreditare promuovendo su Twitter",
			website: "Link al tuo sito web personale o altro (opzionale)",
		},
		errors: { required: "Obbligatorio", website: "Inserisci un URL valido" },
		noteDescription:
			"Invia la tua libreria da includere nella <link>repository della libreria pubblica</link>perch\xE9 sia usata da altri nei loro disegni.",
		noteGuidelines:
			"La libreria dev'esser prima approvata manualmente. Sei pregato di leggere le <link>linee guida</link> prima di inviarla. Necessiterai di un profilo di GitHub per comunicare ed effettuare modifiche se richiesto, ma non \xE8 strettamente necessario.",
		noteLicense:
			"Inviando, acconsenti che la libreria sar\xE0 pubblicata sotto la <link>Licenza MIT, </link>che in breve significa che chiunque possa usarla senza restrizioni.",
		noteItems:
			"Ogni elemento della libreria deve avere il proprio nome, cos\xEC che sia filtrabile. Gli elementi della seguente libreria saranno inclusi:",
		atleastOneLibItem:
			"Sei pregato di selezionare almeno un elemento della libreria per iniziare",
		republishWarning:
			"Nota: alcuni degli elementi selezionati sono contrassegnati come gi\xE0 pubblicati/presentati. \xC8 necessario reinviare gli elementi solo quando si aggiorna una libreria o una presentazione esistente.",
	},
	z = {
		title: "Libreria inviata",
		content:
			"Grazie {{authorName}}. La tua libreria \xE8 stata inviata per la revisione. Puoi monitorarne lo stato<link>qui</link>",
	},
	h = {
...
Questo aumenter\xE0 la dimensione del file esportato.`,
	...
	C = {
		tooltip:
			"I tuoi disegni sono crittografati end-to-end in modo che i server di Excalidraw non li possano mai vedere.",
...
o incollare in un editor di testo esistente`,
		unableToEmbed:
			"Incorporare questo url non \xE8 permesso. Crea una issue su GitHub per richiedere che l'url sia autorizzato",
		unrecognizedLinkFormat:
			"Il link che hai incorporato non corrisponde al formato previsto. Prova a incollare la stringa 'embed' fornita dal sito di origine",
	},
	T = {
	...
	E = {
		action: {
			exportToImage: {
				...
				description:
					"Esporta i dati della scena come immagine, che potrai importare in seguito.",
			},
			saveToDisk: {
				title: "Salva su disco",
				button: "Salva su disco",
				description:
					"Esporta i dati della scena su file, che potrai importare in seguito.",
			},
			excalidrawPlus: {
				title: "Excalidraw+",
		...
		modal: {
			loadFromFile: {
				...
				description:
					"Il caricamento da file sostituir\xE0 <bold>il contenuto esistente</bold>.<br></br>Puoi salvare il tuo disegno prima usando una delle opzioni qui sotto.",
			},
			shareableLink: {
