...
var i = {
	...
	e = {
		...
		hint_emptyLibrary:
			"Atlasiet objektu t\u0101fel\u0113, lai to \u0161eit pievienotu, vai pievienojiet publisku bibliot\u0113ku zem\u0101k.",
		hint_emptyPrivateLibrary:
			"Atlasiet objektu t\u0101fel\u0113, lai to \u0161eit pievienotu.",
	},
	s = {
	...
	r = {
		clearReset:
			"\u0160\u012B funkcija not\u012Br\u012Bs visu t\u0101feli. Vai turpin\u0101t?",
		couldNotCreateShareableLink:
			"Nevar\u0113ja izveidot kop\u012Bgojamo saiti.",
		couldNotCreateShareableLinkTooBig:
			"Nevar\u0113ja izveidot kop\u012Bgojamo saiti \u2013 aina ir par lielu",
		couldNotLoadInvalidFile:
			"Nevar\u0113ja iel\u0101d\u0113t neder\u012Bgu datni",
		...
		uploadedSecurly:
			"Aug\u0161upl\u0101de nodro\u0161in\u0101ta ar \u0161ifr\u0113\u0161anu no gala l\u012Bdz galam, kas noz\u012Bm\u0113, ka Excalidraw serveri un tre\u0161\u0101s puses nevar las\u012Bt saturu.",
		loadSceneOverridePrompt:
			"\u0100r\u0113ja satura iel\u0101de aizst\u0101s j\u016Bsu pa\u0161reiz\u0113jo saturu. Vai v\u0113laties turpin\u0101t?",
...
(Ja v\u0113laties patur\u0113t z\u012Bm\u0113jumu, kas saglab\u0101ts j\u016Bsu p\u0101rl\u016Bk\u0101, vienk\u0101r\u0161i aizveriet p\u0101rl\u016Bka cilni.)`,
		...
		errorRemovingFromLibrary:
			"Nevar\u0113ja iz\u0146emt vienumu no bibliot\u0113kas",
		confirmAddLibrary:
			"\u0160\u012B funkcija pievienos {{numShapes}} formu(-as) j\u016Bsu bibliot\u0113kai. Vai turpin\u0101t?",
		imageDoesNotContainScene:
			"\u0160\u0137iet, ka att\u0113ls nesatur ainas datus. Vai iesp\u0113joj\u0101t ainas iegul\u0161anu, kad eksport\u0113j\u0101t?",
		cannotRestoreFromImage:
			"Ainu nevar\u0113ja atg\u016Bt no att\u0113la datnes",
		invalidSceneUrl:
			"Nevar\u0113ja import\u0113t ainu no nor\u0101d\u012Bt\u0101 URL. Vai nu tas ir neder\u012Bgs, vai nesatur der\u012Bgus Excalidraw JSON datus.",
		resetLibrary:
			"\u0160\u012B funkcija iztuk\u0161os bibliot\u0113ku. Vai turpin\u0101t?",
		removeItemsFromsLibrary:
			"Vai iz\u0146emt {{count}} vienumu(s) no bibliot\u0113kas?",
		invalidEncryptionKey:
			"\u0160ifr\u0113\u0161anas atsl\u0113gai j\u0101b\u016Bt 22 simbolus garai. Tie\u0161saistes sadarb\u012Bba ir izsl\u0113gta.",
...
J\u016Bsu izmai\u0146as netiks saglab\u0101tas!`,
	...
	o = {
		...
		imageInsertError:
			"Nevar\u0113ja ievietot att\u0113lu. M\u0113\u0123iniet v\u0113l\u0101k...",
		fileTooBig:
			"Datne ir par lielu. Liel\u0101kais at\u013Cautais izm\u0113rs ir {{maxSize}}.",
		svgImageInsertError:
			"Nevar\u0113ja ievietot SVG att\u0113lu. \u0160\u0137iet, ka SVG mar\u0137\u0113jums nav der\u012Bgs.",
		failedToFetchImage: "",
		invalidSVGString: "Neder\u012Bgs SVG.",
		cannotResolveCollabServer:
			"Nevar\u0113ja savienoties ar sadarbo\u0161an\u0101s serveri. L\u016Bdzu, p\u0101rl\u0101d\u0113jiet lapu un m\u0113\u0123iniet v\u0113lreiz.",
		importLibraryError: "Nevar\u0113ja iel\u0101d\u0113t bibliot\u0113ku",
		collabSaveFailed:
			"Darbs nav saglab\u0101ts datub\u0101z\u0113. Ja probl\u0113ma turpin\u0101s, saglab\u0101jiet datni lok\u0101laj\u0101 kr\u0101tuv\u0113, lai nodro\u0161in\u0101tos pret darba pazaud\u0113\u0161anu.",
		collabSaveFailed_sizeExceeded:
			"Darbs nav saglab\u0101ts datub\u0101z\u0113, \u0161\u0137iet, ka t\u0101fele ir p\u0101r\u0101k liela. Saglab\u0101jiet datni lok\u0101laj\u0101 kr\u0101tuv\u0113, lai nodro\u0161in\u0101tos pret darba pazaud\u0113\u0161anu.",
	...
	l = {
		...
		penMode:
			"Pildspalvas re\u017E\u012Bms \u2013 nov\u0113rst pieskar\u0161anos",
	...
	u = {
		canvasPanning:
			"Lai b\u012Bd\u012Btu t\u0101feli, turiet nospiestu ritin\u0101\u0161anas vai atstarpes tausti\u0146u, vai izmanto rokas r\u012Bku",
		linearElement:
			"Klik\u0161\u0137iniet, lai s\u0101ktu z\u012Bm\u0113t vair\u0101kus punktus; velciet, lai z\u012Bm\u0113tu l\u012Bniju",
		...
		embeddable: "",
		text_selected:
			"Dubultklik\u0161\u0137iniet vai spiediet ievades tausti\u0146u, lai redi\u0123\u0113tu tekstu",
		text_editing:
			"Spiediet izie\u0161anas tausti\u0146u vai CtrlOrCmd+ENTER, lai beigtu redi\u0123\u0113t",
		linearElementMulti:
			"Klik\u0161\u0137iniet uz p\u0113d\u0113j\u0101 punkta vai spiediet izejas vai ievades tausti\u0146u, lai pabeigtu",
...
turiet nospiestu ALT, lai main\u012Btu izm\u0113ru ap centru`,
		rotate:
			"Rot\u0113jot varat ierobe\u017Eot le\u0146\u0137i, turot nospiestu SHIFT",
		lineEditor_info:
			"Turiet CtrlOrCmd un dubultklik\u0161\u0137iniet, vai spiediet CtrlOrCmd + Enter, lai redi\u0123\u0113tu punktus",
		lineEditor_pointSelected:
			"Spiediet dz\u0113\u0161anas tausti\u0146u, lai no\u0146emtu punktus, \u2013 CtrlOrCmd+D, lai to kop\u0113tu, vai velciet, lai p\u0101rvietotu",
...
vai turiet Alt un clik\u0161\u0137iniet, lai pievienotu jaunus punktus`,
		placeImage:
			"Klik\u0161\u0137iniet, lai novietotu att\u0113lu, vai spiediet un velciet, lai iestat\u012Btu t\u0101 izm\u0113ru",
		publishLibrary: "Public\u0113t savu bibliot\u0113ku",
		bindTextToElement: "Spiediet ievades tausti\u0146u, lai pievienotu tekstu",
		deepBoxSelect:
			"Turient nospiestu Ctrl vai Cmd, lai atlas\u012Btu dzi\u013Cum\u0101 un lai nepie\u013Cautu objektu pavilk\u0161anu",
		eraserRevert:
			"Turiet Alt, lai no\u0146emtu elementus no dz\u0113s\u0161anas atlases",
		firefox_clipboard_write:
			'\u0160is iestat\u012Bjums var tikt iesl\u0113gts ar "dom.events.asyncClipboard.clipboardItem" mar\u0137ieri p\u0101rsl\u0113gtu uz "true". Lai main\u012Btu p\u0101rl\u016Bka mar\u0137ierus Firefox, apmekl\u0113 "about:config" lapu.',
		disableSnapping: "",
	},
	d = {
		...
		canvasTooBigTip:
			"Ieteikums: m\u0113\u0123iniet satuvin\u0101t pa\u0161us t\u0101l\u0101kos elementus.",
	},
	k = {
		headingMain:
			"Notikusi k\u013C\u016Bda. M\u0113\u0123iniet <button>p\u0101rl\u0101d\u0113t lapu.</button>",
		clearCanvasMessage:
			"Ja p\u0101rl\u0101d\u0113\u0161ana nestr\u0101d\u0101, m\u0113\u0123iniet <button>not\u012Brot t\u0101feli.</button>",
		clearCanvasCaveat: " Tas noved\u012Bs pie darba zaud\u0113\u0161anas ",
		trackedToSentry:
			"K\u013C\u016Bda ar kodu {{eventId}} tika noteikta m\u016Bsu sist\u0113m\u0101.",
		openIssueMessage:
			"M\u0113s uzman\u012Bj\u0101mies, lai neiek\u013Cautu j\u016Bsu ainas inform\u0101ciju \u0161aj\u0101 k\u013C\u016Bd\u0101. Ja j\u016Bsu aina nav priv\u0101ta, l\u016Bdzu zi\u0146ojiet par \u0161o k\u013C\u016Bdu m\u016Bsu <button>k\u013C\u016Bdu uzskait\u0113.</button> L\u016Bdzu, miniet sekojo\u0161o inform\u0101ciju to kop\u0113jot un iel\u012Bm\u0113jot j\u016Bsu zi\u0146ojum\u0101 platform\u0101 GitHub.",
		sceneContent: "Ainas saturs:",
	},
	m = {
		desc_intro:
			"Varat iel\u016Bgt cilv\u0113kus pa\u0161reiz\u0113jaj\u0101 ain\u0101, lai sadarbotos ar tiem.",
		desc_privacy:
			"Neuztraucieties, sesija izmanto \u0161ifr\u0113\u0161anu no gala l\u012Bdz galam, t\u0101tad j\u016Bsu z\u012Bm\u0113jums paliks priv\u0101ts. Pat m\u016Bsu serveri nevar\u0113s redz\u0113t, ar ko esat n\u0101cis klaj\u0101.",
		button_startSession: "S\u0101kt sesiju",
		button_stopSession: "Beigt sesiju",
		desc_inProgressIntro: "Notiek tie\u0161saistes sadarb\u012Bbas sesija.",
		desc_shareLink:
			"Dalieties ar \u0161o saiti ar jebkuru, ar ko v\u0113laties sadarboties:",
		desc_exitSession:
			"Sesijas beig\u0161ana j\u016Bs atvienos no sadarbo\u0161an\u0101s, bet j\u016Bs v\u0113l joproj\u0101m var\u0113siet str\u0101d\u0101t ar ainu sav\u0101 dator\u0101. Iev\u0113rojiet, ka \u0161is neietekm\u0113s citus dal\u012Bbniekus, un vi\u0146i v\u0113l joproj\u0101m var\u0113s sadarboties sav\u0101 ainas versij\u0101.",
		shareTitle:
			"Pievienoties tie\u0161saistes sadarb\u012Bbai programm\u0101 Excalidraw",
	},
	p = { title: "K\u013C\u016Bda" },
	b = {
		disk_title: "Saglab\u0101t disk\u0101",
		disk_details:
			"Eksport\u0113t ainas datus datn\u0113, ko v\u0113l\u0101k var\u0113siet import\u0113t.",
		...
		excalidrawplus_description:
			"Saglab\u0101t ainu sav\u0101 Excalidraw+ darbviet\u0101.",
		excalidrawplus_button: "Eksport\u0113t",
		excalidrawplus_exportError:
			"Pa\u0161reiz nevar\u0113ja eksport\u0113t uz Excalidraw+...",
	},
	v = {
		...
		deepBoxSelect:
			"Atlas\u012Bt dzi\u013Cum\u0101 kastes ietvaros, un nepie\u013Caut pavilk\u0161anu",
	...
	g = {
		...
		placeholder: {
			...
			libraryDesc:
				"Bibliot\u0113kas apraksts, kas pal\u012Bdz\u0113s citiem saprast t\u0101s pielietojumu",
			githubHandle:
				"GitHub lietot\u0101jv\u0101rds (neoblig\u0101ts), lai j\u016Bs var\u0113tu redi\u0123\u0113t bibliot\u0113ku p\u0113c t\u0101s iesnieg\u0161anas izskat\u012B\u0161anai",
			twitterHandle:
				"Twitter lietot\u0101jv\u0101rds (neoblig\u0101ts), lai m\u0113s var\u0113tu j\u016Bs piemin\u0113t k\u0101 autoru, kad reklam\u0113sim bibliot\u0113ku platform\u0101 Twitter",
			website:
				"Saikne uz j\u016Bsu person\u012Bgo m\u0101jaslapu vai k\u0101du citu lapu (neoblig\u0101ta)",
		},
		errors: { required: "Oblig\u0101ts", website: "Ievadiet der\u012Bgu URL" },
		noteDescription:
			"Iesniegt savu bibliot\u0113ku iek\u013Cau\u0161anai <link>publiskaj\u0101 bibliot\u0113ku datub\u0101z\u0113</link>, lai citi to var\u0113tu izmantot savos z\u012Bm\u0113jumos.",
		noteGuidelines:
			"\u0160ai bibliot\u0113kai vispirms j\u0101tiek manu\u0101li apstiprin\u0101tai. L\u016Bdzu, izlasiet <link>nor\u0101d\u012Bjumus</link> pirms iesnieg\u0161anas. Jums vajadz\u0113s GitHub kontu, lai sazin\u0101tos un veiktu izmai\u0146as, ja t\u0101das b\u016Bs piepras\u012Btas, bet tas nav absol\u016Bti nepiecie\u0161ams.",
		noteLicense:
			"Iesniedzot bibliot\u0113ku, j\u016Bs piekr\u012Btat t\u0101s public\u0113\u0161anai saska\u0146\u0101 ar <link>MIT Licenci, </link>kas \u012Bsum\u0101 noz\u012Bm\u0113, ka jebkur\u0161 to var\u0113s izmantot bez ierobe\u017Eojumiem.",
		noteItems:
			"Katram bibliot\u0113kas vienumam j\u0101b\u016Bt savam nosaukumam, lai to var\u0113tu atrast filtr\u0113jot. Tiks iek\u013Cauti sekojo\u0161ie bibliot\u0113kas vienumi:",
		atleastOneLibItem:
			"L\u016Bdzu, atlasiet vismaz vienu bibliot\u0113kas vienumu, lai s\u0101ktu darbu",
		republishWarning:
			"Iev\u0113ro: da\u017Ei no atz\u012Bm\u0113tajiem objektiem jau atz\u012Bm\u0113ti k\u0101 public\u0113ti vai iesniegti public\u0113\u0161anai. Tos vajadz\u0113tu atk\u0101rtoti iesniegt tikai tad, ja v\u0113lies labot eso\u0161o bibliot\u0113ku.",
	},
	j = {
		title: "Bibliot\u0113ka iesniegta",
		content:
			"Paldies, {{authorName}}! J\u016Bsu bibliot\u0113ka iesniegta izskat\u012B\u0161anai. J\u016Bs varat izsekot iesnieguma statusam<link>\u0161eit</link>",
	},
	z = {
		resetLibrary: "Atiestat\u012Bt bibliot\u0113ku",
		removeItemsFromLib:
			"No\u0146emt atlas\u012Btos vienumus no bibliot\u0113kas",
	},
	S = {
		header: "",
		label: {
	...
	h = {
		tooltip:
			"J\u016Bsu z\u012Bm\u0113jumi ir \u0161ifr\u0113ti no gala l\u012Bdz galam; l\u012Bdz ar to Excalidraw serveri tos nekad neredz\u0113s.",
	...
	y = {
		...
		copyToClipboardAsPng:
			"Nokop\u0113ja {{exportSelection}} starpliktuv\u0113 k\u0101 PNG ({{exportColorScheme}})",
		fileSaved: "Datne saglab\u0101ta.",
		fileSavedToFilename: "Saglab\u0101ts k\u0101 {filename}",
		canvas: "t\u0101feli",
		selection: "atlasi",
		pasteAsSingleElement:
			"Izmantojiet {{shortcut}}, lai iel\u012Bm\u0113tu k\u0101 jaunu elementu, vai iel\u012Bm\u0113tu eso\u0161\u0101 teksta lauci\u0146\u0101",
		unableToEmbed: "",
	...
	w = {
		app: {
			center_heading:
				"Visi j\u016Bsu dati tiek glab\u0101ti uz vietas j\u016Bsu p\u0101rl\u016Bk\u0101.",
			center_heading_plus:
				"Vai t\u0101 viet\u0101 v\u0113lies doties uz Excalidraw+?",
	...
	A = { title: "", button: "", description: "", syntax: "", preview: "" },
	x = {
		labels: i,
		library: e,
		buttons: s,
...
export {
	...
	e as library,
	A as mermaid,
	P as overwriteConfirm,
	g as publishDialog,
	j as publishSuccessDialog,
	m as roomDialog,
	T as stats,
	y as toast,
	l as toolBar,
