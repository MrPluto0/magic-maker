...
var r = {
	...
	i = {
		...
		hint_emptyLibrary:
			"Seleccionatz un element d\u2019apondre aqu\xED, o installatz una bibliot\xE8ca del depaus public, \xE7ai-jos.",
		hint_emptyPrivateLibrary:
			"Seleccionatz un element d\u2019apondre aqu\xED pel canab\xE0s.",
	},
	t = {
	...
	o = {
		clearReset:
			"Aqu\xF2 suprimir\xE0 lo canab\xE0s compl\xE8t. O vol\xE8tz vertadi\xE8rament\u202F?",
		couldNotCreateShareableLink: "Creacion impossibla del ligam de partatge.",
		couldNotCreateShareableLinkTooBig:
			"Creacion impossibla del ligam de partatge\u202F: la sc\xE8na es tr\xF2p granda",
		couldNotLoadInvalidFile:
			"Cargament impossible d\u2019un fichi\xE8r invalid",
		...
		uploadedSecurly:
			"Lo telecargament es estat securizat amb un chiframent del cap a la fin, significa que los servidors d\u2019Excalidraw o que quina t\xE8r\xE7a part que si\xE1 p\xF2don pas legir lo contengut.",
		loadSceneOverridePrompt:
			"Cargar un dessenh ext\xE8rn rempla\xE7ar\xE0 v\xF2stre contengut existent. Vol\xE8tz contunhar\u202F?",
...
(Se vol\xE8tz gardar v\xF2stre dessenh local, tampatz simplament l\u2019onglet del navegador a la pla\xE7a)`,
		errorAddingToLibrary:
			"Apondon impossible de l\u2019element a la bibliot\xE8ca",
		errorRemovingFromLibrary:
			"Supression impossibla de l\u2019element a la bibliot\xE8ca",
		confirmAddLibrary:
			"Apondr\xE0 {{numShapes}} forma(s) a v\xF2stra bibliot\xE8ca. Confirmatz\u202F?",
		imageDoesNotContainScene:
			"Aqueste imatge sembla pas cont\xE9ner cap de donadas de sc\xE8na. Av\xE8tz activat l\u2019integracion de sc\xE8na pendent l\u2019exportacion\u202F?",
		cannotRestoreFromImage:
			"Restauracion impossibla de la sc\xE8na a partir del fichi\xE8r imatge",
		invalidSceneUrl:
			"Importacion impossibla de la sc\xE8na a partir de l\u2019URL provesida. Es si\xE1 mal formatada o si\xE1 conten pas cap de donada JSON Excalidraw valida.",
		resetLibrary:
			"Aqu\xF2 suprimir\xE0 v\xF2stra bibliot\xE8ca. O vol\xE8tz vertadi\xE8rament\u202F?",
		removeItemsFromsLibrary:
			"Suprimir {{count}} element(s) de la bibliot\xE8ca\u202F?",
		invalidEncryptionKey:
			"La clau de chiframent deu cont\xE9ner 22 caract\xE8rs. La collaboracion en dir\xE8ct es desactivada.",
...
V\xF2stras modificacions ser\xE0n pas salvadas !`,
	...
	n = {
		...
		imageInsertError:
			"Insercion d\u2019imatge impossibla. Tornatz ensajar mai tard...",
		fileTooBig:
			"Fichi\xE8r tr\xF2p pesuc. La talha maximala autorizada es {{maxSize}}.",
		svgImageInsertError:
			"Insercion d\u2019imatge SVG impossibla. Las balisas SVG semblan invalidas.",
		failedToFetchImage: "Frac\xE0s de la recuperacion de l\u2019imatge.",
		invalidSVGString: "SVG invalid.",
		cannotResolveCollabServer:
			"Connexion impossibla al servidor collab. Merc\xE9s de recargar la pagina e tornar ensajar.",
		...
		asyncPasteFailedOnRead:
			"Empegatge impossible (lectura impossibla a partir del quichapapi\xE8rs).",
	...
	c = {
		canvasPanning: "",
		linearElement:
			"Clicatz per comen\xE7ar mantun punt, lisatz per una sola linha",
		...
		embeddable: "",
		text_selected:
			"Clicatz dos c\xF2ps o quichatz ENTRADA per modificar lo t\xE8xt",
		text_editing:
			"Quichatz ESCAPAR o CtrlOrCmd+ENTRADA per acabar la modificacion",
		linearElementMulti:
			"Clicatz sul darri\xE8r punt o quichatz Ecap o Entrada per acabar",
...
quichatz ALT per retalhar a partir del centre`,
		rotate:
			"Pod\xE8tz restr\xE9nger los angles en mantenent MAJ pendent la rotacion",
		lineEditor_info:
			"Ten\xE8tz quichat Ctrl o Cmd e doble clic o quichatz Ctrl o Cmd + Entrada per modificar los ponches",
...
o mant\xE9ner Alt e clicar per n\u2019apondre de nov\xE8ls`,
		placeImage:
			"Clicatz per pla\xE7ar l\u2019imatge, o clicatz e lisatz per definir sa talha manualament",
		publishLibrary: "Publicar v\xF2stra pr\xF2pria bibliot\xE8ca",
		bindTextToElement: "Quichatz Entrada per apondre de t\xE8xte",
		deepBoxSelect:
			"Gardar CtrlOCmd per una seleccion gropada e empachar lo despla\xE7ament",
		eraserRevert:
			"Ten\xE8tz quichat Alt per anullar los elements marcats per supression",
	...
	d = {
		...
		canvasTooBigTip:
			"Ast\xFAcia\u202F: ensajatz de sarrar los elements mai alonhats.",
	},
	p = {
		headingMain:
			"Una error s\u2019es producha. Ensajatz <button>recargament de la pagina.</button>",
		clearCanvasMessage:
			"Se recargar fonciona pas, ensajatz <button>d\u2019escafar los canabasses.</button>",
		clearCanvasCaveat: " Menar\xE0 a una p\xE8rda del trabalh ",
		trackedToSentry:
			"Error amb l\u2019identificant {{eventId}} es estada enregistrada sus n\xF2stre sist\xE8ma.",
		openIssueMessage:
			"\xC8rem plan prudents per inclure pas d\u2019informacions de la sc\xE8na v\xF2stra sus l\u2019error. Se v\xF2stra sc\xE8na es pas privada, volgatz considerar de perseguir sus n\xF2stre <button>tra\xE7adors d\u2019avarias.</button> Volgatz inclure las informacions \xE7ai-jos en las copiant e pegant a l\u2019issue GitHub.",
		sceneContent: "Contengut de la sc\xE8na\u202F:",
	},
	m = {
		desc_intro:
			"Pod\xE8tz convidar lo monde a v\xF2stra sc\xE8na actuala per participar amb vos.",
		desc_privacy:
			"Vos en fagatz pas, la session utiliza lo chiframent del cap a la fin, \xE7\xF2 que dessenetz demorar\xE0 privat. Mai n\xF2stres servidors poir\xE0n pas veire v\xF2stra creacion.",
		...
		desc_shareLink:
			"Partejatz aqueste ligam amb lo monde amb qui vol\xE8tz collaborar\u202F:",
		desc_exitSession:
			"Arrestar la session vos desconnectar\xE0 de la sala, mas poiretz contunhar de trabalhar a la sc\xE8na, en local. Notatz qu\u2019aqu\xF2 afectar\xE0 pas los autres, e poir\xE0n collaborar a lor version.",
	...
	b = {
		...
		disk_details:
			"Exportar las donadas de la sc\xE8na cap a un fichi\xE8r que pod\xE8tz importar mai tard.",
		...
		excalidrawplus_description:
			"Enregistrar la sc\xE8na dins v\xF2stre espaci de trabalh Excalidraw+.",
		excalidrawplus_button: "Exportar",
		excalidrawplus_exportError:
			"Export impossibla cap a Excalidraw+ pel moment...",
	},
	g = {
	...
	v = {
		...
		placeholder: {
			...
			libraryDesc:
				"Descripcion de v\xF2stra bibliot\xE8ca per ajudar lo monde a comprendre son utilizacion",
			githubHandle:
				"GitHub handle(opcional), per poder modificar la bibliot\xE8ca un c\xF2p enviada per repassa",
			twitterHandle:
				"Nom d\u2019utilizaire Twitter (opcional), per saber qual mercejar quand ne parlam sus Twitter",
			website:
				"Ligam cap a v\xF2stre site web personal o endac\xF2m mai (opcional)",
		},
		errors: { required: "Requerit", website: "Picatz una URL valida" },
		noteDescription:
			"Enviatz v\xF2stra bibliot\xE8ca per \xE8sser compresa al <link>repert\xF2ri public de bibliot\xE8ca</link>per que los autres l\u2019utilizen dins lor dessenhs.",
		noteGuidelines:
			"Qualqu\u2019un deu aprovar la bibliot\xE8ca manualament per comen\xE7ar. Volgatz legir las <link>linhas directrises</link> abans de sometre. Vos far\xE0 mesti\xE8r un compte GitHub per comunicar e realizar de modificacions se demandadas, mas es pas compl\xE8tament obligat\xF2ri.",
		noteLicense:
			"En sometent, acceptatz que la bibliot\xE8ca si\xE1 publicada sota la <link>Lic\xE9ncia MIT, </link>que significa en br\xE8u que qual que si\xE1 p\xF2t l\u2019utilizar sens cap de restriccion.",
		noteItems:
			"Cada element de bibliot\xE8ca deu aver un nom pr\xF2pri per \xE8sser filtrable. Los elements de bibliot\xE8ca seguentas ser\xE0n incluses\u202F:",
		atleastOneLibItem:
			"Volgatz seleccionar almens un element de bibliot\xE8ca per comen\xE7ar",
		republishWarning:
			"N\xF2ta\u202F: d\u2019unes elements seleccionats son marcats ja coma publicats/enviats. Deuriatz sonque tornar enviar los elements pendent l\u2019actualizacion d\u2019una bibliot\xE8ca existenta o un mandad\xEDs.",
	},
	z = {
		title: "Bibliot\xE8ca somesa",
		content:
			"Merc\xE9s {{authorName}}. V\xF2stre bibliot\xE8ca es estada somesa per repassa. Pod\xE8tz seguir l\u2019avan\xE7ament<link>aqu\xED</link>",
	},
	S = {
		resetLibrary: "Re\xEFnicializar la bibliot\xE8ca",
	...
	x = {
		tooltip:
			"V\xF2stres dessenhs son chifrats del cap a la fin en consequ\xE9ncia los servidors d\u2019Excalidraw los veir\xE0n pas jamai.",
	...
	f = {
		...
		copyToClipboardAsPng:
			"{{exportSelection}} copiat coma PNG ({{exportColorScheme}})",
	...
	T = {
		app: {
			center_heading:
				"Totas las donadas son enregistradas dins v\xF2stre navegador.",
			center_heading_plus:
				"Voliatz pusl\xE8u utilizar Excalidraw+ a la pla\xE7a\u202F?",
