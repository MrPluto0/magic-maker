import { a as fe, f as pe } from "./chunk-C7567YP5.js";
import {
	Ga as $t,
	Ia as te,
	J as Ue,
...
import { a as de } from "./chunk-M2JW2GFW.js";
import { f as Zt } from "./chunk-SXMPUQ6M.js";
de();
var Ae = Zt(je(), 1);
var j0 = Zt(Ie(), 1),
	U0 = Zt(Ue(), 1);
var It = (function () {
	var e = function (bt, _, x, m) {
		...
		Qt = {
			...
			performAction: function (_, x, m, g, T, u, Rt) {
				var y = u.length - 1;
				switch (T) {
					case 3:
						g.setDirection("TB");
					...
					case 19:
						...
						break;
					case 20:
						g.setAccDescription(u[y].substring(15)),
							(this.$ = u[y].substring(15));
						break;
					case 21:
					...
					case 28:
					case 29:
						u[y].splice(2, 0, "ENTERPRISE"),
							g.addPersonOrSystemBoundary(...u[y]),
							(this.$ = u[y]);
						break;
					case 30:
						...
						break;
					case 31:
						u[y].splice(2, 0, "CONTAINER"),
							g.addContainerBoundary(...u[y]),
							(this.$ = u[y]);
						break;
					case 32:
					...
					case 45:
						...
						break;
					case 46:
						g.addPersonOrSystem("external_system_queue", ...u[y]),
							(this.$ = u[y]);
						break;
					case 47:
					...
					case 51:
						...
						break;
					case 52:
						g.addContainer("external_container_queue", ...u[y]),
							(this.$ = u[y]);
						break;
					case 53:
					...
					case 57:
						...
						break;
					case 58:
						g.addComponent("external_component_queue", ...u[y]),
							(this.$ = u[y]);
						break;
					case 60:
					...
					case 69:
						...
						break;
					case 70:
						g.updateLayoutConfig("update_layout_config", ...u[y]),
							(this.$ = u[y]);
						break;
					case 71:
						this.$ = [u[y]];
			...
			table: [
				...
				{ 27: [1, 79] },
				e(Tt, [2, 23]),
				{ 35: 80, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 86, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 87, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 88, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 89, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 90, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 91, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 92, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 93, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 94, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 95, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 96, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 97, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 98, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 99, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 100, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 101, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 102, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 103, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 104, 75: 81, 76: v, 77: k, 79: A, 80: C },
				e(w, [2, 59]),
				{ 35: 105, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 106, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 107, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 108, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 109, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 110, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 111, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 112, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 113, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 114, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 115, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{
					20: 116,
					29: 49,
					30: 61,
				...
				{ 12: [1, 118], 33: [1, 117] },
				{ 35: 119, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 120, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 121, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 122, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 123, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 124, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 35: 125, 75: 81, 76: v, 77: k, 79: A, 80: C },
				{ 14: [1, 126] },
				{ 14: [1, 127] },
				{ 14: [1, 128] },
				{ 14: [1, 129] },
				{ 1: [2, 8] },
				e(Ct, [2, 15]),
				e(Xt, [2, 17], { 21: 22, 19: 130, 22: t, 23: a, 24: o, 26: l, 28: i }),
				e(Ct, [2, 37], {
					19: 20,
					20: 21,
					21: 22,
				...
				e(Tt, [2, 22]),
				e(w, [2, 39]),
				e(oe, [2, 71], { 75: 81, 35: 132, 76: v, 77: k, 79: A, 80: C }),
				e(Mt, [2, 73]),
				{ 78: [1, 133] },
				e(Mt, [2, 75]),
				e(Mt, [2, 76]),
			...
			parse: function (_) {
				var x = this,
					...
					Le = 2,
					he = 1,
					Ne = u.slice.call(arguments, 1),
					D = Object.create(this.lexer),
					vt = { yy: {} };
				for (var qt in this.yy)
					Object.prototype.hasOwnProperty.call(this.yy, qt) &&
						(vt.yy[qt] = this.yy[qt]);
				D.setInput(_, vt.yy),
					(vt.yy.lexer = D),
					(vt.yy.parser = this),
				...
				typeof vt.yy.parseError == "function"
					? (this.parseError = vt.yy.parseError)
				...
				function Ye() {
					...
					return (
						(X = g.pop() || D.lex() || he),
						typeof X != "number" &&
							(X instanceof Array && ((g = X), (X = g.pop())),
							(X = x.symbols_[X] || X)),
						X
					);
				}
				for (var M, kt, B, Kt, wt = {}, Lt, z, ue, Nt; ; ) {
					if (
						((kt = m[m.length - 1]),
						this.defaultActions[kt]
							? (B = this.defaultActions[kt])
							: ((M === null || typeof M > "u") && (M = Ye()),
								(B = Rt[kt] && Rt[kt][M])),
					...
					switch (B[0]) {
						...
						case 2:
							if (
								...
								(Kt = this.performAction.apply(
									wt,
									[y, ce, Et, vt.yy, B[1], T, u].concat(Ne),
								)),
								typeof Kt < "u")
							)
								return Kt;
							z &&
								...
								(T = T.slice(0, -1 * z)),
								(u = u.slice(0, -1 * z))),
								m.push(this.productions_[B[1]][0]),
								T.push(wt.$),
								u.push(wt._$),
								(ue = Rt[m[m.length - 2]][m[m.length - 1]]),
								m.push(ue);
							break;
						case 3:
							return !0;
				...
				unput: function (_) {
					...
					return (
						(this.yylloc = {
							...
							last_column: m
								? (m.length === g.length ? this.yylloc.first_column : 0) +
									g[g.length - m.length].length -
									m[0].length
								: this.yylloc.first_column - x,
						}),
						this.options.ranges &&
							(this.yylloc.range = [T[0], T[0] + this.yyleng - x]),
...
` +
				...
				test_match: function (_, x) {
					...
					if (
						(this.options.backtrack_lexer &&
							...
							this.options.ranges &&
								(T.yylloc.range = this.yylloc.range.slice(0))),
						(g = _[0].match(/(?:\r\n?|\n).*/g)),
				...
				next: function () {
					...
					for (var T = this._currentRules(), u = 0; u < T.length; u++)
						if (
							((m = this._input.match(this.rules[T[u]])),
							m && (!x || m[0].length > x[0].length))
						) {
							if (((x = m), (g = u), this.options.backtrack_lexer)) {
								if (((_ = this.test_match(m, T[u])), _ !== !1)) return _;
								if (this._backtrack) {
									x = !1;
									continue;
								} else return !1;
					...
					return x
						? ((_ = this.test_match(x, T[g])), _ !== !1 ? _ : !1)
						: this._input === ""
							? this.EOF
							: this.parseError(
									"Lexical error on line " +
...
` +
	...
	return (Ht.prototype = Qt), (Qt.Parser = Ht), new Ht();
})();
It.parser = It;
var Fe = It,
	U = [],
	...
	We = function (e, t, a, o, l, i, s) {
		if (t === null || a === null) return;
		let r = {},
			n = U.find((h) => h.alias === t);
		if (
			(n && t === n.alias ? (r = n) : ((r.alias = t), U.push(r)),
			a == null ? (r.label = { text: "" }) : (r.label = { text: a }),
			o == null)
		)
			r.descr = { text: "" };
	...
	Qe = function (e, t, a, o, l, i, s, r) {
		if (t === null || a === null) return;
		let n = {},
			h = U.find((f) => f.alias === t);
		if (
			(h && t === h.alias ? (n = h) : ((n.alias = t), U.push(n)),
			a == null ? (n.label = { text: "" }) : (n.label = { text: a }),
			o == null)
		)
			n.techn = { text: "" };
		else if (typeof o == "object") {
	...
	qe = function (e, t, a, o, l) {
		if (e === null || t === null) return;
		let i = {},
			s = V.find((r) => r.alias === e);
		if (
			(s && e === s.alias ? (i = s) : ((i.alias = e), V.push(i)),
			t == null ? (i.label = { text: "" }) : (i.label = { text: t }),
			a == null)
		)
			i.type = { text: "system" };
	...
	Ke = function (e, t, a, o, l, i, s, r) {
		if (t === null || a === null) return;
		let n = {},
			h = V.find((f) => f.alias === t);
		if (
			(h && t === h.alias ? (n = h) : ((n.alias = t), V.push(n)),
			a == null ? (n.label = { text: "" }) : (n.label = { text: a }),
			o == null)
		)
			n.type = { text: "node" };
	...
	Ze = function (e, t, a, o, l, i, s, r, n, h, f) {
	...
	$e = function (e, t, a, o, l, i, s) {
		let r = Pt.find((n) => n.from === t && n.to === a);
		if (r !== void 0) {
			if (o != null)
				if (typeof o == "object") {
	...
	f0 = { FILLED: 0, OPEN: 1 },
	p0 = { LEFTOF: 0, RIGHTOF: 1, OVER: 2 },
	y0 = function (e) {
		ae = te(e, Ot());
	},
	ie = {
		addPersonOrSystem: We,
		addPersonOrSystemBoundary: qe,
		addContainer: Qe,
		addContainerBoundary: Ge,
		addComponent: He,
		addDeploymentNode: Ke,
		...
		getBoundaries: Oe,
		getBoundarys: l0,
		getCurrentBoundaryParse: n0,
		getParentBoundaryParse: s0,
		getRels: o0,
		getTitle: c0,
		getC4Type: Ve,
		getC4ShapeInRow: e0,
	...
	Te = function (e, t, a, o, l, i) {
		let s = e.append("image");
		s.attr("width", t), s.attr("height", a), s.attr("x", o), s.attr("y", l);
		let r = i.startsWith("data:image/png;base64") ? i : (0, Ae.sanitizeUrl)(i);
		s.attr("xlink:href", r);
	},
	g0 = (e, t, a) => {
		let o = e.append("g"),
			l = 0;
		for (let i of t) {
			let s = i.textColor ? i.textColor : "#444444",
				r = i.lineColor ? i.lineColor : "#444444",
				n = i.offsetX ? parseInt(i.offsetX) : 0,
				h = i.offsetY ? parseInt(i.offsetY) : 0,
				f = "";
			if (l === 0) {
				let p = o.append("line");
				p.attr("x1", i.startPoint.x),
					p.attr("y1", i.startPoint.y),
					p.attr("x2", i.endPoint.x),
					p.attr("y2", i.endPoint.y),
					p.attr("stroke-width", "1"),
					p.attr("stroke", r),
					p.style("fill", "none"),
					i.type !== "rel_b" &&
						p.attr("marker-end", "url(" + f + "#arrowhead)"),
					(i.type === "birel" || i.type === "rel_b") &&
				...
				p
					...
					.attr(
						...
						"Mstartx,starty Qcontrolx,controly stopx,stopy "
							.replaceAll("startx", i.startPoint.x)
							.replaceAll("starty", i.startPoint.y)
							.replaceAll(
								"controlx",
								i.startPoint.x +
									(i.endPoint.x - i.startPoint.x) / 2 -
									(i.endPoint.x - i.startPoint.x) / 4,
							)
							.replaceAll(
								"controly",
								i.startPoint.y + (i.endPoint.y - i.startPoint.y) / 2,
							)
							.replaceAll("stopx", i.endPoint.x)
							.replaceAll("stopy", i.endPoint.y),
					),
					i.type !== "rel_b" &&
						p.attr("marker-end", "url(" + f + "#arrowhead)"),
					(i.type === "birel" || i.type === "rel_b") &&
			...
			W(a)(
				i.label.text,
				o,
				Math.min(i.startPoint.x, i.endPoint.x) +
					Math.abs(i.endPoint.x - i.startPoint.x) / 2 +
					n,
				Math.min(i.startPoint.y, i.endPoint.y) +
					Math.abs(i.endPoint.y - i.startPoint.y) / 2 +
					h,
				i.label.width,
				i.label.height,
				{ fill: s },
	...
	b0 = function (e, t, a) {
		let o = e.append("g"),
			l = t.bgColor ? t.bgColor : "none",
			i = t.borderColor ? t.borderColor : "#444444",
			s = t.fontColor ? t.fontColor : "black",
			r = { "stroke-width": 1, "stroke-dasharray": "7.0,7.0" };
	...
	_0 = function (e, t, a) {
		var o;
		let l = t.bgColor ? t.bgColor : a[t.typeC4Shape.text + "_bg_color"],
			i = t.borderColor
				? t.borderColor
				: a[t.typeC4Shape.text + "_border_color"],
		...
		let f = O0(a, t.typeC4Shape.text);
		switch (
			(n
				.append("text")
				.attr("fill", s)
				.attr("font-family", f.fontFamily)
				.attr("font-size", f.fontSize - 2)
			...
			case "person":
			case "external_person":
				Te(n, 48, 48, t.x + t.width / 2 - 24, t.y + t.image.Y, r);
				break;
		}
		...
		return (
			...
			(d = a[t.typeC4Shape.text + "Font"]()),
			(d.fontColor = s),
			t.techn && ((o = t.techn) == null ? void 0 : o.text) !== ""
				? W(a)(
						t.techn.text,
						n,
						t.x,
	...
	W = (function () {
		...
		function t(l, i, s, r, n, h, f, d) {
			let { fontSize: p, fontFamily: E, fontWeight: O } = d,
				R = l.split(Bt.lineBreakRegex);
			for (let S = 0; S < R.length; S++) {
				let N = S * p - (p * (R.length - 1)) / 2,
					Y = i
						.append("text")
						.attr("x", s + n / 2)
						.attr("y", r)
		...
		function o(l, i) {
			for (let s in i) i.hasOwnProperty(s) && l.attr(s, i[s]);
		}
		return function (l) {
	...
	F = {
		...
		insertDynamicNumber: C0,
		insertArrowCrossHead: w0,
		insertDatabaseIcon: x0,
	...
	zt = class {
		...
		setData(t, a, o, l) {
			(this.nextData.startx = this.data.startx = t),
				(this.nextData.stopx = this.data.stopx = a),
		...
		insert(t) {
			...
			let a =
				...
				i = l + t.height;
			(a >= this.data.widthLimit ||
				o >= this.data.widthLimit ||
				this.nextData.cnt > Re) &&
				((a = this.nextData.startx + t.margin + b.nextLinePaddingX),
				(l = this.nextData.stopy + t.margin * 2),
				(this.nextData.stopx = o = a + t.width),
				(this.nextData.starty = this.nextData.stopy),
				(this.nextData.stopy = i = l + t.height),
				(this.nextData.cnt = 1)),
				(t.x = a),
				(t.y = l),
				this.updateVal(this.data, "startx", a, Math.min),
				...
				this.updateVal(this.nextData, "startx", a, Math.min),
			...
			e.fontFamily &&
				(b.personFontFamily =
					...
					b.messageFontFamily =
						e.fontFamily),
			e.fontSize &&
				(b.personFontSize = b.systemFontSize = b.messageFontSize = e.fontSize),
			e.fontWeight &&
				(b.personFontWeight =
					b.systemFontWeight =
					b.messageFontWeight =
...
function I(e, t, a, o, l) {
	if (!t[e].width)
		if (a)
			(t[e].text = ge(t[e].text, l, o)),
				(t[e].textLines = t[e].text.split(Bt.lineBreakRegex).length),
				(t[e].width = l),
				(t[e].height = ee(t[e].text, o));
		else {
			let i = t[e].text.split(Bt.lineBreakRegex);
			t[e].textLines = i.length;
			let s = 0;
			(t[e].height = 0), (t[e].width = 0);
			for (let r of i)
				(t[e].width = Math.max(At(r, o), t[e].width)),
					(s = ee(r, o)),
					(t[e].height = t[e].height + s);
		}
}
var De = function (e, t, a) {
		(t.x = a.data.startx),
			(t.y = a.data.starty),
			(t.width = a.data.stopx - a.data.startx),
			(t.height = a.data.stopy - a.data.starty),
			(t.label.y = b.c4ShapeMargin - 35);
		let o = t.wrap && b.wrap,
			l = Yt(b);
		(l.fontSize = l.fontSize + 2), (l.fontWeight = "bold");
		let i = At(t.label.text, l);
	...
	Se = function (e, t, a, o) {
		...
		for (let i of o) {
			l = 0;
			let s = a[i],
				r = St(b, s.typeC4Shape.text);
			switch (
				((r.fontSize = r.fontSize - 2),
				(s.typeC4Shape.width = At("\xAB" + s.typeC4Shape.text + "\xBB", r)),
				(s.typeC4Shape.height = r.fontSize + 2),
				(s.typeC4Shape.Y = b.c4ShapePadding),
				(l = s.typeC4Shape.Y + s.typeC4Shape.height - 4),
			...
			s.sprite &&
				...
				(l = s.image.Y + s.image.height));
			let n = s.wrap && b.wrap,
				h = b.width - b.c4ShapePadding * 2,
				f = St(b, s.typeC4Shape.text);
			if (
				((f.fontSize = f.fontSize + 2),
				(f.fontWeight = "bold"),
				I("label", s, n, f, h),
				(s.label.Y = l + 8),
				(l = s.label.Y + s.label.height),
				s.type && s.type.text !== "")
			) {
				s.type.text = "[" + s.type.text + "]";
				let E = St(b, s.typeC4Shape.text);
				I("type", s, n, E, h),
					(s.type.Y = l + 5),
					(l = s.type.Y + s.type.height);
			} else if (s.techn && s.techn.text !== "") {
				s.techn.text = "[" + s.techn.text + "]";
				let E = St(b, s.techn.text);
				I("techn", s, n, E, h),
					(s.techn.Y = l + 5),
					(l = s.techn.Y + s.techn.height);
			}
			let d = l,
				p = s.label.width;
			if (s.descr && s.descr.text !== "") {
				...
				I("descr", s, n, E, h),
					(s.descr.Y = l + 20),
					(l = s.descr.Y + s.descr.height),
					(p = Math.max(s.label.width, s.descr.width)),
					(d = l - s.descr.textLines * 5);
			}
			(p = p + b.c4ShapePadding),
				(s.width = Math.max(s.width || b.width, p, b.width)),
				(s.height = Math.max(s.height || b.height, d, b.height)),
				(s.margin = s.margin || b.c4ShapeMargin),
				e.insert(s),
				F.drawC4Shape(t, s, b);
		}
		...
		return (
			o == i && a < l
				...
				: o == i && a > l
					? (p = new L(a, r))
					: a == l && o < i
						? (p = new L(s, o + e.height))
						: a == l && o > i && (p = new L(s, o)),
			a > l && o < i
				? d >= f
					? (p = new L(a, r + (f * e.width) / 2))
					: (p = new L(s - ((n / h) * e.height) / 2, o + e.height))
				: a < l && o < i
					? d >= f
						? (p = new L(a + e.width, r + (f * e.width) / 2))
						: (p = new L(s + ((n / h) * e.height) / 2, o + e.height))
					: a < l && o > i
						? d >= f
							? (p = new L(a + e.width, r - (f * e.width) / 2))
							: (p = new L(s + ((e.height / 2) * n) / h, o))
						: a > l &&
							o > i &&
							(d >= f
								? (p = new L(a, r - (e.width / 2) * f))
								: (p = new L(s - ((e.height / 2) * n) / h, o))),
			p
		);
	},
	...
	D0 = function (e, t, a, o) {
		...
		for (let i of t) {
			...
			o.db.getC4Type() === "C4Dynamic" &&
				(i.label.text = l + ": " + i.label.text);
			let h = At(i.label.text, r);
			I("label", i, s, r, h),
				i.techn &&
					i.techn.text !== "" &&
					((h = At(i.techn.text, r)), I("techn", i, s, r, h)),
				i.descr &&
					i.descr.text !== "" &&
					((h = At(i.descr.text, r)), I("descr", i, s, r, h));
			let f = a(i.from),
				d = a(i.to),
				p = R0(f, d);
...
function Pe(e, t, a, o, l) {
	let i = new zt(l);
	i.data.widthLimit = a.data.widthLimit / Math.min(ne, o.length);
	for (let [s, r] of o.entries()) {
		...
		(r.image = { width: 0, height: 0, Y: 0 }),
			r.sprite &&
				...
				(r.image.height = 48),
				(r.image.Y = n),
				(n = r.image.Y + r.image.height));
		let h = r.wrap && b.wrap,
			f = Yt(b);
		if (
			((f.fontSize = f.fontSize + 2),
			(f.fontWeight = "bold"),
			I("label", r, h, f, i.data.widthLimit),
			(r.label.Y = n + 8),
			(n = r.label.Y + r.label.height),
			r.type && r.type.text !== "")
		) {
			r.type.text = "[" + r.type.text + "]";
			let O = Yt(b);
			I("type", r, h, O, i.data.widthLimit),
				(r.type.Y = n + 5),
				(n = r.type.Y + r.type.height);
		}
		if (r.descr && r.descr.text !== "") {
			let O = Yt(b);
			(O.fontSize = O.fontSize - 2),
				I("descr", r, h, O, i.data.widthLimit),
				(r.descr.Y = n + 20),
				(n = r.descr.Y + r.descr.height);
		}
		if (s == 0 || s % ne === 0) {
			let O = a.data.startx + b.diagramMarginX,
				R = a.data.stopy + b.diagramMarginY + n;
			i.setData(O, O, R, R);
		} else {
			let O =
					i.data.stopx !== i.data.startx
						? i.data.stopx + b.diagramMarginX
						: i.data.startx,
				R = i.data.starty;
			i.setData(O, O, R, R);
		}
		i.name = r.alias;
		let d = l.db.getC4ShapeArray(r.alias),
			p = l.db.getC4ShapeKeys(r.alias);
		p.length > 0 && Se(i, e, d, p), (t = r.alias);
		let E = l.db.getBoundarys(t);
		E.length > 0 && Pe(e, t, i, E, l),
			r.alias !== "global" && De(e, r, i),
			(a.data.stopy = Math.max(i.data.stopy + b.c4ShapeMargin, a.data.stopy)),
			(a.data.stopx = Math.max(i.data.stopx + b.c4ShapeMargin, a.data.stopx)),
			(Ft = Math.max(Ft, a.data.stopx)),
			(Vt = Math.max(Vt, a.data.stopy));
	}
}
var S0 = function (e, t, a, o) {
		b = Ot().c4;
		let l = Ot().securityLevel,
			i;
		l === "sandbox" && (i = Dt("#i" + t));
		let s =
				l === "sandbox" ? Dt(i.nodes()[0].contentDocument.body) : Dt("body"),
			r = o.db;
		o.db.setWrap(b.wrap),
			(Re = r.getC4ShapeInRow()),
			(ne = r.getC4BoundaryInRow()),
			$t.debug(`C:${JSON.stringify(b, null, 2)}`);
		let n = l === "sandbox" ? s.select(`[id="${t}"]`) : Dt(`[id="${t}"]`);
		...
		Pe(n, "", h, d, o),
			F.insertArrowHead(n),
			F.insertArrowEnd(n),
			F.insertArrowCrossHead(n),
			F.insertArrowFilledHead(n),
			D0(n, o.db.getRels(), o.db.getC4Shape, o),
			(h.data.stopx = Ft),
			(h.data.stopy = Vt);
		let p = h.data,
			O = p.stopy - p.starty + 2 * b.diagramMarginY,
			S = p.stopx - p.startx + 2 * b.diagramMarginX;
		f &&
			n
				.append("text")
				.text(f)
				.attr("x", (p.stopx - p.startx) / 2 - 4 * b.diagramMarginX)
				.attr("y", p.starty + b.diagramMarginY),
			be(n, O, S, b.useMaxWidth);
		let N = f ? 60 : 0;
		n.attr(
			"viewBox",
			p.startx -
	...
	ke = { drawPersonOrSystemArray: Se, drawBoundary: De, setConf: se, draw: S0 },
	P0 = (e) => `.person {
...
`,
	...
	F0 = {
		...
		styles: M0,
		init: ({ c4: e, wrap: t }) => {
			ke.setConf(e), ie.setWrap(t);
		},
	};
export { F0 as diagram };
