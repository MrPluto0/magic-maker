import { b as V } from "./chunk-LA3PGSPR.js";
import {
	G as P,
	Ga as g,
	I as tt,
...
var Lt = (e, t, a, i) => {
		...
		if ((typeof l == "object" && (l = l[0]), H(b().flowchart.htmlLabels))) {
			...
			for (let n of s) {
				...
				c.setAttributeNS(
					...
					c.setAttribute("x", "0"),
					a
						? c.setAttribute("class", "title-row")
	...
	M = async (e, t, a, i) => {
		let l,
			r = t.useHtmlLabels || H(b().flowchart.htmlLabels);
		...
		t.labelText === void 0
			? (c = "")
			: (c = typeof t.labelText == "string" ? t.labelText : t.labelText[0]);
		let o = n.node(),
			h;
		t.labelType === "markdown"
			...
			: (h = o.appendChild(R(q(U(c), b()), t.labelStyle, !1, i)));
		let y = h.getBBox(),
			f = t.padding / 2;
		if (H(b().flowchart.htmlLabels)) {
			...
			(y = p.getBoundingClientRect()),
				d.attr("width", y.width),
				d.attr("height", y.height);
		}
		return (
			r
				? n.attr(
				...
				: n.attr("transform", "translate(0, " + -y.height / 2 + ")"),
			t.centerLabel &&
				n.attr(
					"transform",
					"translate(" + -y.width / 2 + ", " + -y.height / 2 + ")",
...
function Bt(e, t, a) {
	...
	for (
		var c = i - e.width / 2 - s, o = l - e.height / 2 - n, h = 0;
		h < t.length;
		h++
	) {
		var y = t[h],
			f = t[h < t.length - 1 ? h + 1 : 0],
			p = Tt(e, a, { x: c + y.x, y: o + y.y }, { x: c + f.x, y: o + f.y });
		p && r.push(p);
	}
	return r.length
		? (r.length > 1 &&
...
var Et = (e, t) => {
	...
	Ct = Et,
	w = { node: St, circle: Mt, ellipse: ct, polygon: Bt, rect: Ct },
	$t = async (e, t) => {
		...
		let {
			...
			bbox: l,
			halfPadding: r,
		} = await M(e, t, "node " + t.classes, !0);
		g.info("Classes = ", t.classes);
		let s = i.insert("rect", ":first-child");
		return (
			s
				.attr("rx", t.rx)
				.attr("ry", t.ry)
	...
	at = (e) => (e ? " " + e : ""),
	_ = (e, t) => `${t || "node default"}${at(e.classes)} ${at(e.class)}`,
	et = async (e, t) => {
		let { shapeSvg: a, bbox: i } = await M(e, t, _(t, void 0), !0),
			l = i.width + t.padding,
	...
	Ot = async (e, t) => {
		let { shapeSvg: a, bbox: i } = await M(e, t, void 0, !0),
			l = 2,
			r = i.height + 2 * t.padding,
			s = r / l,
			n = i.width + 2 * s + t.padding,
			c = Ht(t.directions, i, t),
			o = I(a, n, r, c);
		return (
			o.attr("style", t.style),
			m(t, o),
	...
	Xt = async (e, t) => {
		let { shapeSvg: a, bbox: i } = await M(e, t, _(t), !0),
			l = i.width + t.padding,
			r = i.height + t.padding,
			s = [
				{ x: (-2 * r) / 6, y: 0 },
	...
	zt = async (e, t) => {
		let {
				...
				bbox: i,
				halfPadding: l,
			} = await M(e, t, "node " + t.classes + " " + t.class, !0),
		...
		if (
			...
			t.props.borders && (J(r, t.props.borders, s, n), h.delete("borders")),
				h.forEach((y) => {
	...
	Gt = async (e, t) => {
		let { shapeSvg: a } = await M(e, t, "label", !0);
		g.trace("Classes = ", t.class);
		let i = a.insert("rect", ":first-child"),
			l = 0,
			r = 0;
		if (
			(i.attr("width", l).attr("height", r),
			a.attr("class", "label edgeLabel"),
			t.props)
		) {
			let s = new Set(Object.keys(t.props));
			t.props.borders && (J(i, t.props.borders, l, r), s.delete("borders")),
				s.forEach((n) => {
...
var Ft = (e, t) => {
		...
		typeof n == "object" ? (c = n[0]) : (c = n),
			g.info("Label text abc79", c, n, typeof n == "object");
		let o = s.node().appendChild(R(c, t.labelStyle, !0, !0)),
			h = { width: 0, height: 0 };
		if (H(b().flowchart.htmlLabels)) {
			let k = o.children[0],
				x = T(o);
			(h = k.getBoundingClientRect()),
				x.attr("width", h.width),
				x.attr("height", h.height);
		}
		g.info("Text 2", n);
		let y = n.slice(1, n.length),
			f = o.getBBox(),
			p = s
				.node()
				.appendChild(R(y.join ? y.join("<br/>") : y, t.labelStyle, !0, !0));
		if (H(b().flowchart.htmlLabels)) {
			let k = p.children[0],
				x = T(p);
			(h = k.getBoundingClientRect()),
		...
		return (
			T(p).attr(
				"transform",
				"translate( " +
					(h.width > f.width ? 0 : (f.width - h.width) / 2) +
					", " +
					(f.height + d + 5) +
					")",
			),
	...
	Vt = async (e, t) => {
		...
		return (
			...
			(t.intersect = function (s) {
				return (
					g.info("Circle intersect", t, i.width / 2 + l, s),
					w.circle(t, i.width / 2 + l, s)
				);
			}),
			a
		);
	...
	qt = async (e, t) => {
		...
		return (
			...
			(t.intersect = function (o) {
				return (
					g.info("DoubleCircle intersect", t, i.width / 2 + l + r, o),
					w.circle(t, i.width / 2 + l + r, o)
				);
			}),
			a
		);
	...
	tr = (e, t) => {
		...
		let s = e
			...
			h = 0,
			y = i,
			f = s.insert("g").attr("class", "label"),
			p = 0,
			d = t.classData.annotations && t.classData.annotations[0],
			k = t.classData.annotations[0]
		...
		if (H(b().flowchart.htmlLabels)) {
			...
			(u = v.getBoundingClientRect()),
				L.attr("width", u.width),
				L.attr("height", u.height);
		}
		...
		t.classData.type !== void 0 &&
			...
			(b().flowchart.htmlLabels
				? (S += "&lt;" + t.classData.type + "&gt;")
				: (S += "<" + t.classData.type + ">"));
		let E = f.node().appendChild(R(S, t.labelStyle, !0, !0));
		T(E).attr("class", "classTitle");
		let C = E.getBBox();
		if (H(b().flowchart.htmlLabels)) {
			let v = E.children[0],
				L = T(E);
			(C = v.getBoundingClientRect()),
				L.attr("width", C.width),
				L.attr("height", C.height);
		}
		(y += C.height + i), C.width > h && (h = C.width);
		let W = [];
		t.classData.members.forEach((v) => {
			let L = v.getDisplayDetails(),
				X = L.displayText;
			b().flowchart.htmlLabels &&
				(X = X.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
			let N = f
					.node()
					.appendChild(R(X, L.cssStyle ? L.cssStyle : t.labelStyle, !0, !0)),
				$ = N.getBBox();
			if (H(b().flowchart.htmlLabels)) {
				let Q = N.children[0],
					j = T(N);
	...
	pr = async (e, t, a) => {
		...
		if (t.link) {
			let r;
			b().securityLevel === "sandbox"
				? (r = "_top")
				: t.linkTarget && (r = t.linkTarget || "_blank"),
				(i = e.insert("svg:a").attr("xlink:href", t.link).attr("target", r)),
				(l = await it[t.shape](i, t, a));
		} else (l = await it[t.shape](e, t, a)), (i = l);
		return (
			...
			(D[t.id] = i),
			t.haveCallback &&
				D[t.id].attr("class", D[t.id].attr("class") + " clickable"),
			i
		);
	},
	fr = (e, t) => {
	...
	rr = ({ flowchart: e }) => {
		var t, a;
		let i = ((t = e?.subGraphTitleMargin) == null ? void 0 : t.top) ?? 0,
			l = ((a = e?.subGraphTitleMargin) == null ? void 0 : a.bottom) ?? 0,
			r = i + l;
		return {
...
var G = (e) => (Array.isArray(e) ? { x: e[0], y: e[1] } : e),
	ar = (e) => ({
		...
		y: function (t, a, i) {
			let l = 0;
			if (a === 0 && Object.hasOwn(O, e.arrowTypeStart)) {
				let { angle: r, deltaY: s } = z(i[0], i[1]);
				l = O[e.arrowTypeStart] * Math.abs(Math.sin(r)) * (s >= 0 ? 1 : -1);
			} else if (a === i.length - 1 && Object.hasOwn(O, e.arrowTypeEnd)) {
				let { angle: r, deltaY: s } = z(i[i.length - 1], i[i.length - 2]);
	...
	er = (e, t, a, i, l) => {
		t.arrowTypeStart && nt(e, "start", t.arrowTypeStart, a, i, l),
			t.arrowTypeEnd && nt(e, "end", t.arrowTypeEnd, a, i, l);
	},
	sr = {
		arrow_cross: "cross",
		arrow_point: "point",
	...
	ur = (e, t) => {
		let a = H(b().flowchart.htmlLabels),
			i =
				t.labelType === "markdown"
					? V(e, t.label, {
							style: t.labelStyle,
		...
		if (a) {
			...
			(s = c.getBoundingClientRect()),
				o.attr("width", s.width),
				o.attr("height", s.height);
		}
		r.attr(
			"transform",
		...
		let n;
		if (t.startLabelLeft) {
			let c = R(t.startLabelLeft, t.labelStyle),
		...
		if (t.startLabelRight) {
			let c = R(t.startLabelRight, t.labelStyle),
				o = e.insert("g").attr("class", "edgeTerminals"),
				h = o.insert("g").attr("class", "inner");
		...
		if (t.endLabelLeft) {
			let c = R(t.endLabelLeft, t.labelStyle),
				o = e.insert("g").attr("class", "edgeTerminals"),
				h = o.insert("g").attr("class", "inner");
			n = h.node().appendChild(c);
			let y = c.getBBox();
		...
		if (t.endLabelRight) {
			let c = R(t.endLabelRight, t.labelStyle),
				o = e.insert("g").attr("class", "edgeTerminals"),
				h = o.insert("g").attr("class", "inner");
			n = h.node().appendChild(c);
			let y = c.getBBox();
...
var br = (e, t) => {
		...
		let a = t.updatedPath ? t.updatedPath : t.originalPath,
			i = b(),
			{ subGraphTitleTotalMargin: l } = rr(i);
		if (e.label) {
			let r = F[e.id],
				s = e.x,
				n = e.y;
			if (a) {
				let c = Y.calcLabelPosition(a);
				g.debug(
		...
		if (e.startLabelLeft) {
			let r = B[e.id].startLeft,
				s = e.x,
				n = e.y;
			if (a) {
				let c = Y.calcTerminalLabelPosition(
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
		...
		if (Math.abs(l - t.y) * s > Math.abs(i - t.x) * c) {
			...
			return (
				g.debug(`sides calc abc89, Q ${o}, q ${y}, R ${h}, r ${n}`, {
					_x: f,
					_y: p,
				}),
				n === 0 && ((f = t.x), (p = t.y)),
	...
	wr = function (e, t, a, i, l, r, s) {
		...
		h?.intersect &&
			...
			n.unshift(o.intersect(n[0])),
			n.push(h.intersect(n[n.length - 1]))),
			a.toCluster &&
				(g.debug("to cluster abc88", i[a.toCluster]),
				(n = lt(a.points, i[a.toCluster].node)),
				(c = !0)),
			a.fromCluster &&
				(g.debug("from cluster abc88", i[a.fromCluster]),
				(n = lt(n.reverse(), i[a.fromCluster].node).reverse()),
				(c = !0));
		let y = n.filter((C) => !Number.isNaN(C.y)),
			f = tt;
