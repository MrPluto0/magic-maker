...
var i = {
		...
		selectAllElementsInFrame:
			"S\xE9lectionner tous les \xE9l\xE9ments du cadre",
	...
	t = {
		...
		hint_emptyLibrary:
			"S\xE9lectionnez un \xE9l\xE9ment sur le canevas pour l'ajouter ici ou installez une biblioth\xE8que depuis le d\xE9p\xF4t public, ci-dessous.",
		hint_emptyPrivateLibrary:
			"S\xE9lectionnez un \xE9l\xE9ment sur le canevas pour l'ajouter ici.",
	},
	o = {
	...
	n = {
		clearReset:
			"L'int\xE9gralit\xE9 du canevas va \xEAtre effac\xE9e. \xCAtes-vous s\xFBr ?",
		couldNotCreateShareableLink: "Impossible de cr\xE9er un lien de partage.",
		couldNotCreateShareableLinkTooBig:
			"Impossible de cr\xE9er un lien de partage : la sc\xE8ne est trop volumineuse",
		...
		uploadedSecurly:
			"Le t\xE9l\xE9chargement a \xE9t\xE9 s\xE9curis\xE9 avec un chiffrement de bout en bout, ce qui signifie que ni Excalidraw ni personne d'autre ne peut en lire le contenu.",
		loadSceneOverridePrompt:
			"Le chargement d'un dessin externe remplacera votre contenu actuel. Souhaitez-vous continuer ?",
...
(Si vous voulez garder votre dessin local, fermez simplement l'onglet du navigateur \xE0 la place.)`,
		errorAddingToLibrary:
			"Impossible d'ajouter l'\xE9l\xE9ment \xE0 la biblioth\xE8que",
		errorRemovingFromLibrary:
			"Impossible de retirer l'\xE9l\xE9ment de la biblioth\xE8que",
		confirmAddLibrary:
			"Cela va ajouter {{numShapes}} forme(s) \xE0 votre biblioth\xE8que. \xCAtes-vous s\xFBr\xB7e ?",
		imageDoesNotContainScene:
			"Cette image ne semble pas contenir de donn\xE9es de sc\xE8ne. Avez-vous activ\xE9 l'int\xE9gration de sc\xE8ne lors de l'exportation ?",
		cannotRestoreFromImage:
			"Impossible de restaurer la sc\xE8ne depuis ce fichier image",
		invalidSceneUrl:
			"Impossible d'importer la sc\xE8ne depuis l'URL fournie. Elle est soit incorrecte, soit ne contient pas de donn\xE9es JSON Excalidraw valides.",
		resetLibrary:
			"Cela va effacer votre biblioth\xE8que. \xCAtes-vous s\xFBr\xB7e ?",
		removeItemsFromsLibrary:
			"Supprimer {{count}} \xE9l\xE9ment(s) de la biblioth\xE8que\xA0?",
		invalidEncryptionKey:
			"La cl\xE9 de chiffrement doit comporter 22 caract\xE8res. La collaboration en direct est d\xE9sactiv\xE9e.",
...
Vos modifications ne seront pas enregistr\xE9es !`,
	...
	a = {
		...
		imageInsertError:
			"Impossible d'ins\xE9rer l'image. R\xE9essayez plus tard...",
		fileTooBig:
			"Le fichier est trop volumineux. La taille maximale autoris\xE9e est de {{maxSize}}.",
		svgImageInsertError:
			"Impossible d'ins\xE9rer l'image SVG. Le balisage SVG semble invalide.",
		failedToFetchImage: "\xC9chec de r\xE9cup\xE9ration de l'image.",
		invalidSVGString: "SVG invalide.",
		cannotResolveCollabServer:
			"Impossible de se connecter au serveur collaboratif. Veuillez recharger la page et r\xE9essayer.",
		importLibraryError: "Impossible de charger la biblioth\xE8que",
		collabSaveFailed:
			"Impossible d'enregistrer dans la base de donn\xE9es en arri\xE8re-plan. Si des probl\xE8mes persistent, vous devriez enregistrer votre fichier localement pour vous assurer de ne pas perdre votre travail.",
		collabSaveFailed_sizeExceeded:
			"Impossible d'enregistrer dans la base de donn\xE9es en arri\xE8re-plan, le tableau semble trop grand. Vous devriez enregistrer le fichier localement pour vous assurer de ne pas perdre votre travail.",
		imageToolNotSupported: "Les images sont d\xE9sactiv\xE9es.",
		brave_measure_text_error: {
			line1:
				"On dirait que vous utilisez le navigateur Brave avec l'option <bold>Bloquer agressivement le fichage</bold> activ\xE9e.",
			line2:
				"Cela pourrait entra\xEEner des probl\xE8mes avec les <bold>\xC9l\xE9ments Textuels</bold> dans vos dessins.",
			line3:
				"Nous recommandons fortement de d\xE9sactiver cette option. Vous pouvez suivre <link>ces instructions</link> pour savoir comment faire.",
			line4:
				"Si d\xE9sactiver cette option de r\xE9sout pas le probl\xE8me d'affichage des \xE9l\xE9ments textuels, veuillez ouvrir un <issueLink>ticket</issueLink> sur notre GitHub, ou \xE9crivez-nous sur notre <discordLink>Discord</discordLink>",
		},
		libraryElementTypeError: {
			embeddable:
				"Les \xE9l\xE9ments int\xE9gr\xE9s ne peuvent pas \xEAtre ajout\xE9s \xE0 la librairie.",
			iframe: "",
			image:
				"Le support pour l'ajout d'images \xE0 la librairie arrive bient\xF4t\xA0!",
		},
		asyncPasteFailedOnRead:
			"Impossible de coller (impossible de lire le presse-papiers syst\xE8me).",
	...
	u = {
		canvasPanning:
			"Pour d\xE9placer la zone de dessin, maintenez la molette de la souris enfonc\xE9e ou la barre d'espace tout en faisant glisser, ou utiliser l'outil main.",
		linearElement:
			"Cliquez pour d\xE9marrer plusieurs points, faites glisser pour une seule ligne",
		freeDraw:
			"Cliquez et faites glissez, rel\xE2chez quand vous avez termin\xE9",
		text: "Astuce : vous pouvez aussi ajouter du texte en double-cliquant n'importe o\xF9 avec l'outil de s\xE9lection",
		embeddable:
			"Cliquez et glissez pour cr\xE9er une int\xE9gration de site web",
		text_selected:
			"Double-cliquez ou appuyez sur ENTR\xC9E pour modifier le texte",
		text_editing:
			"Appuyez sur \xC9CHAP ou Ctrl/Cmd+ENTR\xC9E pour terminer l'\xE9dition",
		linearElementMulti:
			"Cliquez sur le dernier point ou appuyez sur \xC9chap ou Entr\xE9e pour terminer",
		lockAngle: "Vous pouvez restreindre l'angle en maintenant MAJ",
		resize:
			"Vous pouvez conserver les proportions en maintenant la touche MAJ pendant le redimensionnement, maintenez la touche ALT pour redimensionner par rapport au centre",
		resizeImage: `Vous pouvez redimensionner librement en maintenant SHIFT,
maintenez ALT pour redimensionner depuis le centre`,
		rotate:
			"Vous pouvez restreindre les angles en maintenant MAJ pendant la rotation",
		lineEditor_info:
			"Maintenez CtrlOrCmd et Double-cliquez ou appuyez sur CtrlOrCmd + Entr\xE9e pour modifier les points",
		lineEditor_pointSelected:
			"Appuyer sur Suppr. pour supprimer des points, Ctrl ou Cmd+D pour dupliquer, ou faire glisser pour d\xE9placer",
...
ou maintenir la touche Alt enfonc\xE9e et cliquer pour ajouter de nouveaux points`,
		placeImage:
			"Cliquez pour placer l'image, ou cliquez et faites glisser pour d\xE9finir sa taille manuellement",
		publishLibrary: "Publier votre propre biblioth\xE8que",
		bindTextToElement: "Appuyer sur Entr\xE9e pour ajouter du texte",
		deepBoxSelect:
			"Maintenir Ctrl ou Cmd pour s\xE9lectionner dans les groupes et emp\xEAcher le d\xE9placement",
		eraserRevert:
			"Maintenez Alt enfonc\xE9 pour annuler les \xE9l\xE9ments marqu\xE9s pour suppression",
	...
	d = {
		...
		canvasTooBigTip:
			"Astuce : essayez de rapprocher un peu les \xE9l\xE9ments les plus \xE9loign\xE9s.",
	},
	c = {
		headingMain:
			"Une erreur est survenue. Essayez <button>de recharger la page.</button>",
		clearCanvasMessage:
			"Si le rechargement ne r\xE9sout pas l'erreur, essayez <button>effacement du canevas.</button>",
		clearCanvasCaveat: " Cela entra\xEEnera une perte du travail ",
		trackedToSentry:
			"L'erreur avec l'identifiant {{eventId}} a \xE9t\xE9 enregistr\xE9e dans notre syst\xE8me.",
		openIssueMessage:
			"Nous avons fait tr\xE8s attention \xE0 ne pas inclure les informations de votre sc\xE8ne dans l'erreur. Si votre sc\xE8ne n'est pas priv\xE9e, veuillez envisager de poursuivre sur notre <button>outil de suivi des bugs.</button> Veuillez inclure les informations ci-dessous en les copiant-collant dans le ticket GitHub.",
		sceneContent: "Contenu de la sc\xE8ne :",
	},
	p = {
		desc_intro:
			"Vous pouvez inviter des personnes \xE0 collaborer avec vous sur votre sc\xE8ne actuelle.",
		desc_privacy:
			"Pas d'inqui\xE9tude, la session utilise le chiffrement de bout en bout, donc tout ce que vous dessinez restera priv\xE9. M\xEAme notre serveur ne pourra voir ce que vous faites.",
		button_startSession: "D\xE9marrer la session",
		button_stopSession: "Arr\xEAter la session",
		desc_inProgressIntro:
			"La session de collaboration en direct est maintenant en cours.",
		desc_shareLink:
			"Partagez ce lien avec les personnes avec lesquelles vous souhaitez collaborer :",
		desc_exitSession:
			"Arr\xEAter la session vous d\xE9connectera de la salle, mais vous pourrez continuer \xE0 travailler avec la sc\xE8ne, localement. Notez que cela n'affectera pas les autres personnes, et ils pourront toujours collaborer sur leur version.",
		shareTitle:
			"Rejoindre une session de collaboration en direct sur Excalidraw",
	},
	m = { title: "Erreur" },
	b = {
		disk_title: "Enregistrer sur le disque",
		disk_details:
			"Exporter les donn\xE9es de la sc\xE8ne comme un fichier que vous pourrez importer ult\xE9rieurement.",
		...
		excalidrawplus_description:
			"Enregistrer la sc\xE8ne dans votre espace de travail Excalidraw+.",
		excalidrawplus_button: "Exporter",
		excalidrawplus_exportError:
			"Impossible d'exporter vers Excalidraw+ pour le moment...",
	},
	g = {
		...
		deepBoxSelect:
			"S\xE9lectionner dans les groupes, et emp\xEAcher le d\xE9placement",
	...
	v = { title: "Effacer la zone de dessin" },
	h = {
		...
		placeholder: {
			...
			libraryDesc:
				"Description de votre biblioth\xE8que pour aider les gens \xE0 comprendre son usage",
			githubHandle:
				"Nom d'utilisateur GitHub (optionnel), pour que tu puisses modifier la biblioth\xE8que une fois soumise pour v\xE9rification",
			twitterHandle:
				"Nom d'utilisateur Twitter (optionnel), pour savoir qui cr\xE9diter lors de la promotion sur Twitter",
			website: "Lien vers votre site web personnel ou autre (optionnel)",
		},
		errors: { required: "Requis", website: "Entrer une URL valide" },
		noteDescription:
			"Soumets ta biblioth\xE8que pour l'inclure au <link>d\xE9p\xF4t de biblioth\xE8que publique</link>pour permettre son utilisation par autrui dans leurs dessins.",
		noteGuidelines:
			"La biblioth\xE8que doit d'abord \xEAtre approuv\xE9e manuellement. Veuillez lire les <link>lignes directrices</link> avant de la soumettre. Vous aurez besoin d'un compte GitHub pour communiquer et apporter des modifications si demand\xE9, mais ce n'est pas obligatoire.",
		noteLicense:
			"En soumettant, vous acceptez que la biblioth\xE8que soit publi\xE9e sous la <link>Licence MIT, </link>ce qui en gros signifie que tout le monde peut l'utiliser sans restrictions.",
		noteItems:
			"Chaque \xE9l\xE9ment de la biblioth\xE8que doit avoir son propre nom afin qu'il soit filtrable. Les \xE9l\xE9ments de biblioth\xE8que suivants seront inclus :",
		atleastOneLibItem:
			"Veuillez s\xE9lectionner au moins un \xE9l\xE9ment de biblioth\xE8que pour commencer",
		republishWarning:
			"Remarque : certains des \xE9l\xE9ments s\xE9lectionn\xE9s sont marqu\xE9s comme \xE9tant d\xE9j\xE0 publi\xE9s/soumis. Vous devez uniquement resoumettre des \xE9l\xE9ments lors de la mise \xE0 jour d'une biblioth\xE8que ou d'une soumission existante.",
	},
	f = {
		title: "Biblioth\xE8que soumise",
		content:
			"Merci {{authorName}}. Votre biblioth\xE8que a \xE9t\xE9 soumise pour examen. Vous pouvez suivre le statut<link>ici</link>",
	},
	x = {
		resetLibrary: "R\xE9initialiser la biblioth\xE8que",
		removeItemsFromLib:
			"Enlever les \xE9l\xE9ments s\xE9lectionn\xE9s de la biblioth\xE8que",
	},
	S = {
...
Cela augmentera la taille du fichier export\xE9.`,
	...
	C = {
		tooltip:
			"Vos dessins sont chiffr\xE9s de bout en bout, les serveurs d'Excalidraw ne les verront jamais.",
...
ou coller dans un \xE9diteur de texte existant`,
		unableToEmbed:
			"Int\xE9grer cet URL n'est actuellement pas autoris\xE9. Ouvrez un ticket sur GitHub pour demander son ajout \xE0 la liste blanche",
		unrecognizedLinkFormat:
			"Le lien que vous avez int\xE9gr\xE9 ne correspond pas au format attendu. Veuillez essayer de coller la cha\xEEne d'int\xE9gration fournie par le site source",
	},
	E = {
	...
	q = {
		app: {
			center_heading:
				"Toutes vos donn\xE9es sont sauvegard\xE9es en local dans votre navigateur.",
			center_heading_plus:
				"Vouliez-vous plut\xF4t aller \xE0 Excalidraw+\xA0\xE0 la place ?",
	...
	L = {
		mostUsedCustomColors:
			"Couleurs personnalis\xE9es les plus fr\xE9quemment utilis\xE9es",
		colors: "Couleurs",
		shades: "Nuances",
		hexCode: "Code hex",
	...
	A = {
		action: {
			exportToImage: {
				...
				description:
					"Exporter les donn\xE9es de la sc\xE8ne comme une image que vous pourrez importer ult\xE9rieurement.",
			},
			saveToDisk: {
		...
		modal: {
			loadFromFile: {
				...
				description:
					"Charger depuis un fichier va <bold>remplacer votre contenu existant</bold>.<br></br>Vous pouvez d'abord sauvegarder votre dessin en utilisant l'une des options ci-dessous.",
			},
			shareableLink: {
				title: "Charger depuis un lien",
				button: "Remplacer mon contenu",
				description:
					"Charger un dessin externe va <bold>remplacer votre contenu existant</bold>.<br></br>Vous pouvez d'abord sauvegarder votre dessin en utilisant l'une des options ci-dessous.",
			},
		},
	},
	T = {
