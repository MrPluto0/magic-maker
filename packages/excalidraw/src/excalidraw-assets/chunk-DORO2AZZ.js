...
import { a as Xt } from "./chunk-M2JW2GFW.js";
Xt();
var At = (function () {
	var e = function (f1, a, o, f) {
		...
		n = [1, 5],
		c = [
			1, 8, 9, 10, 11, 27, 34, 36, 38, 42, 58, 81, 82, 83, 84, 85, 86, 99, 102,
			103, 106, 108, 111, 112, 113, 118, 119, 120, 121,
		],
		l = [2, 2],
		h = [1, 13],
		U = [1, 14],
		...
		M = [
			8, 9, 10, 11, 29, 42, 44, 46, 48, 50, 52, 54, 56, 58, 61, 63, 65, 66, 68,
			73, 75, 86, 99, 102, 103, 106, 108, 111, 112, 113,
		],
		Et = [8, 9, 11, 42, 58, 73, 75, 86, 99, 102, 103, 106, 108, 111, 112, 113],
		N1 = [42, 58, 86, 99, 102, 103, 106, 108, 111, 112, 113],
		kt = [1, 121],
		bt = [1, 120],
		gt = [1, 128],
		Dt = [1, 142],
		...
		Ut = [1, 131],
		at = [
			8, 9, 10, 11, 27, 32, 34, 36, 38, 42, 58, 81, 82, 83, 84, 85, 86, 99, 102,
			103, 106, 108, 111, 112, 113, 118, 119, 120, 121,
		],
		Gt = [1, 149],
		T = [8, 9, 11],
		...
		m1 = [75, 113, 116],
		g = [
			8, 9, 10, 11, 12, 14, 27, 29, 32, 42, 58, 73, 81, 82, 83, 84, 85, 86, 87,
		...
		y1 = [1, 255],
		Kt = [8, 9, 11, 103],
		q = [8, 9, 10, 11, 58, 81, 102, 103, 106, 107, 108, 109],
		ct = {
			trace: function () {},
			yy: {},
			symbols_: {
			...
			performAction: function (a, o, f, r, S, t, w1) {
				var s = t.length - 1;
				switch (S) {
					case 2:
						this.$ = [];
						break;
					case 3:
						(!Array.isArray(t[s]) || t[s].length > 0) && t[s - 1].push(t[s]),
							(this.$ = t[s - 1]);
						break;
					case 4:
					case 176:
					...
					case 39:
						...
						break;
					case 43:
						r.addLink(t[s - 2].stmt, t[s], t[s - 1]),
							(this.$ = { stmt: t[s], nodes: t[s].concat(t[s - 2].nodes) });
						break;
					case 44:
						r.addLink(t[s - 3].stmt, t[s - 1], t[s - 2]),
							(this.$ = {
								stmt: t[s - 1],
					...
					case 52:
						(this.$ = t[s - 3]),
							r.addVertex(t[s - 3], t[s - 1], "doublecircle");
						break;
					case 53:
					...
					case 57:
						(this.$ = t[s - 7]),
							r.addVertex(
								...
								void 0,
								void 0,
								Object.fromEntries([[t[s - 5], t[s - 3]]]),
							);
						break;
					case 58:
					...
					case 64:
						(this.$ = t[s - 3]),
							r.addVertex(t[s - 3], t[s - 1], "inv_trapezoid");
						break;
					case 65:
					...
					case 109:
						(this.$ = t[s - 3]),
							r.setClickEvent(t[s - 3], t[s - 2]),
							r.setTooltip(t[s - 3], t[s]);
						break;
					case 102:
					...
					case 103:
						(this.$ = t[s - 4]),
							r.setClickEvent(t[s - 4], t[s - 3], t[s - 2]),
							r.setTooltip(t[s - 4], t[s]);
						break;
					case 104:
					...
					case 107:
						(this.$ = t[s - 6]),
							r.setLink(t[s - 6], t[s - 4], t[s]),
							r.setTooltip(t[s - 6], t[s - 2]);
						break;
					case 110:
					...
					case 113:
						(this.$ = t[s - 5]),
							r.setLink(t[s - 5], t[s - 4], t[s]),
							r.setTooltip(t[s - 5], t[s - 2]);
						break;
					case 114:
					...
					case 117:
						(this.$ = t[s - 8]),
							r.updateLinkInterpolate([t[s - 6]], t[s - 2]),
							r.updateLink([t[s - 6]], t[s]);
						break;
					case 118:
						(this.$ = t[s - 8]),
							r.updateLinkInterpolate(t[s - 6], t[s - 2]),
			...
			table: [
				...
				e(c, [2, 10]),
				e(c, [2, 11]),
				{ 8: [1, 54], 9: [1, 55], 10: R1, 15: 53, 18: 56 },
				e(b, [2, 3]),
				e(b, [2, 4]),
				e(b, [2, 5]),
				e(b, [2, 6]),
				e(b, [2, 7]),
				e(b, [2, 8]),
				{ 8: W, 9: Q, 11: Z, 21: 58, 39: 59, 70: 63, 73: [1, 64], 75: [1, 65] },
				{ 8: W, 9: Q, 11: Z, 21: 66 },
				{ 8: W, 9: Q, 11: Z, 21: 67 },
				{ 8: W, 9: Q, 11: Z, 21: 68 },
				{ 8: W, 9: Q, 11: Z, 21: 69 },
				{ 8: W, 9: Q, 11: Z, 21: 70 },
				{ 8: W, 9: Q, 10: [1, 71], 11: Z, 21: 72 },
				e(b, [2, 36]),
				{ 35: [1, 73] },
				{ 37: [1, 74] },
				e(b, [2, 39]),
				e(W1, [2, 46], { 18: 75, 10: R1 }),
				{ 10: [1, 76] },
				{ 10: [1, 77] },
				{ 10: [1, 78] },
				{ 10: [1, 79] },
				...
				e(b, [2, 41]),
				e(b, [2, 42]),
				e(N1, [2, 71], { 71: 113, 60: [1, 115], 72: [1, 114] }),
			...
			parse: function (a) {
				...
				var ht = _.yylloc;
				t.push(ht);
				var we = _.options && _.options.ranges;
				typeof d1.yy.parseError == "function"
					? (this.parseError = d1.yy.parseError)
				...
				function Oe() {
					...
					return (
						(a1 = r.pop() || _.lex() || jt),
						typeof a1 != "number" &&
							(a1 instanceof Array && ((r = a1), (a1 = r.pop())),
							(a1 = o.symbols_[a1] || a1)),
						a1
					);
				}
				for (var G, E1, j, ft, v1 = {}, Z1, n1, zt, J1; ; ) {
					if (
						((E1 = f[f.length - 1]),
						this.defaultActions[E1]
							? (j = this.defaultActions[E1])
							: ((G === null || typeof G > "u") && (G = Oe()),
								(j = w1[E1] && w1[E1][G])),
						...
						case 2:
							if (
								...
								(ft = this.performAction.apply(
									v1,
									[s, Yt, Y, d1.yy, j[1], S, t].concat(Ne),
								)),
								typeof ft < "u")
							)
								return ft;
							n1 &&
								...
								S.push(v1.$),
								t.push(v1._$),
								(zt = w1[f[f.length - 2]][f[f.length - 1]]),
								f.push(zt);
							break;
						case 3:
							return !0;
				...
				unput: function (a) {
					...
					return (
						(this.yylloc = {
							...
							last_column: f
								? (f.length === r.length ? this.yylloc.first_column : 0) +
									r[r.length - f.length].length -
									f[0].length
...
` +
				...
				next: function () {
					...
					for (var S = this._currentRules(), t = 0; t < S.length; t++)
						if (
							((f = this._input.match(this.rules[S[t]])),
							f && (!o || f[0].length > o[0].length))
						) {
							if (((o = f), (r = t), this.options.backtrack_lexer)) {
								if (((a = this.test_match(f, S[t])), a !== !1)) return a;
								if (this._backtrack) {
									o = !1;
									continue;
								} else return !1;
					...
					return o
						? ((a = this.test_match(o, S[r])), a !== !1 ? a : !1)
						: this._input === ""
							? this.EOF
							: this.parseError(
									"Lexical error on line " +
...
` +
				...
				options: {},
				performAction: function (o, f, r, S) {
					switch (r) {
						case 0:
				...
				conditions: {
					...
					trapText: {
						rules: [
							15, 18, 70, 73, 75, 77, 81, 83, 84, 85, 86, 87, 88, 101, 103, 105,
							107,
						],
						inclusive: !1,
					},
					...
					text: {
						rules: [
							15, 18, 70, 73, 74, 75, 76, 77, 80, 81, 82, 83, 87, 88, 100, 101,
					...
					acc_descr_multiline: {
						rules: [
							5, 6, 15, 18, 70, 73, 75, 77, 81, 83, 87, 88, 101, 103, 105, 107,
						],
						inclusive: !1,
					},
					acc_descr: {
					...
					INITIAL: {
						rules: [
							...
							87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 101, 103, 105,
							107, 109, 110, 111, 112,
						],
						inclusive: !0,
					},
...
var We = At,
	...
	ut,
	it = [],
	rt = (e) => Ht.sanitizeText(e, I1),
	G1 = function (e) {
		let u = Object.keys(D);
		for (let i of u) if (D[i].id === e) return D[i].domId;
		return e;
	},
	ue = function (e, u, i, n, c, l, h = {}) {
		let U,
			F = e;
		F !== void 0 &&
			F.trim().length !== 0 &&
			...
			D[F].props === void 0
				? (D[F].props = h)
				: h !== void 0 && Object.assign(D[F].props, h));
	},
	ie = function (e, u, i) {
		let l = { start: e, end: u, type: void 0, text: "", labelType: "text" };
		O1.info("abc78 Got edge...", l);
		let h = i.text;
		if (
			(h !== void 0 &&
				((l.text = rt(h.text.trim())),
				l.text[0] === '"' &&
					l.text[l.text.length - 1] === '"' &&
					(l.text = l.text.substring(1, l.text.length - 1)),
				(l.labelType = h.type)),
			i !== void 0 &&
				((l.type = i.type), (l.stroke = i.stroke), (l.length = i.length)),
			l?.length > 10 && (l.length = 10),
			H.length < (I1.maxEdges ?? 500))
		)
			O1.info("abc78 pushing edge..."), H.push(l);
		else
			throw new Error(`Edge limit exceeded. ${H.length} edges found, but the limit is ${I1.maxEdges}.
...
You have to call mermaid.initialize.`);
	...
	re = function (e, u, i) {
		O1.info("addLink (abc78)", e, u, i);
		let n, c;
		for (n = 0; n < e.length; n++)
			for (c = 0; c < u.length; c++) ie(e[n], u[c], i);
	},
	ne = function (e, u) {
	...
	ae = function (e, u) {
		e.forEach(function (i) {
			...
			i === "default"
				? (H.defaultStyle = u)
				: ($1.isSubstringInArray("fill", u) === -1 && u.push("fill:none"),
					(H[i].style = u));
		});
	},
	ce = function (e, u) {
		e.split(",").forEach(function (i) {
			L1[i] === void 0 && (L1[i] = { id: i, styles: [], textStyles: [] }),
				u?.forEach(function (n) {
					if (n.match("color")) {
						let c = n.replace("fill", "bgFill").replace("color", "fill");
						L1[i].textStyles.push(c);
					}
					L1[i].styles.push(n);
				});
		});
	...
	nt = function (e, u) {
		e.split(",").forEach(function (i) {
			let n = i;
			D[n] !== void 0 && D[n].classes.push(u),
				et[n] !== void 0 && et[n].classes.push(u);
		});
	},
	Ue = function (e, u) {
		e.split(",").forEach(function (i) {
			u !== void 0 && (st[ut === "gen-1" ? G1(i) : i] = rt(u));
		});
	},
	Ge = function (e, u, i) {
		let n = G1(e);
		if (P1().securityLevel !== "loose" || u === void 0) return;
		let c = [];
		if (typeof i == "string") {
			c = i.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
	...
	le = function (e, u, i) {
		e.split(",").forEach(function (n) {
			D[n] !== void 0 &&
				((D[n].link = $1.formatUrl(u, I1)), (D[n].linkTarget = i));
		}),
			nt(e, "clickable");
	},
	he = function (e) {
	...
	be = function (e) {
		let u = V1(".mermaidTooltip");
		(u._groups || u)[0][0] === null &&
			(u = V1("body")
				.append("div")
			...
			V1(e)
				...
				.on("mouseover", function () {
					...
					u.transition().duration(200).style("opacity", ".9"),
						u
							...
							.style(
								"left",
								window.scrollX + h.left + (h.right - h.left) / 2 + "px",
							)
				...
				.on("mouseout", function () {
					u.transition().duration(500).style("opacity", 0),
						V1(this).classed("hover", !1);
				});
	};
it.push(be);
var ge = function (e = "gen-1") {
		(D = {}),
			(L1 = {}),
			(H = []),
			(it = [be]),
	...
	Te = function (e, u, i) {
		...
		let h = [],
			{ nodeList: U, dir: F } = l(h.concat.apply(h, u));
		if (((h = U), ut === "gen-1"))
			for (let X = 0; X < h.length; X++) h[X] = G1(h[X]);
		(n = n || "subGraph" + tt), (c = c || ""), (c = rt(c)), (tt = tt + 1);
		let w = {
			id: n,
			nodes: h,
			title: c.trim(),
		...
		return (
			O1.info("Adding", w.id, w.nodes, w.dir),
			(w.nodes = Ve(w, c1).nodes),
			c1.push(w),
			(et[n] = w),
			n
		);
	...
	Me = function (e) {
		for (let [u, i] of c1.entries()) if (i.id === e) return u;
		return -1;
	},
	U1 = -1,
	Se = [],
	Ce = function (e, u) {
		let i = c1[u].nodes;
		if (((U1 = U1 + 1), U1 > 2e3)) return;
		if (((Se[U1] = u), c1[u].id === e)) return { result: !0, count: 0 };
		let n = 0,
			c = 1;
		for (; n < i.length; ) {
			let l = Me(i[n]);
	...
	xe = function () {
		(U1 = -1), c1.length > 0 && Ce("none", c1.length - 1);
	},
	Be = function () {
		return c1;
	},
	...
	je = (e) => {
		...
		switch (u.slice(-1)) {
			case "x":
				(n = "arrow_cross"),
					u[0] === "x" && ((n = "double_" + n), (i = i.slice(1)));
				break;
			case ">":
				(n = "arrow_point"),
					u[0] === "<" && ((n = "double_" + n), (i = i.slice(1)));
				break;
			case "o":
				(n = "arrow_circle"),
					u[0] === "o" && ((n = "double_" + n), (i = i.slice(1)));
				break;
		}
		let c = "normal",
			l = i.length - 1;
...
export { We as a, ze as b, Qe as c };
