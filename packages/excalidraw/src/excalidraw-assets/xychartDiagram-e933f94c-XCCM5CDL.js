import { a as vt } from "./chunk-LA3PGSPR.js";
import {
	$a as ut,
	G as lt,
	Ga as ct,
...
import { a as Et } from "./chunk-M2JW2GFW.js";
import { f as ot } from "./chunk-SXMPUQ6M.js";
Et();
var Ii = ot(hi(), 1),
	Mi = ot(ri(), 1),
	Wi = ot(li(), 1);
var xt = (function () {
	var e = function (M, o, l, c) {
			for (l = l || {}, c = M.length; c--; l[M[c]] = o);
			return l;
		},
		...
		h = [1, 6],
		g = [1, 7],
		f = [1, 5, 10, 12, 14, 16, 18, 19, 21, 23, 34, 35, 36],
		y = [1, 25],
		L = [1, 26],
		_ = [1, 28],
		C = [1, 29],
		...
		Rt = [1, 47],
		U = [1, 50],
		b = [1, 10, 12, 14, 16, 18, 19, 21, 23, 34, 35, 36],
		J = [1, 10, 12, 14, 16, 18, 19, 21, 23, 24, 26, 27, 28, 34, 35, 36],
		T = [
		...
		tt = {
			...
			performAction: function (o, l, c, u, m, a, F) {
				var x = a.length - 1;
				switch (m) {
					case 5:
						u.setOrientation(a[x]);
						break;
					case 9:
						u.setDiagramTitle(a[x].text.trim());
						break;
					case 12:
						u.setLineData({ text: "", type: "text" }, a[x]);
						break;
					case 13:
						u.setLineData(a[x - 1], a[x]);
						break;
					case 14:
						u.setBarData({ text: "", type: "text" }, a[x]);
						break;
					case 15:
						u.setBarData(a[x - 1], a[x]);
						break;
					case 16:
						(this.$ = a[x].trim()), u.setAccTitle(this.$);
						break;
					case 17:
					case 18:
						(this.$ = a[x].trim()), u.setAccDescription(this.$);
						break;
					case 19:
						this.$ = a[x - 1];
						break;
					...
					case 25:
						...
						break;
					case 26:
						u.setXAxisRangeData(Number(a[x - 2]), Number(a[x]));
						break;
					case 27:
						this.$ = a[x - 1];
						break;
					...
					case 30:
						...
						break;
					case 31:
						u.setYAxisTitle(a[x - 1]);
						break;
					case 32:
						u.setYAxisTitle({ type: "text", text: "" });
						break;
					case 33:
						u.setYAxisRangeData(Number(a[x - 2]), Number(a[x]));
						break;
					case 37:
			...
			table: [
				e(t, i, { 3: 1, 4: 2, 7: 4, 5: s, 34: n, 35: h, 36: g }),
				{ 1: [3] },
				e(t, i, { 4: 2, 7: 4, 3: 8, 5: s, 34: n, 35: h, 36: g }),
				e(t, i, {
					4: 2,
					7: 4,
					6: 9,
				...
				e(f, [2, 36]),
				{ 1: [2, 1] },
				e(t, i, { 4: 2, 7: 4, 3: 21, 5: s, 34: n, 35: h, 36: g }),
				{ 1: [2, 3] },
				e(f, [2, 5]),
				e(t, [2, 7], { 4: 22, 34: n, 35: h, 36: g }),
				{
					11: 23,
					37: 24,
					38: y,
				...
				e(T, [2, 51]),
				e(b, [2, 10]),
				e(b, [2, 22], { 30: 41, 29: 56, 24: B, 27: Ct }),
				e(b, [2, 24]),
				e(b, [2, 25]),
				{ 31: [1, 57] },
				{
			...
			parse: function (o) {
				...
				A.setInput(o, W.yy),
					(W.yy.lexer = A),
					(W.yy.parser = this),
					typeof A.yylloc > "u" && (A.yylloc = {});
				var st = A.yylloc;
				a.push(st);
				var ai = A.options && A.options.ranges;
				...
				for (var S, O, D, nt, z = {}, q, V, Pt, j; ; ) {
					if (
						((O = c[c.length - 1]),
						this.defaultActions[O]
							? (D = this.defaultActions[O])
							: ((S === null || typeof S > "u") && (S = oi()),
								(D = F[O] && F[O][S])),
					...
					switch (D[0]) {
						...
						case 2:
							if (
								...
								ai &&
									(z._$.range = [
										a[a.length - (V || 1)].range[0],
										a[a.length - 1].range[1],
									]),
								(nt = this.performAction.apply(
									z,
									[x, Dt, $, W.yy, D[1], m, a].concat(ni),
								)),
								typeof nt < "u")
							)
								return nt;
							V &&
								...
								m.push(z.$),
								a.push(z._$),
								(Pt = F[c[c.length - 2]][c[c.length - 1]]),
								c.push(Pt);
							break;
						case 3:
							return !0;
				...
				unput: function (o) {
					...
					return (
						(this.yylloc = {
							...
							last_column: c
								? (c.length === u.length ? this.yylloc.first_column : 0) +
									u[u.length - c.length].length -
									c[0].length
								: this.yylloc.first_column - l,
						}),
						this.options.ranges &&
							(this.yylloc.range = [m[0], m[0] + this.yyleng - l]),
...
` +
				...
				next: function () {
					...
					for (var m = this._currentRules(), a = 0; a < m.length; a++)
						if (
							((c = this._input.match(this.rules[m[a]])),
							c && (!l || c[0].length > l[0].length))
						) {
							if (((l = c), (u = a), this.options.backtrack_lexer)) {
								if (((o = this.test_match(c, m[a])), o !== !1)) return o;
								if (this._backtrack) {
									l = !1;
									continue;
								} else return !1;
					...
					return l
						? ((o = this.test_match(l, m[u])), o !== !1 ? o : !1)
						: this._input === ""
							? this.EOF
							: this.parseError(
									"Lexical error on line " +
...
` +
				...
				performAction: function (l, c, u, m) {
					switch (u) {
						case 0:
							break;
						case 1:
...
var Q = class {
		...
		getMaxDimension(t, i) {
			...
			for (let h of t) {
				let g = vt(n, 1, h),
					f = g ? g.width : h.length * i,
					y = g ? g.height : i;
				(s.width = Math.max(s.width, f)), (s.height = Math.max(s.height, y));
			}
			return n.remove(), s;
		}
	},
	...
	K = class {
		...
		recalculateOuterPaddingToDrawBar() {
			Ut * this.getTickDistance() > this.outerPadding * 2 &&
				(this.outerPadding = Math.floor((Ut * this.getTickDistance()) / 2)),
				this.recalculateScale();
		}
	...
	pt = class extends K {
		constructor(t, i, s, n, h) {
			super(t, n, h, i),
				(this.categories = s),
				(this.scale = ht().domain(this.categories).range(this.getRange()));
		}
		setRange(t) {
			super.setRange(t);
		}
	...
	dt = class extends K {
		constructor(t, i, s, n, h) {
			super(t, n, h, i),
				(this.domain = s),
				(this.scale = rt().domain(this.domain).range(this.getRange()));
		}
		getTickValues() {
		...
		recalculateScale() {
			...
			this.axisPosition === "left" && t.reverse(),
				(this.scale = rt().domain(t).range(this.getRange()));
		}
		getScaleValue(t) {
			return this.scale(t);
		}
...
function qt(e, t, i, s) {
	let n = new Q(s);
	return jt(e)
		? new pt(t, i, e.categories, e.title, n)
		: new dt(t, i, [e.min, e.max], e.title, n);
}
var ft = class {
	constructor(t, i, s, n) {
...
var yt = class {
	...
	bt = class {
		...
		getDrawableElements() {
			...
			let t = [];
			for (let [i, s] of this.chartData.plots.entries())
				switch (s.type) {
					case "line":
						{
							let n = new yt(
...
var At = class {
		...
		calculateVerticalSpace() {
			let t = this.chartConfig.width,
				...
				s = 0,
				n = 0,
				h = Math.floor((t * this.chartConfig.plotReservedSpacePercent) / 100),
				g = Math.floor((i * this.chartConfig.plotReservedSpacePercent) / 100),
				f = this.componentStore.plot.calculateSpace({ width: h, height: g });
			(t -= f.width),
				(i -= f.height),
				(f = this.componentStore.title.calculateSpace({
				...
				t > 0 && ((h += t), (t = 0)),
				i > 0 && ((g += i), (i = 0)),
				this.componentStore.plot.calculateSpace({ width: h, height: g }),
				this.componentStore.plot.setBoundingBoxXY({ x: s, y: n }),
				this.componentStore.xAxis.setRange([s, s + h]),
				...
				this.chartData.plots.some((y) => Ht(y)) &&
		...
		calculateHorizontalSpace() {
			let t = this.chartConfig.width,
				...
				f = Math.floor((i * this.chartConfig.plotReservedSpacePercent) / 100),
				y = this.componentStore.plot.calculateSpace({ width: g, height: f });
			(t -= y.width),
				(i -= y.height),
				(y = this.componentStore.title.calculateSpace({
					width: this.chartConfig.width,
					height: i,
				})),
				(s = y.height),
				...
				(y = this.componentStore.xAxis.calculateSpace({ width: t, height: i })),
				(t -= y.width),
				(n = y.width),
				this.componentStore.yAxis.setAxisPosition("top"),
				(y = this.componentStore.yAxis.calculateSpace({ width: t, height: i })),
				(i -= y.height),
				(h = s + y.height),
				t > 0 && ((g += t), (t = 0)),
				i > 0 && ((f += i), (i = 0)),
				this.componentStore.plot.calculateSpace({ width: g, height: f }),
				this.componentStore.plot.setBoundingBoxXY({ x: n, y: h }),
				this.componentStore.yAxis.setRange([n, n + g]),
				this.componentStore.yAxis.setBoundingBoxXY({ x: n, y: s }),
				this.componentStore.xAxis.setRange([h, h + f]),
				this.componentStore.xAxis.setBoundingBoxXY({ x: 0, y: h }),
				this.chartData.plots.some((L) => Ht(L)) &&
					this.componentStore.xAxis.recalculateOuterPaddingToDrawBar();
		}
		calculateSpace() {
		...
		getDrawableElement() {
			...
			for (let i of Object.values(this.componentStore))
	...
	wt = class {
		static build(t, i, s, n) {
			return new At(t, i, s, n).getDrawableElement();
		}
	},
	X = 0,
	Gt,
	...
	H = Qt(),
	p = Zt(),
	St = H.plotColorPalette.split(",").map((e) => e.trim()),
	Z = !1,
	_t = !1;
function Qt() {
	let e = It(),
		t = G();
	return ut(e.xyChart, t.themeVariables.xyChart);
}
function Kt() {
	let e = G();
	return ut(Mt.xyChart, e.xyChart);
}
function Zt() {
	return {
...
function pi(e) {
	e === "horizontal"
		? (Y.chartOrientation = "horizontal")
		: (Y.chartOrientation = "vertical");
}
function di(e) {
	p.xAxis.title = kt(e.text);
}
function Jt(e, t) {
	(p.xAxis = { type: "linear", title: p.xAxis.title, min: e, max: t }),
		(Z = !0);
}
function fi(e) {
	(p.xAxis = {
		type: "band",
		title: p.xAxis.title,
		categories: e.map((t) => kt(t.text)),
	}),
		(Z = !0);
}
function yi(e) {
	p.yAxis.title = kt(e.text);
}
function mi(e, t) {
	(p.yAxis = { type: "linear", title: p.yAxis.title, min: e, max: t }),
		(_t = !0);
}
function bi(e) {
	let t = Math.min(...e),
		i = Math.max(...e),
		s = N(p.yAxis) ? p.yAxis.min : 1 / 0,
		n = N(p.yAxis) ? p.yAxis.max : -1 / 0;
	p.yAxis = {
		type: "linear",
		title: p.yAxis.title,
		min: Math.min(s, t),
...
function ti(e) {
	...
	if (!Z) {
		let i = N(p.xAxis) ? p.xAxis.min : 1 / 0,
			s = N(p.xAxis) ? p.xAxis.max : -1 / 0;
		Jt(Math.min(i, 1), Math.max(s, e.length));
	}
	if (
		(_t || bi(e),
		jt(p.xAxis) && (t = p.xAxis.categories.map((i, s) => [i, e[s]])),
		N(p.xAxis))
	) {
		let i = p.xAxis.min,
			s = p.xAxis.max,
...
function Ai(e, t) {
	let i = ti(t);
	p.plots.push({ type: "line", strokeFill: ii(X), strokeWidth: 2, data: i }),
		X++;
}
function wi(e, t) {
	let i = ti(t);
	p.plots.push({ type: "bar", fill: ii(X), data: i }), X++;
}
function Si() {
	if (p.plots.length === 0)
		throw Error("No Plot to render, please provide a plot with some data");
	return (p.title = gt()), wt.build(Y, p, H, Gt);
}
function _i() {
	return H;
}
...
var Ci = function () {
	...
	Ri = {
		...
		setOrientation: pi,
		setXAxisTitle: di,
		setXAxisRangeData: Jt,
		setXAxisBand: fi,
		setYAxisTitle: yi,
		setYAxisRangeData: mi,
		setLineData: Ai,
		setBarData: wi,
		setTmpSVGG: xi,
		getChartThemeConfig: _i,
		getChartConfig: ki,
	},
	Ti = (e, t, i, s) => {
		let n = s.db,
			h = n.getChartThemeConfig(),
			g = n.getChartConfig();
		function f(d) {
...
` + e,
		...
		let _ = Yt(t),
			C = _.append("g").attr("class", "main"),
			P = C.append("rect")
				.attr("width", g.width)
				.attr("height", g.height)
				.attr("class", "background");
		Wt(_, g.height, g.width, !0),
			_.attr("viewBox", `0 0 ${g.width} ${g.height}`),
			P.attr("fill", h.backgroundColor),
			n.setTmpSVGG(_.append("g").attr("class", "mermaid-tmp-group"));
		let E = n.getDrawableElem(),
			k = {};
		function v(d) {
			let w = C,
				r = "";
			for (let [R] of d.entries()) {
				let B = C;
				R > 0 && k[r] && (B = k[r]),
					(r += d[R]),
					(w = k[r]),
					w || (w = k[r] = B.append("g").attr("class", d[R]));
			}
			return w;
		}
		for (let d of E) {
			if (d.data.length === 0) continue;
			let w = v(d.groupTexts);
			switch (d.type) {
				case "rect":
					w.selectAll("rect")
						.data(d.data)
						...
						.attr("fill", (r) => r.fill)
						.attr("stroke", (r) => r.strokeFill)
						.attr("stroke-width", (r) => r.strokeWidth);
					break;
				case "text":
					w.selectAll("text")
						.data(d.data)
						...
						.attr("dominant-baseline", (r) => f(r.verticalPos))
						.attr("text-anchor", (r) => y(r.horizontalPos))
						.attr("transform", (r) => L(r))
						.text((r) => r.text);
					break;
				case "path":
					w.selectAll("path")
						...
						.append("path")
						.attr("d", (r) => r.path)
						.attr("fill", (r) => (r.fill ? r.fill : "none"))
						.attr("stroke", (r) => r.strokeFill)
						.attr("stroke-width", (r) => r.strokeWidth);
					break;
			}
	...
	Di = { draw: Ti },
	Oi = { parser: ci, db: Ri, renderer: Di };
