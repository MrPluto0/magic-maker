...
var r = {
	...
	l = {
		...
		hint_emptyLibrary:
			"Trieu un element o un llen\xE7 per a afegir-lo aqu\xED, o instal\xB7leu una biblioteca del repositori p\xFAblic, m\xE9s avall.",
		hint_emptyPrivateLibrary:
			"Trieu un element o un llen\xE7 per a afegir-lo aqu\xED.",
	},
	i = {
	...
	t = {
		...
		couldNotCreateShareableLink:
			"No s'ha pogut crear un enlla\xE7 per a compartir.",
		couldNotCreateShareableLinkTooBig:
			"No s\u2019ha pogut crear un enlla\xE7 per a compartir: l\u2019escena \xE9s massa gran",
		...
		uploadedSecurly:
			"La c\xE0rrega s'ha assegurat amb xifratge punta a punta, cosa que significa que el servidor Excalidraw i tercers no poden llegir el contingut.",
		loadSceneOverridePrompt:
			"Si carregas aquest dibuix extern, substituir\xE1 el que tens. Vols continuar?",
...
(Si voleu conservar el dibuix local, tanqueu la pentanya del navegador en comptes d'aturar la sessi\xF3).`,
		...
		errorRemovingFromLibrary:
			"No s'ha pogut eliminar l'element de la biblioteca",
		confirmAddLibrary:
			"Aix\xF2 afegir\xE0 {{numShapes}} forma(es) a la vostra biblioteca. Est\xE0s segur?",
		imageDoesNotContainScene:
			"Aquesta imatge no sembla contenir cap dada d'escena. Heu activat l'incrustaci\xF3 de l'escena durant l'exportaci\xF3?",
		cannotRestoreFromImage:
			"L\u2019escena no s\u2019ha pogut restaurar des d\u2019aquest fitxer d\u2019imatge",
		invalidSceneUrl:
			"No s'ha pogut importar l'escena des de l'adre\xE7a URL proporcionada. Est\xE0 malformada o no cont\xE9 dades Excalidraw JSON v\xE0lides.",
		...
		invalidEncryptionKey:
			"La clau d'encriptaci\xF3 ha de tenir 22 car\xE0cters. La col\xB7laboraci\xF3 en directe est\xE0 desactivada.",
...
Els vostres canvis no seran guardats!`,
	...
	o = {
		...
		imageInsertError:
			"No s'ha pogut insertar la imatge, torneu-ho a provar m\xE9s tard...",
		fileTooBig:
			"El fitxer \xE9s massa gros. La mida m\xE0xima permesa \xE9s {{maxSize}}.",
		svgImageInsertError:
			"No ha estat possible inserir la imatge SVG. Les marques SVG semblen inv\xE0lides.",
		failedToFetchImage: "",
		invalidSVGString: "SVG no v\xE0lid.",
		cannotResolveCollabServer:
			"No ha estat possible connectar amb el servidor collab. Si us plau recarregueu la p\xE0gina i torneu a provar.",
		importLibraryError: "No s'ha pogut carregar la biblioteca",
		collabSaveFailed:
			"No s'ha pogut desar a la base de dades de fons. Si els problemes persisteixen, haur\xEDeu de desar el fitxer localment per assegurar-vos que no perdeu el vostre treball.",
		collabSaveFailed_sizeExceeded:
			"No s'ha pogut desar a la base de dades de fons, sembla que el llen\xE7 \xE9s massa gran. Haur\xEDeu de desar el fitxer localment per assegurar-vos que no perdeu el vostre treball.",
	...
	c = {
		canvasPanning:
			"Per moure el llen\xE7, manteniu premuda la roda del ratol\xED o la barra espaiadora mentre arrossegueu o utilitzeu l'eina manual",
		linearElement:
			"Feu clic per a dibuixar m\xFAltiples punts; arrossegueu per a una sola l\xEDnia",
		...
		text_editing:
			"Premeu Escapada o Ctrl+Retorn (o Ordre+Retorn) per a finalitzar l'edici\xF3",
		linearElementMulti:
			"Feu clic a l'ultim punt, o pitgeu Esc o Retorn per a finalitzar",
		lockAngle:
			"Per restringir els angles, mantenir premut el maj\xFAscul (SHIFT)",
		resize:
			"Per restringir les proporcions mentres es canvia la mida, mantenir premut el maj\xFAscul (SHIFT); per canviar la mida des del centre, mantenir premut ALT",
		resizeImage: `Podeu redimensionar lliurement prement MAJ\xDASCULA;
per a redimensionar des del centre, premeu ALT`,
		rotate:
			"Per restringir els angles mentre gira, mantenir premut el maj\xFAscul (SHIFT)",
		lineEditor_info:
			"Mantingueu premut Ctrl o Cmd i feu doble clic o premeu Ctrl o Cmd + Retorn per editar els punts",
		lineEditor_pointSelected:
			"Premeu Suprimir per a eliminar el(s) punt(s), CtrlOrCmd+D per a duplicar-lo, o arrossegueu-lo per a moure'l",
...
selecci\xF3 m\xFAltiple), o manteniu Alt i feu clic per a afegir m\xE9s punts`,
		placeImage:
			"Feu clic per a col\xB7locar la imatge o clic i arrossegar per a establir-ne la mida manualment",
		publishLibrary: "Publiqueu la vostra pr\xF2pia llibreria",
		bindTextToElement: "Premeu enter per a afegir-hi text",
		deepBoxSelect:
			"Manteniu CtrlOrCmd per a selecci\xF3 profunda, i per a evitar l'arrossegament",
		eraserRevert:
			"Mantingueu premuda Alt per a revertir els elements seleccionats per a esborrar",
		firefox_clipboard_write:
			'\xC9s probable que aquesta funci\xF3 es pugui activar posant la marca "dom.events.asyncClipboard.clipboardItem" a "true". Per canviar les marques del navegador al Firefox, visiteu la p\xE0gina "about:config".',
		disableSnapping: "",
	},
	d = {
		...
		canvasTooBigTip:
			"Consell: proveu d\u2019acostar una mica els elements m\xE9s allunyats.",
	},
	u = {
		headingMain:
			"S'ha produ\xEFt un error. Proveu <button>recarregar la p\xE0gina.</button>",
		clearCanvasMessage:
			"Si la rec\xE0rrega no funciona, proveu <button>esborrar el llen\xE7.</button>",
		clearCanvasCaveat: " Aix\xF2 resultar\xE0 en la p\xE8rdua de feina ",
		trackedToSentry:
			"L'error amb l'identificador {{eventId}} s'ha rastrejat en el nostre sistema.",
		openIssueMessage:
			"An\xE0vem amb molta cura de no incloure la informaci\xF3 de la vostra escena en l'error. Si l'escena no \xE9s privada, podeu fer-ne el seguiment al nostre <button>rastrejador d'errors.</button> Incloeu la informaci\xF3 a continuaci\xF3 copiant i enganxant a GitHub Issues.",
		sceneContent: "Contingut de l'escena:",
	},
	p = {
		desc_intro:
			"Podeu convidar persones a la vostra escena actual a col\xB7laborar amb v\xF3s.",
		desc_privacy:
			"No us preocupeu, la sessi\xF3 utilitza el xifratge de punta a punta, de manera que qualsevol cosa que dibuixeu romandr\xE0 privada. Ni tan sols el nostre servidor podr\xE0 veure qu\xE8 feu.",
		button_startSession: "Inicia la sessi\xF3",
		button_stopSession: "Atura la sessi\xF3",
		desc_inProgressIntro:
			"La sessi\xF3 de col\xB7laboraci\xF3 en directe est\xE0 en marxa.",
		desc_shareLink:
			"Comparteix aquest enlla\xE7 amb qualsevol persona amb qui vulgueu col\xB7laborar:",
		desc_exitSession:
			"Si atureu la sessi\xF3, us desconectareu de la sala, per\xF2 podreu continuar treballant amb el dibuix localment. Tingues en compte que aix\xF2 no afectar\xE0 a altres persones, i encara podran col\xB7laborar en la seva versi\xF3.",
		shareTitle:
			"Uniu-vos a una sessi\xF3 de col\xB7laboraci\xF3 en directe a Excalidraw",
	},
	m = { title: "Error" },
	b = {
		disk_title: "Desa al disc",
		disk_details:
			"Exporta les dades de l'escena a un fitxer que despr\xE9s podreu importar.",
		...
		excalidrawplus_description:
			"Desa l'escena en el vostre espai de treball Excalidraw+.",
		excalidrawplus_button: "Exporta",
		excalidrawplus_exportError:
			"No \xE9s possible exportar a Excalidraw+ ara mateix...",
	},
	g = {
		...
		deepBoxSelect:
			"Seleccioneu profundament dins del quadre i eviteu arrossegar",
	...
	x = {
		...
		placeholder: {
			...
			libraryDesc:
				"Descripci\xF3 de la biblioteca per a ajudar a la gent a entendre'n el funcionament",
			githubHandle:
				"Identificador de GitHub (opcional), per tal que pugueu editar la biblioteca una vegada enviada per a ser revisada",
			twitterHandle:
				"Usuari de twitter (opcional), per tal que puguem donar-vos cr\xE8dit quan fem la promoci\xF3 a Twitter",
			website:
				"Enlla\xE7 al vostre lloc web personal o a qualsevol altre (opcional)",
		},
		errors: { required: "Requerit", website: "Introdu\xEFu una URL v\xE0lida" },
		noteDescription:
			"Envieu la vostra biblioteca perqu\xE8 sigui inclosa al <link>repositori p\xFAblic</link>per tal que altres persones puguin fer-ne \xFAs en els seus dibuixos.",
		noteGuidelines:
			"La biblioteca ha de ser aprovada manualment. Si us plau, llegiu les <link>directrius</link> abans d'enviar-hi res. Necessitareu un compte de GitHub per a comunicar i fer-hi canvis si cal, per\xF2 no \xE9s requisit imprescindible.",
		noteLicense:
			"Quan l'envieu, accepteu que la biblioteca sigui publicada sota la <link>llic\xE8ncia MIT, </link>que, en resum, vol dir que qualsevol persona pot fer-ne \xFAs sense restriccions.",
		noteItems:
			"Cada element de la biblioteca ha de tenir el seu propi nom per tal que sigui filtrable. S'hi inclouran els elements seg\xFCents:",
		atleastOneLibItem:
			"Si us plau, seleccioneu si m\xE9s no un element de la biblioteca per a comen\xE7ar",
		republishWarning:
			"Nota: alguns dels elements seleccionats s'han marcat com a publicats/enviats. Nom\xE9s haur\xEDeu de reenviar elements quan actualitzeu una biblioteca existent.",
	},
	h = {
		title: "Biblioteca enviada",
		content:
			"Gr\xE0cies, {{authorName}}. La vostra biblioteca ha estat enviada per a ser revisada. Podeu comprovar-ne l'estat<link>aqu\xED</link>",
	},
	S = {
		resetLibrary: "Restableix la biblioteca",
	...
	f = {
		...
		button: { exportToPng: "PNG", exportToSvg: "", copyPngToClipboard: "" },
	},
	E = {
		tooltip:
			"Els vostres dibuixos estan xifrats de punta a punta de manera que els servidors d\u2019Excalidraw no els veuran mai.",
...
o enganxeu-lo en un editor de text existent`,
	...
	w = {
		app: {
			center_heading:
				"Totes les vostres dades es guarden localment al vostre navegador.",
