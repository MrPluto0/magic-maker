...
declare const OverwriteConfirmDialog: React.FC<
	OverwriteConfirmDialogProps & {
		__fallback?: boolean | undefined;
	}
> & {
	Actions: (({ children }: { children: React.ReactNode }) => JSX.Element) & {
	...
	Action: ({
		...
		actionLabel,
		onClick,
	}: import("./OverwriteConfirmActions").ActionProps) => JSX.Element;
};
