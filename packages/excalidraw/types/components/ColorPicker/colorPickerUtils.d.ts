...
export declare const getColorNameAndShadeFromColor: ({
	palette,
	color,
}: {
...
export declare const isCustomColor: ({
	color,
	palette,
}: {
	color: string;
...
export declare const getMostUsedCustomColors: (
...
export declare const getContrastYIQ: (
	bgHex: string,
