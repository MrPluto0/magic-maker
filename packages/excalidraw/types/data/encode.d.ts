export declare const toByteString: (
 ...
 *  due to reencoding
 */
export declare const stringToBase64: (
	str: string,
	isByteString?: boolean,
) => string;
export declare const base64ToString: (
	base64: string,
	isByteString?: boolean,
) => string;
 ...
 * ]
 */
export declare const compressData: <T extends Record<string, any> = never>(
...
export declare const decompressData: <T extends Record<string, any>>(
