...
export declare const getFileHandleType: (
	handle: FileSystemHandle | null,
) => string | null;
export declare const isImageFileHandleType: (
	type: string | null,
) => type is "png" | "svg";
export declare const isImageFileHandle: (
	handle: FileSystemHandle | null,
) => boolean;
export declare const isSupportedImageFileType: (
	type: string | null | undefined,
) => boolean;
export declare const isSupportedImageFile: (
	blob: Blob | null | undefined,
) => blob is Blob & {
	type: ValueOf<typeof IMAGE_MIME_TYPES>;
};
export declare const loadSceneOrLibraryFromBlob: (
	blob: Blob | File,
...
>;
export declare const loadFromBlob: (
	blob: Blob,
	localAppState: AppState | null,
	localElements: readonly ExcalidrawElement[] | null,
	fileHandle?: FileSystemHandle | null,
) => Promise<import("./restore").RestoredDataState>;
export declare const parseLibraryJSON: (
	json: string,
	defaultStatus?: LibraryItem["status"],
) => LibraryItem[];
export declare const loadLibraryFromBlob: (
	blob: Blob,
	defaultStatus?: LibraryItem["status"],
) => Promise<LibraryItem[]>;
export declare const canvasToBlob: (
...
export declare const getDataURL_sync: (
	data: string | Uint8Array | ArrayBuffer,
	mimeType: ValueOf<typeof MIME_TYPES>,
) => DataURL;
export declare const dataURLToFile: (
	dataURL: DataURL,
	filename?: string,
) => File;
...
export declare const SVGStringToFile: (
	SVGString: string,
	filename?: string,
) => File & {
	type: typeof MIME_TYPES.svg;
};
export declare const ImageURLToFile: (
	imageUrl: string,
	filename?: string,
) => Promise<File | undefined>;
export declare const getFileFromEvent: (
	event: React.DragEvent<HTMLDivElement>,
) => Promise<{
	file: File | null;
	fileHandle: FileSystemHandle | null;
}>;
export declare const getFileHandle: (
	event: React.DragEvent<HTMLDivElement>,
