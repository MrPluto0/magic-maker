...
export declare const KeyCodeMap: Map<
	ValueOf<{
		readonly ARROW_DOWN: "ArrowDown";
		readonly ARROW_LEFT: "ArrowLeft";
		readonly ARROW_RIGHT: "ArrowRight";
 ...
 */
export declare const matchKey: (
	event: KeyboardEvent | React.KeyboardEvent<Element>,
	key: ValueOf<typeof KEYS>,
) => boolean;
export declare const isArrowKey: (key: string) => boolean;
export declare const shouldResizeFromCenter: (
	event: MouseEvent | KeyboardEvent,
) => boolean;
export declare const shouldMaintainAspectRatio: (
	event: MouseEvent | KeyboardEvent,
) => boolean;
export declare const shouldRotateWithDiscreteAngle: (
