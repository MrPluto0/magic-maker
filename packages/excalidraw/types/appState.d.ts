...
export declare const getDefaultAppState: () => Omit<
	AppState,
	"offsetTop" | "offsetLeft" | "width" | "height"
>;
export declare const clearAppStateForLocalStorage: (
...
export declare const clearAppStateForDatabase: (
	appState: Partial<AppState>,
) => {
	viewBackgroundColor?: string | undefined;
	gridSize?: number | undefined;
...
export declare const isHandToolActive: ({
	activeTool,
}: {
	activeTool: AppState["activeTool"];
}) => boolean;
