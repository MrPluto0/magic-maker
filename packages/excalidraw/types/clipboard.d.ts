...
export declare const createPasteEvent: ({
	types,
	files,
}: {
	types?:
...
export declare const serializeAsClipboardJSON: ({
	elements,
	files,
}: {
...
export declare const copyBlobToClipboardAsPng: (
	blob: Blob | Promise<Blob>,
) => Promise<void>;
export declare const copyTextToSystemClipboard: (
	text: string | null,
	clipboardEvent?: ClipboardEvent | null,
) => Promise<void>;
export {};
