...
export declare const isSnappingEnabled: ({
	event,
	app,
	selectedElements,
}: {
...
export declare const areRoughlyEqual: (
	a: number,
	b: number,
	precision?: number,
) => boolean;
export declare const getElementsCorners: (
...
export declare const getVisibleGaps: (
...
export declare const getReferenceSnapPoints: (
	elements: readonly NonDeletedExcalidrawElement[],
	selectedElements: ExcalidrawElement[],
	appState: AppState,
	elementsMap: ElementsMap,
...
export declare const snapResizingElements: (
	selectedElements: ExcalidrawElement[],
...
export declare const snapNewElement: (
...
export declare const getSnapLinesAtPointer: (
...
export declare const isActiveToolNonLinearSnappable: (
