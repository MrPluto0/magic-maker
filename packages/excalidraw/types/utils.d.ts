...
export declare const isToolIcon: (
...
export declare const isInputLike: (
	...
	| HTMLSelectElement
	| HTMLTextAreaElement;
export declare const isInteractive: (
	target: Element | EventTarget | null,
) => boolean;
 ...
 * cancelAnimation();
 */
export declare const easeToValuesRAF: <
...
export declare const chunk: <T extends unknown>(
	array: readonly T[],
	size: number,
) => T[][];
...
export declare const queryFocusableElements: (
 ...
 */
export declare const isShallowEqual: <
...
export declare function getSvgPathFromStroke(
	points: number[][],
	closed?: boolean,
): string;
...
export declare const safelyParseJSON: (
	json: string,
