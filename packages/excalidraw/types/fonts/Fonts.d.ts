...
export declare class Fonts {
	 ...
	 */
	getSceneFamilies: () => FontFamilyValues[];
	/**
	 ...
	 */
	static generateFontFaceDeclarations(
		elements: readonly ExcalidrawElement[],
	): Promise<string[]>;
 ...
 */
export declare const getVerticalOffset: (
